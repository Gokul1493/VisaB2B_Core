...
Feature: Generate the CHINA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CHINA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCHINA.txt')
    * def referencenumber = "MT103SFTPCHINA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCHINA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCHINA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCHINA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCHINA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCHINA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCHINA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCHINA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCHINA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCHINA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCHINA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPCHINA00011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPCHINA00012", ":20:" + referencenumber +'12')
    * def fileName = 'CHINA' + 'SFTP'+ Uniquefilename + '.txt'
