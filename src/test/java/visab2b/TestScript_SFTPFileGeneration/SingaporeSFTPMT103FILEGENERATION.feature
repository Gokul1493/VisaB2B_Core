...
Feature: Generate the SINGAPORE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SINGAPORE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSINGAPORE.txt')
    * def referencenumber = "MT103SFTPSINGAPORE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSINGAPORE0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSINGAPORE0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSINGAPORE0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSINGAPORE0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSINGAPORE0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSINGAPORE0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSINGAPORE0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSINGAPORE0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSINGAPORE0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSINGAPORE0010", ":20:" + referencenumber +'10')
    * def fileName = 'SINGAPORE' + 'SFTP'+ Uniquefilename + '.txt'
