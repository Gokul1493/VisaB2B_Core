...
Feature: Generate the PERU SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PERU
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPERU.txt')
    * def referencenumber = "MT103SFTPPERU" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPERU0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPERU0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPERU0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPERU0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPERU0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPERU0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPERU0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPPERU0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPPERU0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPPERU0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPPERU0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPPERU0012", ":20:" + referencenumber +'10').replaceAll(":20:SFTPPERU0013", ":20:" + referencenumber +'10')
    * def fileName = 'PERU' + 'SFTP'+ Uniquefilename + '.txt'
