...
Feature: Generate the MAURITIUS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MAURITIUS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMAURITIUS.txt')
    * def referencenumber = "MT103SFTPMAURITIUS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMAURITIUS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMAURITIUS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMAURITIUS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMAURITIUS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMAURITIUS0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMAURITIUS0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMAURITIUS0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMAURITIUS0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMAURITIUS0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMAURITIUS0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPMAURITIUS0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPMAURITIUS0012", ":20:" + referencenumber +'10')
    * def fileName = 'MAURITIUS' + 'SFTP'+ Uniquefilename + '.txt'
