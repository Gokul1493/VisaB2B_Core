...
Feature: Generate the MOROCCO SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MOROCCO
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMOROCCO.txt')
    * def referencenumber = "MT103SFTPMOROCCO" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMOROCCO0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMOROCCO0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMOROCCO0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMOROCCO0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMOROCCO0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMOROCCO0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMOROCCO0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMOROCCO0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMOROCCO0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMOROCCO0010", ":20:" + referencenumber +'10')
    * def fileName = 'MOROCCO' + 'SFTP'+ Uniquefilename + '.txt'
