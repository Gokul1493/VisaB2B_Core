...
Feature: Generate the EGYPT SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for EGYPT
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPEGYPT.txt')
    * def referencenumber = "MT103SFTPEGYPT" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPEGYPT0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPEGYPT0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPEGYPT0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPEGYPT0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPEGYPT0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPEGYPT0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPEGYPT0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPEGYPT0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPEGYPT0009", ":20:" + referencenumber +'8').replaceAll(":20:SFTPEGYPT0010", ":20:" + referencenumber +'8').replaceAll(":20:SFTPEGYPT0011", ":20:" + referencenumber +'8').replaceAll(":20:SFTPEGYPT0012", ":20:" + referencenumber +'8').replaceAll(":20:SFTPEGYPT0013", ":20:" + referencenumber +'8')
    * def fileName = 'EGYPT' + 'SFTP'+ Uniquefilename + '.txt'
