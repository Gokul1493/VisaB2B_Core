...
Feature: Generate the OMAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for OMAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPOMAN.txt')
    * def referencenumber = "MT103SFTPOMAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPOMAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPOMAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPOMAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPOMAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPOMAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPOMAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPOMAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPOMAN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPOMAN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPOMAN0010", ":20:" + referencenumber +'10')
    * def fileName = 'OMAN' + 'SFTP'+ Uniquefilename + '.txt'
