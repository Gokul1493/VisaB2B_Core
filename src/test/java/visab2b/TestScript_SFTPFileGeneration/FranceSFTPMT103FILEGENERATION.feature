...
Feature: Generate the FRANCE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for FRANCE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPFRANCE.txt')
    * def referencenumber = "MT103SFTPFRANCE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPFRANCE0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPFRANCE0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPFRANCE0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPFRANCE0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPFRANCE0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPFRANCE0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPFRANCE0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPFRANCE0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPFRANCE0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPFRANCE0010", ":20:" + referencenumber +'10')
    * def fileName = 'FRANCE' + 'SFTP'+ Uniquefilename + '.txt'
