...
Feature: Generate the MT103BLOCK1NOVALUE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPMT103BLOCK1NOVALUE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK1NOVALUE.txt')
    * def referencenumber = "SFTPBLOCK1NOVALUE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPVALIDMT103WITH124BLOCK001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK1NOVALUE' + 'SFTP'+ Uniquefilename + '.txt'
