...
Feature: Generate the VIETNAM SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for VIETNAM
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPVIETNAM.txt')
    * def referencenumber = "MT103SFTPVIETNAM" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPVIETNAM0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPVIETNAM0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPVIETNAM0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPVIETNAM0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPVIETNAM0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPVIETNAM0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPVIETNAM0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPVIETNAM0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPVIETNAM0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPVIETNAM0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPVIETNAM0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPVIETNAM0012", ":20:" + referencenumber +'10')
    * def fileName = 'VIETNAM' + 'SFTP'+ Uniquefilename + '.txt'
