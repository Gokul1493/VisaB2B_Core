...
Feature: Generate the Bahamas SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Bahamas
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBAHAMAS.txt')
    * def referencenumber = "MT103SFTPBAHAMAS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBAHAMAS00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBAHAMAS00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBAHAMAS00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBAHAMAS00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBAHAMAS00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBAHAMAS00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBAHAMAS00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBAHAMAS00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBAHAMAS00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPBAHAMAS00010", ":20:" + referencenumber +'10')
    * def fileName = 'BAHAMAS' + 'SFTP'+ Uniquefilename + '.txt'
