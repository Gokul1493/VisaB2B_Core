...
Feature: Generate the Belgium SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Belgium
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBELGIUM.txt')
    * def referencenumber = "MT103SFTPBELGIUM" + Uniquefilename
    ...
    * def fileName = 'BELGIUM' + 'SFTP'+ Uniquefilename + '.txt'
