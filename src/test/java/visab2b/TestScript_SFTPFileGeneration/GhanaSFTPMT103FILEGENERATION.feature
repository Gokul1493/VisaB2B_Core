...
Feature: Generate the GHANA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for GHANA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPGHANA.txt')
    * def referencenumber = "MT103SFTPGHANA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPGHANA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPGHANA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPGHANA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPGHANA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPGHANA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPGHANA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPGHANA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPGHANA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPGHANA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPGHANA0010", ":20:" + referencenumber +'10')
    * def fileName = 'GHANA' + 'SFTP'+ Uniquefilename + '.txt'
