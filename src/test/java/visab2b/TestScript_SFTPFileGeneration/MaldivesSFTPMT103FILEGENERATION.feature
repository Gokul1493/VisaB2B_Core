...
Feature: Generate the MALDIVES SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MALDIVES
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMALDIVES.txt')
    * def referencenumber = "MT103SFTPMALDIVES" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMALDIVES0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMALDIVES0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMALDIVES0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMALDIVES0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMALDIVES0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMALDIVES0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMALDIVES0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMALDIVES0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMALDIVES0009", ":20:" + referencenumber +'9')
    * def fileName = 'MALDIVES' + 'SFTP'+ Uniquefilename + '.txt'
