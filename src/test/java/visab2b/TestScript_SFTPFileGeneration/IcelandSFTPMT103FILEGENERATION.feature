...
Feature: Generate the ICELAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ICELAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPICELAND.txt')
    * def referencenumber = "MT103SFTPICELAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPICELAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPICELAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPICELAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPICELAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPICELAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPICELAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPICELAND0007", ":20:" + referencenumber +'7')
    * def fileName = 'ICELAND' + 'SFTP'+ Uniquefilename + '.txt'
