...
Feature: Generate the MALTA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MALTA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMALTA.txt')
    * def referencenumber = "MT103SFTPMALTA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMALTA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMALTA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMALTA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMALTA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMALTA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMALTA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMALTA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMALTA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMALTA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMALTA0010", ":20:" + referencenumber +'10')
    * def fileName = 'MALTA' + 'SFTP'+ Uniquefilename + '.txt'
