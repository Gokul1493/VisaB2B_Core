...
Feature: Generate the GERMANY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for GERMANY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPGERMANY.txt')
    * def referencenumber = "MT103SFTPGERMANY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPGERMANY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPGERMANY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPGERMANY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPGERMANY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPGERMANY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPGERMANY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPGERMANY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPGERMANY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPGERMANY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPGERMANY0010", ":20:" + referencenumber +'10')
    * def fileName = 'GERMANY' + 'SFTP'+ Uniquefilename + '.txt'
