...
Feature: Generate the SOUTHKOREA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SOUTHKOREA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSOUTHKOREA.txt')
    * def referencenumber = "MT103SFTPSOUTHKOREA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSOUTHKOREA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSOUTHKOREA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSOUTHKOREA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSOUTHKOREA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSOUTHKOREA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSOUTHKOREA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSOUTHKOREA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSOUTHKOREA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSOUTHKOREA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSOUTHKOREA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHKOREA0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHKOREA0012", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHKOREA0013", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHKOREA0014", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHKOREA0015", ":20:" + referencenumber +'10')
    * def fileName = 'SOUTHKOREA' + 'SFTP'+ Uniquefilename + '.txt'
