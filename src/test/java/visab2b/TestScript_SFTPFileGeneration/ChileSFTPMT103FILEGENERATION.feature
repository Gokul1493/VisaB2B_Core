...
Feature: Generate the CHILE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CHILE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCHILE.txt')
    * def referencenumber = "MT103SFTPCHILE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCHILE00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCHILE00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCHILE00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCHILE00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCHILE00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCHILE00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCHILE00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCHILE00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCHILE00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCHILE00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPCHILE00011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPCHILE00012", ":20:" + referencenumber +'12')
    * def fileName = 'CHILE' + 'SFTP'+ Uniquefilename + '.txt'
