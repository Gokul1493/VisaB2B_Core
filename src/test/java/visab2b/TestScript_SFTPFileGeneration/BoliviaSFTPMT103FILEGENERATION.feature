...
Feature: Generate the Bolivia SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Bolivia
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBOLIVIA.txt')
    * def referencenumber = "MT103SFTPBOLIVIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBOLIVIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBOLIVIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBOLIVIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBOLIVIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBOLIVIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBOLIVIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBOLIVIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBOLIVIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBOLIVIA0009", ":20:" + referencenumber +'9')
    * def fileName = 'BOLIVIA' + 'SFTP'+ Uniquefilename + '.txt'
