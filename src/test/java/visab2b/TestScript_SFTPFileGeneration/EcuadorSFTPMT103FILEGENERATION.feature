...
Feature: Generate the ECUADOR SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ECUADOR
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPECUADOR.txt')
    * def referencenumber = "MT103SFTPECUADOR" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPECUADOR0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPECUADOR0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPECUADOR0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPECUADOR0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPECUADOR0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPECUADOR0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPECUADOR0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPECUADOR0008", ":20:" + referencenumber +'8')
    * def fileName = 'ECUADOR' + 'SFTP'+ Uniquefilename + '.txt'
