...
Feature: Generate the HONDURAS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for HONDURAS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPHONDURAS.txt')
    * def referencenumber = "MT103SFTPHONDURAS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPHONDURAS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPHONDURAS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPHONDURAS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPHONDURAS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPHONDURAS0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPHONDURAS0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPHONDURAS0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPHONDURAS0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPHONDURAS0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPHONDURAS0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPHONDURAS0011", ":20:" + referencenumber +'10')
    * def fileName = 'HONDURAS' + 'SFTP'+ Uniquefilename + '.txt'
