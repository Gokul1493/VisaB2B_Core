...
Feature: Generate the PHILIPPINES SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PHILIPPINES
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPHILIPPINES.txt')
    * def referencenumber = "MT103SFTPPHILIPPINES" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPHILIPPINES0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPHILIPPINES0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPHILIPPINES0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPHILIPPINES0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPHILIPPINES0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPHILIPPINES0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPHILIPPINES0007", ":20:" + referencenumber +'7')
    * def fileName = 'PHILIPPINES' + 'SFTP'+ Uniquefilename + '.txt'
