...
Feature: Generate the REMOVEDBLOCK1 SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for REMOVEDBLOCK1
    * def filepath = read('classpath:visab2b/SFTPMT103_files/REMOVEDBLOCK1.txt')
    * def referencenumber = "REMOVEDBLOCK1SFTP" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPREMOVEDBLOCK1001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPREMOVEDBLOCK1' + 'SFTP'+ Uniquefilename + '.txt'
