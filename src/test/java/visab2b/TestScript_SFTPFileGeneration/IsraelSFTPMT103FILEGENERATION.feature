...
Feature: Generate the ISRAEL SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ISRAEL
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPISRAEL.txt')
    * def referencenumber = "MT103SFTPISRAEL" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPISRAEL0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPISRAEL0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPISRAEL0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPISRAEL0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPISRAEL0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPISRAEL0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPISRAEL0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPISRAEL0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPISRAEL0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPISRAEL0010", ":20:" + referencenumber +'10')
    * def fileName = 'ISRAEL' + 'SFTP'+ Uniquefilename + '.txt'
