...
Feature: Generate the DENMARK SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for DENMARK
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPDENMARK.txt')
    * def referencenumber = "MT103SFTPDENMARK" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPDENMARK0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPDENMARK0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPDENMARK0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPDENMARK0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPDENMARK0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPDENMARK0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPDENMARK0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPDENMARK0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPDENMARK0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPDENMARK0010", ":20:" + referencenumber +'10')
    * def fileName = 'DENMARK' + 'SFTP'+ Uniquefilename + '.txt'
