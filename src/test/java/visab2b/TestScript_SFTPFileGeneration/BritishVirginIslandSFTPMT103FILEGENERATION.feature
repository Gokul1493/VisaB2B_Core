...
Feature: Generate the BRITISHVIRGINISLAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BRITISHVIRGINISLAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBRITISHVIRGINISLAND.txt')
    * def referencenumber = "MT103SFTPBRITISHVIRGINISLAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBRITISHISLAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBRITISHISLAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBRITISHISLAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBRITISHISLAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBRITISHISLAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBRITISHISLAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBRITISHISLAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBRITISHISLAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBRITISHISLAND0009", ":20:" + referencenumber +'9')
    * def fileName = 'BRITISHVIRGINISLAND' + 'SFTP'+ Uniquefilename + '.txt'
