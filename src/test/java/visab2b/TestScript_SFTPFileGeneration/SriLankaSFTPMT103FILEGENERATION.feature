...
Feature: Generate the SRILANKA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SRILANKA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSRILANKA.txt')
    * def referencenumber = "MT103SFTPSRILANKA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSRILANKA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSRILANKA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSRILANKA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSRILANKA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSRILANKA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSRILANKA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSRILANKA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSRILANKA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSRILANKA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSRILANKA0010", ":20:" + referencenumber +'10')
    * def fileName = 'SRILANKA' + 'SFTP'+ Uniquefilename + '.txt'
