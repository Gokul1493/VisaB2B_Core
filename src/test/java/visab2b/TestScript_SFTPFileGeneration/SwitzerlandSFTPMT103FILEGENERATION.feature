...
Feature: Generate the SWITZERLAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SWITZERLAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSWITZERLAND.txt')
    * def referencenumber = "MT103SFTPSWITZERLAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSWITZERLAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSWITZERLAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSWITZERLAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSWITZERLAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSWITZERLAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSWITZERLAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSWITZERLAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSWITZERLAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSWITZERLAND0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSWITZERLAND0010", ":20:" + referencenumber +'10')
    * def fileName = 'SWITZERLAND' + 'SFTP'+ Uniquefilename + '.txt'
