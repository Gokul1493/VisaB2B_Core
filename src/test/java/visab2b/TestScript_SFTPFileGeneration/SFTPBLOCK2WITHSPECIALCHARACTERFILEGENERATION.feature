...
Feature: Generate the SFTPBLOCK2OPENBRACEMISSING SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK2OPENBRACEMISSING
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK2WITHSPECIALCHARACTER.txt')
    * def referencenumber = "SFTPBLOCK2WITHSPECIALCHARACTER" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK2NOVALUE001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK2WITHSPECIALCHARACTER' + 'SFTP'+ Uniquefilename + '.txt'
