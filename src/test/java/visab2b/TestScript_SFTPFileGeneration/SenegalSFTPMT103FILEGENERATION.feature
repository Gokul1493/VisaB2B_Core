...
Feature: Generate the SENEGAL SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SENEGAL
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSENEGAL.txt')
    * def referencenumber = "MT103SFTPSENEGAL" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSENEGAL0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSENEGAL0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSENEGAL0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSENEGAL0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSENEGAL0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSENEGAL0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSENEGAL0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSENEGAL0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSENEGAL0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSENEGAL0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSENEGAL0011", ":20:" + referencenumber +'10')
    * def fileName = 'SENEGAL' + 'SFTP'+ Uniquefilename + '.txt'
