...
Feature: Generate the SOUTHAFRICA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SOUTHAFRICA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSOUTHAFRICA.txt')
    * def referencenumber = "MT103SFTPSOUTHAFRICA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSOUTHAFRICA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSOUTHAFRICA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSOUTHAFRICA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSOUTHAFRICA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSOUTHAFRICA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSOUTHAFRICA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSOUTHAFRICA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSOUTHAFRICA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSOUTHAFRICA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSOUTHAFRICA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHAFRICA0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHAFRICA0012", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSOUTHAFRICA0013", ":20:" + referencenumber +'10')
    * def fileName = 'SOUTHAFRICA' + 'SFTP'+ Uniquefilename + '.txt'
