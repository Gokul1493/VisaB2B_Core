@parallel=false
Feature: Generate the Algeria SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Algeria
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPALGERIA.txt')
    * def referencenumber = "MT103SFTPALGERIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPALGERIA000010", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPALGERIA000020", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPALGERIA000030", ":20:" + referencenumber +'3').replaceAll(":20:SFTPALGERIA000040", ":20:" + referencenumber +'4').replaceAll(":20:SFTPALGERIA000050", ":20:" + referencenumber +'5').replaceAll(":20:SFTPALGERIA000060", ":20:" + referencenumber +'6').replaceAll(":20:SFTPALGERIA000070", ":20:" + referencenumber +'7').replaceAll(":20:SFTPALGERIA000080", ":20:" + referencenumber +'8').replaceAll(":20:SFTPALGERIA000090", ":20:" + referencenumber +'9').replaceAll(":20:SFTPALGERIA000100", ":20:" + referencenumber +'10')
    * def fileName = 'ALGERIA' + 'SFTP'+ Uniquefilename + '.txt'
