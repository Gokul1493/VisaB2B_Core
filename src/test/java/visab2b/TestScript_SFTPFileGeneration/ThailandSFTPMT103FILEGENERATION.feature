...
Feature: Generate the THAILAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for THAILAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTHAILAND.txt')
    * def referencenumber = "MT103SFTPTHAILAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTHAILAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTHAILAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTHAILAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTHAILAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTHAILAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTHAILAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTHAILAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTHAILAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPTHAILAND0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPTHAILAND0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPTHAILAND0011", ":20:" + referencenumber +'10')
    * def fileName = 'THAILAND' + 'SFTP'+ Uniquefilename + '.txt'
