...
Feature: Generate the TANZANIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for TANZANIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTANZANIA.txt')
    * def referencenumber = "MT103SFTPTANZANIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTANZANIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTANZANIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTANZANIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTANZANIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTANZANIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTANZANIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTANZANIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTANZANIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPTANZANIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPTANZANIA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPTANZANIA0011", ":20:" + referencenumber +'10')
    * def fileName = 'TANZANIA' + 'SFTP'+ Uniquefilename + '.txt'
