...
Feature: Generate the PORTUGAL SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PORTUGAL
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPORTUGAL.txt')
    * def referencenumber = "MT103SFTPPORTUGAL" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPORTUGAL0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPORTUGAL0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPORTUGAL0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPORTUGAL0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPORTUGAL0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPORTUGAL0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPORTUGAL0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPPORTUGAL0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPPORTUGAL0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPPORTUGAL0010", ":20:" + referencenumber +'10')
    * def fileName = 'PORTUGAL' + 'SFTP'+ Uniquefilename + '.txt'
