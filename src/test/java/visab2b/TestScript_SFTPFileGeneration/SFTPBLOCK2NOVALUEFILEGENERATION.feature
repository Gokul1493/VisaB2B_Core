...
Feature: Generate the MT103BLOCK1NOVALUE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK2NOVALUE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK2NOVALUE.txt')
    * def referencenumber = "SFTPBLOCK1NOVALUE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK2NOVALUE001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK2NOVALUE' + 'SFTP'+ Uniquefilename + '.txt'
