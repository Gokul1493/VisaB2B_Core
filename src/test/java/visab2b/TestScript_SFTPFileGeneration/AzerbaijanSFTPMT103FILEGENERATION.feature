...
Feature: Generate the Azerbaijan SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Azerbaijan
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPAZERBAIJAN.txt')
    * def referencenumber = "MT103SFTPAZERBAIJAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPAZERBAIJAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPAZERBAIJAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPAZERBAIJAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPAZERBAIJAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPAZERBAIJAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPAZERBAIJAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPAZERBAIJAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPAZERBAIJAN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPAZERBAIJAN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPAZERBAIJAN0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPAZERBAIJAN0011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPAZERBAIJAN0012", ":20:" + referencenumber +'12')
    * def fileName = 'AZERBAIJAN' + 'SFTP'+ Uniquefilename + '.txt'
