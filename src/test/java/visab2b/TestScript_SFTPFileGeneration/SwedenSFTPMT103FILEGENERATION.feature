...
Feature: Generate the SWEDEN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SWEDEN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSWEDEN.txt')
    * def referencenumber = "MT103SFTPSWEDEN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSWEDEN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSWEDEN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSWEDEN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSWEDEN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSWEDEN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSWEDEN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSWEDEN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSWEDEN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSWEDEN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSWEDEN0010", ":20:" + referencenumber +'10')
    * def fileName = 'SWEDEN' + 'SFTP'+ Uniquefilename + '.txt'
