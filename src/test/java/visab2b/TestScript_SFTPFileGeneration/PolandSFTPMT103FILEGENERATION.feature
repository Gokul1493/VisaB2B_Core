...
Feature: Generate the POLAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for POLAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPOLAND.txt')
    * def referencenumber = "MT103SFTPPOLAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPOLAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPOLAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPOLAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPOLAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPOLAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPOLAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPOLAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPPOLAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPPOLAND0009", ":20:" + referencenumber +'9')
    * def fileName = 'POLAND' + 'SFTP'+ Uniquefilename + '.txt'
