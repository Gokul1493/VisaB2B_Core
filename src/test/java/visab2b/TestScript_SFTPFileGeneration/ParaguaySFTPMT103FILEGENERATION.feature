...
Feature: Generate the PARAGUAY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PARAGUAY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPARAGUAY.txt')
    * def referencenumber = "MT103SFTPPARAGUAY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPARAGUAY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPARAGUAY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPARAGUAY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPARAGUAY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPARAGUAY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPARAGUAY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPARAGUAY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPPARAGUAY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPPARAGUAY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPPARAGUAY0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPPARAGUAY0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPPARAGUAY0012", ":20:" + referencenumber +'10')
    * def fileName = 'PARAGUAY' + 'SFTP'+ Uniquefilename + '.txt'
