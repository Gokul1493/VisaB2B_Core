...
Feature: Generate the Australia SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Australia
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPAUSTRALIA.txt')
    * def referencenumber = "MT103SFTPAUSTRALIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPAUSTRALIA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPAUSTRALIA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPAUSTRALIA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPAUSTRALIA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPAUSTRALIA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPAUSTRALIA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPAUSTRALIA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPAUSTRALIA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPAUSTRALIA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPAUSTRALIA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPAUSTRALIA00011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPAUSTRALIA00012", ":20:" + referencenumber +'12')
    * def fileName = 'AUSTRALIA' + 'SFTP'+ Uniquefilename + '.txt'
