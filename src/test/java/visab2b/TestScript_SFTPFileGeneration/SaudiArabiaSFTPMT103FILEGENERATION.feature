...
Feature: Generate the SAUDIARABIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SAUDIARABIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSAUDIARABIA.txt')
    * def referencenumber = "MT103SFTPSAUDIARABIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSAUDIARABIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSAUDIARABIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSAUDIARABIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSAUDIARABIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSAUDIARABIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSAUDIARABIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSAUDIARABIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSAUDIARABIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSAUDIARABIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSAUDIARABIA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPSAUDIARABIA0011", ":20:" + referencenumber +'10')
    * def fileName = 'SAUDIARABIA' + 'SFTP'+ Uniquefilename + '.txt'
