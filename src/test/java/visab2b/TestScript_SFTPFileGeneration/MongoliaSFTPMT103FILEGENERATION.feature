...
Feature: Generate the MONGOLIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MONGOLIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMONGOLIA.txt')
    * def referencenumber = "MT103SFTPMONGOLIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMONGOLIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMONGOLIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMONGOLIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMONGOLIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMONGOLIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMONGOLIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMONGOLIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMONGOLIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMONGOLIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMONGOLIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'MONGOLIA' + 'SFTP'+ Uniquefilename + '.txt'
