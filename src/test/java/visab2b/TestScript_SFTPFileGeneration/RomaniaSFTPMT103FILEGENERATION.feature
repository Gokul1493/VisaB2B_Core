...
Feature: Generate the ROMANIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ROMANIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPROMANIA.txt')
    * def referencenumber = "MT103SFTPROMANIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPROMANIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPROMANIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPROMANIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPROMANIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPROMANIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPROMANIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPROMANIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPROMANIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPROMANIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPROMANIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'ROMANIA' + 'SFTP'+ Uniquefilename + '.txt'
