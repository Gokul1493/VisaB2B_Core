...
Feature: Generate the SLOVAKIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SLOVAKIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSLOVAKIA.txt')
    * def referencenumber = "MT103SFTPSLOVAKIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSLOVAKIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSLOVAKIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSLOVAKIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSLOVAKIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSLOVAKIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSLOVAKIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSLOVAKIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSLOVAKIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSLOVAKIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSLOVAKIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'SLOVAKIA' + 'SFTP'+ Uniquefilename + '.txt'
