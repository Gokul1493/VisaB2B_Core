...
Feature: Generate the Bangladesh SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Bangladesh
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBANGLADESH.txt')
    * def referencenumber = "MT103SFTPBANGLADESH" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBANGALDESH00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBANGALDESH00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBANGALDESH00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBANGALDESH00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBANGALDESH00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBANGALDESH00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBANGALDESH00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBANGALDESH00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBANGALDESH00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPBANGALDESH00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPBANGALDESH00011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPBANGALDESH00012", ":20:" + referencenumber +'12').replaceAll(":20:SFTPBANGALDESH00013", ":20:" + referencenumber +'13')
    * def fileName = 'BANGLADESH' + 'SFTP'+ Uniquefilename + '.txt'
