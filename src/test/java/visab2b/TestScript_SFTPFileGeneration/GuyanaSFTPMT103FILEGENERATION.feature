...
Feature: Generate the GUYANA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for GUYANA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPGUYANA.txt')
    * def referencenumber = "MT103SFTPGUYANA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPGUYANA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPGUYANA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPGUYANA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPGUYANA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPGUYANA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPGUYANA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPGUYANA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPGUYANA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPGUYANA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPGUYANA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPGUYANA0011", ":20:" + referencenumber +'10')
    * def fileName = 'GUYANA' + 'SFTP'+ Uniquefilename + '.txt'
