...
Feature: Generate the TURKEY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for TURKEY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTURKEY.txt')
    * def referencenumber = "MT103SFTPTURKEY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTURKEY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTURKEY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTURKEY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTURKEY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTURKEY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTURKEY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTURKEY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTURKEY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPTURKEY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPTURKEY0010", ":20:" + referencenumber +'10')
    * def fileName = 'TURKEY' + 'SFTP'+ Uniquefilename + '.txt'
