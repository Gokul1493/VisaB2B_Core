...
Feature: Generate the ESTONIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ESTONIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPESTONIA.txt')
    * def referencenumber = "MT103SFTPESTONIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPESTONIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPESTONIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPESTONIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPESTONIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPESTONIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPESTONIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPESTONIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPESTONIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPESTONIA0009", ":20:" + referencenumber +'8').replaceAll(":20:SFTPESTONIA0010", ":20:" + referencenumber +'8')
    * def fileName = 'ESTONIA' + 'SFTP'+ Uniquefilename + '.txt'
