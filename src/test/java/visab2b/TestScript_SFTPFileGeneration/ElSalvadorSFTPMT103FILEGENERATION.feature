...
Feature: Generate the ELSALVADOR SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ELSALVADOR
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPELSALVADOR.txt')
    * def referencenumber = "MT103SFTPELSALVADOR" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPELSALVADOR0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPELSALVADOR0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPELSALVADOR0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPELSALVADOR0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPELSALVADOR0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPELSALVADOR0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPELSALVADOR0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPELSALVADOR0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPELSALVADOR0009", ":20:" + referencenumber +'8')
    * def fileName = 'ELSALVADOR' + 'SFTP'+ Uniquefilename + '.txt'
