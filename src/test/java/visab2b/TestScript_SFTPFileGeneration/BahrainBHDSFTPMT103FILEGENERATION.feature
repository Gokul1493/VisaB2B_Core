...
Feature: Generate the BahrainBHD SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BahrainBHD
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBAHRAINBHD.txt')
    * def referencenumber = "MT103SFTPBAHRAINBHD" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBAHRAINBHD00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBAHRAINBHD00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBAHRAINBHD00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBAHRAINBHD00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBAHRAINBHD00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBAHRAINBHD00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBAHRAINBHD00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBAHRAINBHD00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBAHRAINBHD00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPBAHRAINBHD00010", ":20:" + referencenumber +'10')
    * def fileName = 'BAHRAINBHD' + 'SFTP'+ Uniquefilename + '.txt'
