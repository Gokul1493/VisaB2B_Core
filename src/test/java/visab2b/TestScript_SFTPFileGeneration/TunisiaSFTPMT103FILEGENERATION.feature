...
Feature: Generate the TUNISIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for TUNISIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTUNISIA.txt')
    * def referencenumber = "MT103SFTPTUNISIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTUNISIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTUNISIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTUNISIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTUNISIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTUNISIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTUNISIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTUNISIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTUNISIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPTUNISIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPTUNISIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'TUNISIA' + 'SFTP'+ Uniquefilename + '.txt'
