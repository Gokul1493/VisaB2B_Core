...
Feature: Generate the GREECE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for GREECE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPGREECE.txt')
    * def referencenumber = "MT103SFTPGREECE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPGREECE0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPGREECE0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPGREECE0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPGREECE0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPGREECE0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPGREECE0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPGREECE0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPGREECE0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPGREECE0009", ":20:" + referencenumber +'9')
    * def fileName = 'GREECE' + 'SFTP'+ Uniquefilename + '.txt'
