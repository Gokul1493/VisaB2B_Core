...
Feature: Generate the UZBEKISTAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for UZBEKISTAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPUZBEKISTAN.txt')
    * def referencenumber = "MT103SFTPUZBEKISTAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPUZBEKISTAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPUZBEKISTAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPUZBEKISTAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPUZBEKISTAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPUZBEKISTAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPUZBEKISTAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPUZBEKISTAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPUZBEKISTAN0008", ":20:" + referencenumber +'8')
    * def fileName = 'UZBEKISTAN' + 'SFTP'+ Uniquefilename + '.txt'
