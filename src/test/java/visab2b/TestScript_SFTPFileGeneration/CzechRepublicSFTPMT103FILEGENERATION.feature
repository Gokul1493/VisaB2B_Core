...
Feature: Generate the CZECHREPUBLIC SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CZECHREPUBLIC
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCZECHREPUBLIC.txt')
    * def referencenumber = "MT103SFTPCZECHREPUBLIC" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCZECHREPUBLIC0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCZECHREPUBLIC0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCZECHREPUBLIC0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCZECHREPUBLIC0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCZECHREPUBLIC0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCZECHREPUBLIC0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCZECHREPUBLIC0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCZECHREPUBLIC0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCZECHREPUBLIC0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCZECHREPUBLIC0010", ":20:" + referencenumber +'10')
    * def fileName = 'CZECHREPUBLIC' + 'SFTP'+ Uniquefilename + '.txt'
