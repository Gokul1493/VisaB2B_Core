...
Feature: Generate the NEWZEALAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for NEWZEALAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPNEWZEALAND.txt')
    * def referencenumber = "MT103SFTPNEWZEALAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPNEWZEALAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPNEWZEALAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPNEWZEALAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPNEWZEALAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPNEWZEALAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPNEWZEALAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPNEWZEALAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPNEWZEALAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPNEWZEALAND0009", ":20:" + referencenumber +'9')
    * def fileName = 'NEWZEALAND' + 'SFTP'+ Uniquefilename + '.txt'
