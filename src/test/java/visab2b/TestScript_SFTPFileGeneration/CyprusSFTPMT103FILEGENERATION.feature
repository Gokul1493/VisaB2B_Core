...
Feature: Generate the CYPRUS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CYPRUS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCYPRUS.txt')
    * def referencenumber = "MT103SFTPCYPRUS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCYPRUS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCYPRUS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCYPRUS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCYPRUS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCYPRUS0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCYPRUS0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCYPRUS0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCYPRUS0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCYPRUS0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCYPRUS0010", ":20:" + referencenumber +'10')
    * def fileName = 'CYPRUS' + 'SFTP'+ Uniquefilename + '.txt'
