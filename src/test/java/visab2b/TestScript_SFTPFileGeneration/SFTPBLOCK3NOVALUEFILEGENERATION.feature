...
Feature: Generate the SFTPBLOCK3NOVALUE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK3NOVALUE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK3NOVALUE.txt')
    * def referencenumber = "SFTPBLOCK3NOVALUE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK2WITHSPECIALCHARACTER01", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK3NOVALUE' + 'SFTP'+ Uniquefilename + '.txt'
