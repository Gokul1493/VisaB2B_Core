...
Feature: Generate the LAOS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for LAOS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPLAOS.txt')
    * def referencenumber = "MT103SFTPLAOS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPLAOS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPLAOS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPLAOS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPLAOS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPLAOS0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPLAOS0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPLAOS0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPLAOS0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPLAOS0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPLAOS0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPLAOS0011", ":20:" + referencenumber +'10')
    * def fileName = 'LAOS' + 'SFTP'+ Uniquefilename + '.txt'
