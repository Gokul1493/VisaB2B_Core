...
Feature: Generate the BELARUS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BELARUS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBELARUS.txt')
    * def referencenumber = "MT103SFTPBELARUS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBELARUS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBELARUS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBELARUS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBELARUS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBELARUS0005", ":20:" + referencenumber +'5')
    * def fileName = 'BELARUS' + 'SFTP'+ Uniquefilename + '.txt'
