...
Feature: Generate the REMOVEDBLOCK1 SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for REMOVEDBLOCK1
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPALLBLOCKINSEPARATELINE.txt')
    * def referencenumber = "SFTPALLBLOCKINSEPARATELINE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPALLBLOCKINSEPARATELINE", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPALLBLOCKINSEPARATELINE' + 'SFTP'+ Uniquefilename + '.txt'
