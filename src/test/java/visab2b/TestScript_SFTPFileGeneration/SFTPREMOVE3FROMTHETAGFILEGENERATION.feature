...
Feature: Generate the SFTPREMOVE3FROMTHETAG SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPREMOVE3FROMTHETAG
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPREMOVE3FROMTHETAG.txt')
    * def referencenumber = "SFTPREMOVE3FROMTHETAG" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPREMOVE3FROMTHETAG001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPREMOVE3FROMTHETAG' + 'SFTP'+ Uniquefilename + '.txt'
