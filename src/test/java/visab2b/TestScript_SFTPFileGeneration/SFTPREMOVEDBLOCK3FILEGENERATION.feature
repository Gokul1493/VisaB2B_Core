...
Feature: Generate the SFTPREMOVEDBLOCK3 SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPREMOVEDBLOCK3
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPREMOVEDBLOCK3.txt')
    * def referencenumber = "SFTPREMOVEDBLOCK3" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPREMOVEDBLOCK3001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPREMOVEDBLOCK3' + 'SFTP'+ Uniquefilename + '.txt'
