...
Feature: Generate the SFTPBLOCK5REMOVED SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK5REMOVED
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK5REMOVED.txt')
    * def referencenumber = "SFTPBLOCK5REMOVED" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK5REMOVED01", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK5REMOVED' + 'SFTP'+ Uniquefilename + '.txt'
