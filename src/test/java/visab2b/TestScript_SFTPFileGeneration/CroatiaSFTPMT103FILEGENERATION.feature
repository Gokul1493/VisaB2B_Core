...
Feature: Generate the CROATIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CROATIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCROATIA.txt')
    * def referencenumber = "MT103SFTPCROATIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCROATIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCROATIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCROATIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCROATIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCROATIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCROATIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCROATIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCROATIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCROATIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCROATIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'CROATIA' + 'SFTP'+ Uniquefilename + '.txt'
