...
Feature: Generate the COSTARICA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for COSTARICA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCOSTARICA.txt')
    * def referencenumber = "MT103SFTPCOSTARICA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCOSTARICA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCOSTARICA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCOSTARICA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCOSTARICA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCOSTARICA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCOSTARICA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCOSTARICA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCOSTARICA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCOSTARICA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCOSTARICA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPCOSTARICA00011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPCOSTARICA00012", ":20:" + referencenumber +'12').replaceAll(":20:SFTPCOSTARICA00013", ":20:" + referencenumber +'13')
    * def fileName = 'COSTARICA' + 'SFTP'+ Uniquefilename + '.txt'
