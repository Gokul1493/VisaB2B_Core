...
Feature: Generate the URUGUAY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for URUGUAY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPURUGUAY.txt')
    * def referencenumber = "MT103SFTPURUGUAY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPURUGUAY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPURUGUAY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPURUGUAY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPURUGUAY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPURUGUAY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPURUGUAY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPURUGUAY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPURUGUAY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPURUGUAY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPURUGUAY0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPURUGUAY0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPURUGUAY0012", ":20:" + referencenumber +'10').replaceAll(":20:SFTPURUGUAY0013", ":20:" + referencenumber +'10').replaceAll(":20:SFTPURUGUAY0014", ":20:" + referencenumber +'10')
    * def fileName = 'URUGUAY' + 'SFTP'+ Uniquefilename + '.txt'
