...
Feature: Generate the GEORGIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for GEORGIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPGEORGIA.txt')
    * def referencenumber = "MT103SFTPGEORGIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPGEORGIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPGEORGIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPGEORGIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPGEORGIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPGEORGIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPGEORGIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPGEORGIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPGEORGIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPGEORGIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPGEORGIA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPGEORGIA0011", ":20:" + referencenumber +'10')
    * def fileName = 'GEORGIA' + 'SFTP'+ Uniquefilename + '.txt'
