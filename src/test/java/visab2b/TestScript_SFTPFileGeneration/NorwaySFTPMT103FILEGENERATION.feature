...
Feature: Generate the NORWAY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for NORWAY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPNORWAY.txt')
    * def referencenumber = "MT103SFTPNORWAY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPNORWAY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPNORWAY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPNORWAY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPNORWAY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPNORWAY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPNORWAY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPNORWAY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPNORWAY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPNORWAY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPNORWAY0010", ":20:" + referencenumber +'10')
    * def fileName = 'NORWAY' + 'SFTP'+ Uniquefilename + '.txt'
