...
Feature: Generate the NIGERIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for NIGERIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPNIGERIA.txt')
    * def referencenumber = "MT103SFTPNIGERIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPNIGERIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPNIGERIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPNIGERIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPNIGERIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPNIGERIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPNIGERIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPNIGERIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPNIGERIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPNIGERIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPNIGERIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'NIGERIA' + 'SFTP'+ Uniquefilename + '.txt'
