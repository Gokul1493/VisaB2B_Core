...
Feature: Generate the INDONESIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for INDONESIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPINDONESIA.txt')
    * def referencenumber = "MT103SFTPINDONESIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPINDONESIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPINDONESIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPINDONESIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPINDONESIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPINDONESIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPINDONESIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPINDONESIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPINDONESIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPINDONESIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPINDONESIA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPINDONESIA0011", ":20:" + referencenumber +'10')
    * def fileName = 'INDONESIA' + 'SFTP'+ Uniquefilename + '.txt'
