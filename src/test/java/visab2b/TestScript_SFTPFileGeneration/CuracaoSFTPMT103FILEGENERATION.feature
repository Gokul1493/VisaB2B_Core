...
Feature: Generate the CURACAO SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CURACAO
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCURACAO.txt')
    * def referencenumber = "MT103SFTPCURACAO" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCURACAO00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCURACAO00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCURACAO00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCURACAO00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCURACAO00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCURACAO00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCURACAO00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCURACAO00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCURACAO00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCURACAO00010", ":20:" + referencenumber +'10')
    * def fileName = 'CURACAO' + 'SFTP'+ Uniquefilename + '.txt'
