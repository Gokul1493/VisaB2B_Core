...
Feature: Generate the CAMBODIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CAMBODIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCAMBODIA.txt')
    * def referencenumber = "MT103SFTPCAMBODIA" + Uniquefilename
    ...
    * def fileName = 'CAMBODIA' + 'SFTP'+ Uniquefilename + '.txt'
