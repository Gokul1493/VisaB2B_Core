...
Feature: Generate the MALAYSIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MALAYSIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMALAYSIA.txt')
    * def referencenumber = "MT103SFTPMALAYSIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMALAYSIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMALAYSIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMALAYSIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMALAYSIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMALAYSIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMALAYSIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMALAYSIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMALAYSIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMALAYSIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMALAYSIA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPMALAYSIA0011", ":20:" + referencenumber +'10')
    * def fileName = 'MALAYSIA' + 'SFTP'+ Uniquefilename + '.txt'
