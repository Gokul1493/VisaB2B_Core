...
Feature: Generate the Argentina SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Argentina
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPARGENTINA.txt')
    * def referencenumber = "MT103SFTPARGENTINA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPARGENTINA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPARGENTINA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPARGENTINA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPARGENTINA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPARGENTINA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPARGENTINA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPARGENTINA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPARGENTINA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPARGENTINA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPARGENTINA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPARGENTINA00011", ":20:" + referencenumber +'11')
    * def fileName = 'ARGENTINA' + 'SFTP'+ Uniquefilename + '.txt'
