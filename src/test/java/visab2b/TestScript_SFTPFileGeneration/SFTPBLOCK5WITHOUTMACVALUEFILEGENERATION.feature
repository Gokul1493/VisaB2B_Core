...
Feature: Generate the SFTPBLOCK5WITHOUTMACVALUE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK5WITHOUTMACVALUE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK5WITHOUTMACVALUE.txt')
    * def referencenumber = "SFTPBLOCK5WITHOUTMACVALUE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK5WITHOUTMACVALUE01", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK5WITHOUTMACVALUE' + 'SFTP'+ Uniquefilename + '.txt'
