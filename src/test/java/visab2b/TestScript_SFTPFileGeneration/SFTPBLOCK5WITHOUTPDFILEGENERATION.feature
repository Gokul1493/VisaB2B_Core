...
Feature: Generate the SFTPBLOCK5WITHOUTPDE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK5WITHOUTPDE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK5WITHOUTPDE.txt')
    * def referencenumber = "SFTPBLOCK5WITHOUTPDE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK5WITHOUTPDE01", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK5WITHOUTPDE' + 'SFTP'+ Uniquefilename + '.txt'
