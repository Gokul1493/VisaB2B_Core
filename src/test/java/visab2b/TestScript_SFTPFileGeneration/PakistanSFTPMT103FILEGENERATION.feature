...
Feature: Generate the PAKISTAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PAKISTAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPAKISTAN.txt')
    * def referencenumber = "MT103SFTPPAKISTAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPAKISTAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPAKISTAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPAKISTAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPAKISTAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPAKISTAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPAKISTAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPAKISTAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPPAKISTAN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPPAKISTAN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPPAKISTAN0010", ":20:" + referencenumber +'10')
    * def fileName = 'PAKISTAN' + 'SFTP'+ Uniquefilename + '.txt'
