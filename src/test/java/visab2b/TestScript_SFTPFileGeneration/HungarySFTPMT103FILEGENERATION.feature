...
Feature: Generate the HUNGARY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for HUNGARY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPHUNGARY.txt')
    * def referencenumber = "MT103SFTPHUNGARY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPHUNGARY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPHUNGARY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPHUNGARY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPHUNGARY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPHUNGARY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPHUNGARY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPHUNGARY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPHUNGARY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPHUNGARY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPHUNGARY0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPHUNGARY0011", ":20:" + referencenumber +'10')
    * def fileName = 'HUNGARY' + 'SFTP'+ Uniquefilename + '.txt'
