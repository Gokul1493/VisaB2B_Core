...
Feature: Generate the BULGARIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BULGARIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBULGARIA.txt')
    * def referencenumber = "MT103SFTPBULGARIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBULGARIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBULGARIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBULGARIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBULGARIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBULGARIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBULGARIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBULGARIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBULGARIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBULGARIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPBULGARIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'BULGARIA' + 'SFTP'+ Uniquefilename + '.txt'
