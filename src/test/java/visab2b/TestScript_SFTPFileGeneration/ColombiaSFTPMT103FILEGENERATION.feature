...
Feature: Generate the COLOMBIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for COLOMBIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCOLOMBIA.txt')
    * def referencenumber = "MT103SFTPCOLOMBIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCOLOMBIA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCOLOMBIA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCOLOMBIA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCOLOMBIA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCOLOMBIA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCOLOMBIA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCOLOMBIA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCOLOMBIA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCOLOMBIA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCOLOMBIA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPCOLOMBIA00011", ":20:" + referencenumber +'11').replaceAll(":20:SFTPCOLOMBIA00012", ":20:" + referencenumber +'12')
    * def fileName = 'COLOMBIA' + 'SFTP'+ Uniquefilename + '.txt'
