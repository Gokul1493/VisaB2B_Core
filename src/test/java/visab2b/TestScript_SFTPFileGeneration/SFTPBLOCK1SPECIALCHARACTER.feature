...
Feature: Generate the SFTPBLOCK1SPECIALCHARACTER SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK1SPECIALCHARACTER
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK1SPECIALCHARACTER.txt')
    * def referencenumber = "SFTPBLOCK1SPECIALCHARACTER" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK1SPECIALCHARACTER", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK1SPECIALCHARACTER' + 'SFTP'+ Uniquefilename + '.txt'
