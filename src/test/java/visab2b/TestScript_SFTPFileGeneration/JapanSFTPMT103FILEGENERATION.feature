...
Feature: Generate the JAPAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for JAPAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPJAPAN.txt')
    * def referencenumber = "MT103SFTPJAPAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPJAPAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPJAPAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPJAPAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPJAPAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPJAPAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPJAPAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPJAPAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPJAPAN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPJAPAN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPJAPAN0010", ":20:" + referencenumber +'10')
    * def fileName = 'JAPAN' + 'SFTP'+ Uniquefilename + '.txt'
