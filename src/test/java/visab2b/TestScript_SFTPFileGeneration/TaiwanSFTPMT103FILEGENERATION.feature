...
Feature: Generate the TAIWAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for TAIWAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTAIWAN.txt')
    * def referencenumber = "MT103SFTPTAIWAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTAIWAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTAIWAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTAIWAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTAIWAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTAIWAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTAIWAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTAIWAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTAIWAN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPTAIWAN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPTAIWAN0010", ":20:" + referencenumber +'10')
    * def fileName = 'TAIWAN' + 'SFTP'+ Uniquefilename + '.txt'
