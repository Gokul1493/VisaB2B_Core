...
Feature: Generate the TrinidadAndTobago SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for TrinidadAndTobago
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTrinidadAndTobago.txt')
    * def referencenumber = "MT103SFTPTRINIDADANDTOBAGO" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTrinidadAndTobago0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTrinidadAndTobago0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTrinidadAndTobago0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTrinidadAndTobago0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTrinidadAndTobago0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTrinidadAndTobago0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTrinidadAndTobago0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTrinidadAndTobago0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPTrinidadAndTobago0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPTrinidadAndTobago0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPTrinidadAndTobago0011", ":20:" + referencenumber +'10')
    * def fileName = 'TRINIDADANDTOBAGO' + 'SFTP'+ Uniquefilename + '.txt'
