...
Feature: Generate the ITALY SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ITALY
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPITALY.txt')
    * def referencenumber = "MT103SFTPITALY" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPITALY0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPITALY0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPITALY0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPITALY0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPITALY0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPITALY0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPITALY0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPITALY0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPITALY0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPITALY0010", ":20:" + referencenumber +'10')
    * def fileName = 'ITALY' + 'SFTP'+ Uniquefilename + '.txt'
