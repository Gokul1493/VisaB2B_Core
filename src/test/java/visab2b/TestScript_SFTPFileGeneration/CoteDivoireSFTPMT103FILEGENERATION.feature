...
Feature: Generate the COTEDIVOIRE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for COTEDIVOIRE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCOTEDIVORIE.txt')
    * def referencenumber = "MT103SFTPCOTEDIVOIRE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCOTEDIVORE00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCOTEDIVORE00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCOTEDIVORE00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCOTEDIVORE00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCOTEDIVORE00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCOTEDIVORE00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCOTEDIVORE00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCOTEDIVORE00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCOTEDIVORE00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCOTEDIVORE00010", ":20:" + referencenumber +'10')
    * def fileName = 'COTEDIVOIRE' + 'SFTP'+ Uniquefilename + '.txt'
