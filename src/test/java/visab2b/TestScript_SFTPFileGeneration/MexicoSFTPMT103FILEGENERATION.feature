...
Feature: Generate the MEXICO SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MEXICO
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMEXICO.txt')
    * def referencenumber = "MT103SFTPMEXICO" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMEXICO0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMEXICO0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMEXICO0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMEXICO0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMEXICO0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMEXICO0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMEXICO0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMEXICO0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMEXICO0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMEXICO0010", ":20:" + referencenumber +'10')
    * def fileName = 'MEXICO' + 'SFTP'+ Uniquefilename + '.txt'
