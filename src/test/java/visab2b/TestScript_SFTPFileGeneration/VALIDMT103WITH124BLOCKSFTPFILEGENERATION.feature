...
Feature: Generate the SLOVAKIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SLOVAKIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPVALIDMT103WITH124BLOCK.txt')
    * def referencenumber = "SFTPVALIDMT103WITH124BLOCKAS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPVALIDMT103WITH124BLOCK001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPVALIDMT103WITH124BLOCK' + 'SFTP'+ Uniquefilename + '.txt'
