...
Feature: Generate the NICARAGUA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for NICARAGUA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPNICARAGUA.txt')
    * def referencenumber = "MT103SFTPNICARAGUA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPNICARAGUA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPNICARAGUA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPNICARAGUA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPNICARAGUA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPNICARAGUA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPNICARAGUA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPNICARAGUA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPNICARAGUA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPNICARAGUA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPNICARAGUA0010", ":20:" + referencenumber +'10')
    * def fileName = 'NICARAGUA' + 'SFTP'+ Uniquefilename + '.txt'
