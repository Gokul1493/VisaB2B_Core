...
Feature: Generate the SFTPREMOVEDBLOCK2 SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPREMOVEDBLOCK2
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPREMOVEDBLOCK2.txt')
    * def referencenumber = "SFTPREMOVEDBLOCK2" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPREMOVEDBLOCK2001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPREMOVEDBLOCK2' + 'SFTP'+ Uniquefilename + '.txt'
