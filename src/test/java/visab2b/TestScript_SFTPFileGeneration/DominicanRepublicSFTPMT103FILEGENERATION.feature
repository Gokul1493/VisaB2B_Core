...
Feature: Generate the DOMINICANREPUBLIC SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for DOMINICANREPUBLIC
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPDOMINICANREPUBLIC.txt')
    * def referencenumber = "MT103SFTPDOMINICANREPUBLIC" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPDOMINICANREPUBLIC0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPDOMINICANREPUBLIC0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPDOMINICANREPUBLIC0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPDOMINICANREPUBLIC0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPDOMINICANREPUBLIC0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPDOMINICANREPUBLIC0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPDOMINICANREPUBLIC0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPDOMINICANREPUBLIC0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPDOMINICANREPUBLIC0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPDOMINICANREPUBLIC0010", ":20:" + referencenumber +'10')
    * def fileName = 'DOMINICANREPUBLIC' + 'SFTP'+ Uniquefilename + '.txt'
