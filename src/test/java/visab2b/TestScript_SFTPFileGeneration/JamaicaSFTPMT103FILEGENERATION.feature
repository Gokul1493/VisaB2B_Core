...
Feature: Generate the JAMAICA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for JAMAICA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPJAMAICA.txt')
    * def referencenumber = "MT103SFTPJAMAICA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPJAMAICA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPJAMAICA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPJAMAICA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPJAMAICA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPJAMAICA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPJAMAICA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPJAMAICA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPJAMAICA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPJAMAICA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPJAMAICA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPJAMAICA0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPJAMAICA0012", ":20:" + referencenumber +'10')
    * def fileName = 'JAMAICA' + 'SFTP'+ Uniquefilename + '.txt'
