...
Feature: Generate the SFTPBLOCK5WITHOUTMACTAG SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK5WITHOUTMACTAG
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK5WITHOUTMACTAG.txt')
    * def referencenumber = "SFTPBLOCK5WITHOUTMACTAG" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK5WITHOUTMACTAG01", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK5WITHOUTMACTAG' + 'SFTP'+ Uniquefilename + '.txt'
