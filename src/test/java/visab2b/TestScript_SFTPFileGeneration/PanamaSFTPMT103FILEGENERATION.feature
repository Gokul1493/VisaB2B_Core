...
Feature: Generate the PANAMA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PANAMA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPANAMA.txt')
    * def referencenumber = "MT103SFTPPANAMA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPANAMA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPANAMA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPANAMA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPANAMA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPANAMA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPPANAMA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPPANAMA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPPANAMA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPPANAMA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPPANAMA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPPANAMA0011", ":20:" + referencenumber +'10')
    * def fileName = 'PANAMA' + 'SFTP'+ Uniquefilename + '.txt'
