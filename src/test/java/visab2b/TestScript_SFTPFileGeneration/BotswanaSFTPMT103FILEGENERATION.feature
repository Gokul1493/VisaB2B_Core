...
Feature: Generate the BOTSWANA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BOTSWANA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBOTSWANA.txt')
    * def referencenumber = "MT103SFTPBOTSWANA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBOTSWANA001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBOTSWANA002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBOTSWANA003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBOTSWANA004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBOTSWANA005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBOTSWANA006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBOTSWANA007", ":20:" + referencenumber +'7')
    * def fileName = 'BOTSWANA' + 'SFTP'+ Uniquefilename + '.txt'
