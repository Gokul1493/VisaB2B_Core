...
Feature: Generate the MOZAMBIQUE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for MOZAMBIQUE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPMOZAMBIQUE.txt')
    * def referencenumber = "MT103SFTPMOZAMBIQUE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMOZAMBIQUE0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMOZAMBIQUE0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMOZAMBIQUE0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMOZAMBIQUE0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMOZAMBIQUE0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMOZAMBIQUE0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMOZAMBIQUE0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMOZAMBIQUE0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMOZAMBIQUE0009", ":20:" + referencenumber +'9')
    * def fileName = 'MOZAMBIQUE' + 'SFTP'+ Uniquefilename + '.txt'
