...
Feature: Generate the Angola SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Angola
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPANGOLA.txt')
    * def referencenumber = "MT103SFTPANGOLA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPANGOLA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPANGOLA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPANGOLA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPANGOLA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPANGOLA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPANGOLA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPANGOLA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPANGOLA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPANGOLA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPANGOLA00010", ":20:" + referencenumber +'10')
    * def fileName = 'ANGOLA' + 'SFTP'+ Uniquefilename + '.txt'
