...
Feature: Generate the SFTPBLOCK1OPENBRACEREMOVED SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SFTPBLOCK1OPENBRACEREMOVED
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBLOCK1OPENBRACEREMOVED.txt')
    * def referencenumber = "SFTPBLOCK1OPENBRACEREMOVED" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBLOCK1OPENBRACEREMOVED001", ":20:" + referencenumber +'1' )
    * def fileName = 'SFTPBLOCK1OPENBRACEREMOVED' + 'SFTP'+ Uniquefilename + '.txt'
