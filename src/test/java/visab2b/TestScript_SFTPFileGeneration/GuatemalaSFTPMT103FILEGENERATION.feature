...
Feature: Generate the GUATEMALA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for GUATEMALA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPGUATEMALA.txt')
    * def referencenumber = "MT103SFTPGUATEMALA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPGUATEMALA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPGUATEMALA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPGUATEMALA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPGUATEMALA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPGUATEMALA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPGUATEMALA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPGUATEMALA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPGUATEMALA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPGUATEMALA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPGUATEMALA0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPGUATEMALA0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPGUATEMALA0012", ":20:" + referencenumber +'10').replaceAll(":20:SFTPGUATEMALA0013", ":20:" + referencenumber +'10').replaceAll(":20:SFTPGUATEMALA0014", ":20:" + referencenumber +'10')
    * def fileName = 'GUATEMALA' + 'SFTP'+ Uniquefilename + '.txt'
