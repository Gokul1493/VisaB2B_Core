...
Feature: Generate the LITHUANIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for LITHUANIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPLITHUANIA.txt')
    * def referencenumber = "MT103SFTPLITHUANIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPLITHUANIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPLITHUANIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPLITHUANIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPLITHUANIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPLITHUANIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPLITHUANIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPLITHUANIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPLITHUANIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPLITHUANIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPLITHUANIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'LITHUANIA' + 'SFTP'+ Uniquefilename + '.txt'
