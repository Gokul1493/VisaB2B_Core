...
Feature: Generate the UKRAINE SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for UKRAINE
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPUKRAINE.txt')
    * def referencenumber = "MT103SFTPUKRAINE" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPUKRAINE0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPUKRAINE0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPUKRAINE0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPUKRAINE0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPUKRAINE0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPUKRAINE0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPUKRAINE0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPUKRAINE0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPUKRAINE0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPUKRAINE0010", ":20:" + referencenumber +'10')
    * def fileName = 'UKRAINE' + 'SFTP'+ Uniquefilename + '.txt'
