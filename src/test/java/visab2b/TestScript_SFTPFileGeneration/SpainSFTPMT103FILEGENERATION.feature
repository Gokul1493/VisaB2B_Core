...
Feature: Generate the SPAIN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SPAIN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSPAIN.txt')
    * def referencenumber = "MT103SFTPSPAIN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSPAIN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSPAIN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSPAIN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSPAIN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSPAIN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSPAIN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSPAIN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSPAIN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSPAIN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSPAIN0010", ":20:" + referencenumber +'10')
    * def fileName = 'SPAIN' + 'SFTP'+ Uniquefilename + '.txt'
