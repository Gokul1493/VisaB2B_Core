...
Feature: Generate the LEBANON SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for LEBANON
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPLEBANON.txt')
    * def referencenumber = "MT103SFTPLEBANON" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPLEBANON0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPLEBANON0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPLEBANON0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPLEBANON0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPLEBANON0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPLEBANON0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPLEBANON0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPLEBANON0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPLEBANON0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPLEBANON0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPLEBANON0011", ":20:" + referencenumber +'10')
    * def fileName = 'LEBANON' + 'SFTP'+ Uniquefilename + '.txt'
