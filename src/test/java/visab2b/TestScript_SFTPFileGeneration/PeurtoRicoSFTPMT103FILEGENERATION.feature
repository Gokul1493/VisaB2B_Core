...
Feature: Generate the PEURTORICO SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for PEURTORICO
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPPEURTORICO.txt')
    * def referencenumber = "MT103SFTPPEURTORICO" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPPEURTORICO0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPPEURTORICO0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPPEURTORICO0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPPEURTORICO0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPPEURTORICO0005", ":20:" + referencenumber +'5')
    * def fileName = 'PEURTORICO' + 'SFTP'+ Uniquefilename + '.txt'
