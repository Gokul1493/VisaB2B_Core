...
Feature: Generate the BOSNIAANDHERZEGOVINA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BOSNIAANDHERZEGOVINA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBOSNIAANDHERZEGOVINA.txt')
    * def referencenumber = "MT103SFTPBOSNIAANDHERZEGOVINA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBOSNIAANDHERZEGOVINA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBOSNIAANDHERZEGOVINA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBOSNIAANDHERZEGOVINA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBOSNIAANDHERZEGOVINA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBOSNIAANDHERZEGOVINA0005", ":20:" + referencenumber +'5')
    * def fileName = 'BOSNIAANDHERZEGOVINA' + 'SFTP'+ Uniquefilename + '.txt'
