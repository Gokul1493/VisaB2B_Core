...
Feature: Generate the HAITI SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for HAITI
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPHAITI.txt')
    * def referencenumber = "MT103SFTPHAITI" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPHAITI0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPHAITI0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPHAITI0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPHAITI0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPHAITI0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPHAITI0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPHAITI0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPHAITI0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPHAITI0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPHAITI0010", ":20:" + referencenumber +'10')
    * def fileName = 'HAITI' + 'SFTP'+ Uniquefilename + '.txt'
