...
Feature: Generate the Armenia SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Armenia
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPARMENIA.txt')
    * def referencenumber = "MT103SFTPARMENIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPARMENIA001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPARMENIA002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPARMENIA003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPARMENIA004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPARMENIA005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPARMENIA006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPARMENIA007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPARMENIA008", ":20:" + referencenumber +'8')
    * def fileName = 'ARMENIA' + 'SFTP'+ Uniquefilename + '.txt'
