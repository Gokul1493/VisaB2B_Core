...
Feature: Generate the UNITEDARABEMIRATES SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for UNITEDARABEMIRATES
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPUNITEDARABEMIRATES.txt')
    * def referencenumber = "MT103SFTPUNITEDARABEMIRATES" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPUNITEDARABEMIRATES0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPUNITEDARABEMIRATES0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPUNITEDARABEMIRATES0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPUNITEDARABEMIRATES0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPUNITEDARABEMIRATES0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPUNITEDARABEMIRATES0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPUNITEDARABEMIRATES0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPUNITEDARABEMIRATES0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPUNITEDARABEMIRATES0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPUNITEDARABEMIRATES0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPUNITEDARABEMIRATES0011", ":20:" + referencenumber +'10')
    * def fileName = 'UNITEDARABEMIRATES' + 'SFTP'+ Uniquefilename + '.txt'
