...
Feature: Generate the CANADACAD SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CANADACAD
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCANADAUSD.txt')
    * def referencenumber = "MT103SFTPCANADAUSD" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCANADAUSD0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCANADAUSD0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCANADAUSD0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCANADAUSD0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCANADAUSD0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCANADAUSD0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCANADAUSD0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCANADAUSD0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCANADAUSD0009", ":20:" + referencenumber +'9')
    * def fileName = 'CANADAUSD' + 'SFTP'+ Uniquefilename + '.txt'
