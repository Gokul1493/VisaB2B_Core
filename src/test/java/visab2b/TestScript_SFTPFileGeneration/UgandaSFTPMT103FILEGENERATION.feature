...
Feature: Generate the UGANDA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for UGANDA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPUGANDA.txt')
    * def referencenumber = "MT103SFTPUGANDA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPUGANDA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPUGANDA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPUGANDA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPUGANDA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPUGANDA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPUGANDA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPUGANDA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPUGANDA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPUGANDA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPUGANDA0010", ":20:" + referencenumber +'10')..replaceAll(":20:SFTPUGANDA0011", ":20:" + referencenumber +'10')
    * def fileName = 'UGANDA' + 'SFTP'+ Uniquefilename + '.txt'
