...
Feature: Generate the NETHERLANDS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for NETHERLANDS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPNETHERLANDS.txt')
    * def referencenumber = "MT103SFTPNETHERLANDS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPNETHERLANDS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPNETHERLANDS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPNETHERLANDS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPNETHERLANDS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPNETHERLANDS0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPNETHERLANDS0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPNETHERLANDS0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPNETHERLANDS0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPNETHERLANDS0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPNETHERLANDS0010", ":20:" + referencenumber +'10')
    * def fileName = 'NETHERLANDS' + 'SFTP'+ Uniquefilename + '.txt'
