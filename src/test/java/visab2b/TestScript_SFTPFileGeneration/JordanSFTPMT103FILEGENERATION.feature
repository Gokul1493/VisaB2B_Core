...
Feature: Generate the JORDAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for JORDAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPJORDAN.txt')
    * def referencenumber = "MT103SFTPJORDAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPJORDAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPJORDAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPJORDAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPJORDAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPJORDAN0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPJORDAN0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPJORDAN0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPJORDAN0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPJORDAN0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPJORDAN0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPJORDAN0011", ":20:" + referencenumber +'10')
    * def fileName = 'JORDAN' + 'SFTP'+ Uniquefilename + '.txt'
