...
Feature: Generate the TURKSANDCAICOS SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for TURKSANDCAICOS
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPTURKSANDCAICOS.txt')
    * def referencenumber = "MT103SFTPTURKSANDCAICOS" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPTURKSANDCAICOS0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPTURKSANDCAICOS0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPTURKSANDCAICOS0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPTURKSANDCAICOS0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPTURKSANDCAICOS0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPTURKSANDCAICOS0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPTURKSANDCAICOS0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPTURKSANDCAICOS0008", ":20:" + referencenumber +'8')
    * def fileName = 'TURKSANDCAICOS' + 'SFTP'+ Uniquefilename + '.txt'
