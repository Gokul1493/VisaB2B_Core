...
Feature: Generate the NAMIBIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for NAMIBIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPNAMIBIA.txt')
    * def referencenumber = "MT103SFTPNAMIBIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPNAMIBIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPNAMIBIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPNAMIBIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPNAMIBIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPNAMIBIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPNAMIBIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPNAMIBIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPNAMIBIA0008", ":20:" + referencenumber +'8')
    * def fileName = 'NAMIBIA' + 'SFTP'+ Uniquefilename + '.txt'
