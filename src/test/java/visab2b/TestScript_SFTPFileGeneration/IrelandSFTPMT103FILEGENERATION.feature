...
Feature: Generate the IRELAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for IRELAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPIRELAND.txt')
    * def referencenumber = "MT103SFTPIRELAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPIRELAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPIRELAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPIRELAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPIRELAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPIRELAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPIRELAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPIRELAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPIRELAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPIRELAND0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPIRELAND0010", ":20:" + referencenumber +'10')
    * def fileName = 'IRELAND' + 'SFTP'+ Uniquefilename + '.txt'
