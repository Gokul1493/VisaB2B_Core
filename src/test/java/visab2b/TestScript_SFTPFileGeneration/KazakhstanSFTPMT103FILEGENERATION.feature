...
Feature: Generate the KAZAKHSTAN SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for KAZAKHSTAN
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPKAZAKHSTAN.txt')
    * def referencenumber = "MT103SFTPKAZAKHSTAN" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPKAZAKHSTAN0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPKAZAKHSTAN0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPKAZAKHSTAN0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPKAZAKHSTAN0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPKAZAKHSTAN0005", ":20:" + referencenumber +'5')
    * def fileName = 'KAZAKHSTAN' + 'SFTP'+ Uniquefilename + '.txt'
