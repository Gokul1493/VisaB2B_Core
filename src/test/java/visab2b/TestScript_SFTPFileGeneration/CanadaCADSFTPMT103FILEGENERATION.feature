...
Feature: Generate the CANADACAD SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CANADACAD
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCANADACAD.txt')
    * def referencenumber = "MT103SFTPCANADACAD" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPCANADA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPCANADA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPCANADA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPCANADA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPCANADA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPCANADA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPCANADA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPCANADA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPCANADA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPCANADA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPCANADA00011", ":20:" + referencenumber +'11')
    * def fileName = 'CANADACAD' + 'SFTP'+ Uniquefilename + '.txt'
