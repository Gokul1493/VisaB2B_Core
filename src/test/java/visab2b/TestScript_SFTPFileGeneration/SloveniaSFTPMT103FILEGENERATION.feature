...
Feature: Generate the SLOVENIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SLOVENIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSLOVENIA.txt')
    * def referencenumber = "MT103SFTPSLOVENIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSLOVENIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSLOVENIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSLOVENIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSLOVENIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSLOVENIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSLOVENIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSLOVENIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSLOVENIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSLOVENIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSLOVENIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'SLOVENIA' + 'SFTP'+ Uniquefilename + '.txt'
