...
Feature: Generate the BRAZIL SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BRAZIL
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBRAZIL.txt')
    * def referencenumber = "MT103SFTPBRAZIL" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBRAZIL0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBRAZIL0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBRAZIL0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBRAZIL0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBRAZIL0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBRAZIL0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBRAZIL0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBRAZIL0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBRAZIL0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPBRAZIL0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPBRAZIL0011", ":20:" + referencenumber +'11')
    * def fileName = 'BRAZIL' + 'SFTP'+ Uniquefilename + '.txt'
