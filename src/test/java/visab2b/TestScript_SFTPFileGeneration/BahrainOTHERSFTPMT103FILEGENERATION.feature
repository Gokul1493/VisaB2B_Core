...
Feature: Generate the BahrainOther SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for BahrainOther
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPBAHRAINOTHER.txt')
    * def referencenumber = "MT103SFTPBAHRAINOTHER" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPBAHRAINUSD000001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPBAHRAINUSD000002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPBAHRAINUSD000003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPBAHRAINUSD000004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPBAHRAINUSD000005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPBAHRAINUSD000006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPBAHRAINUSD000007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPBAHRAINUSD000008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPBAHRAINUSD000009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPBAHRAINUSD000010", ":20:" + referencenumber +'10')
    * def fileName = 'BAHRAINOTHER' + 'SFTP'+ Uniquefilename + '.txt'
