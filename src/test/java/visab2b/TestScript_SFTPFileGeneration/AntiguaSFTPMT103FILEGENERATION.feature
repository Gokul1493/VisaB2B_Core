...
Feature: Generate the Anitgua SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for Angola
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPANTIGUA.txt')
    * def referencenumber = "MT103SFTPANTIGUA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPANTIGUA00001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPANTIGUA00002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPANTIGUA00003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPANTIGUA00004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPANTIGUA00005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPANTIGUA00006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPANTIGUA00007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPANTIGUA00008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPANTIGUA00009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPANTIGUA00010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPANTIGUA00011", ":20:" + referencenumber +'11')
    * def fileName = 'ANTIGUA' + 'SFTP'+ Uniquefilename + '.txt'
