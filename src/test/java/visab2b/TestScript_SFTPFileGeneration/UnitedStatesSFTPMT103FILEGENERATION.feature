...
Feature: Generate the UNITEDSTATES SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for UNITEDSTATES
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPUNITEDSTATES.txt')
    * def referencenumber = "MT103SFTPUNITEDSTATES" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPUNITEDSTATES0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPUNITEDSTATES0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPUNITEDSTATES0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPUNITEDSTATES0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPUNITEDSTATES0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPUNITEDSTATES0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPUNITEDSTATES0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPUNITEDSTATES0008", ":20:" + referencenumber +'8')
    * def fileName = 'UNITEDSTATES' + 'SFTP'+ Uniquefilename + '.txt'
