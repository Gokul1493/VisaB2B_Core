...
Feature: Generate the FINLAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for FINLAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPFINLAND.txt')
    * def referencenumber = "MT103SFTPFINLAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPFINLAND0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPFINLAND0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPFINLAND0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPFINLAND0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPFINLAND0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPFINLAND0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPFINLAND0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPFINLAND0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPFINLAND0009", ":20:" + referencenumber +'8').replaceAll(":20:SFTPFINLAND0010", ":20:" + referencenumber +'8')
    * def fileName = 'FINLAND' + 'SFTP'+ Uniquefilename + '.txt'
