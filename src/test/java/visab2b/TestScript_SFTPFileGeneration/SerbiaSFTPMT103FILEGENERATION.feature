...
Feature: Generate the SERBIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for SERBIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPSERBIA.txt')
    * def referencenumber = "MT103SFTPSERBIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPSERBIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPSERBIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPSERBIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPSERBIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPSERBIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPSERBIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPSERBIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPSERBIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPSERBIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPSERBIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'SERBIA' + 'SFTP'+ Uniquefilename + '.txt'
