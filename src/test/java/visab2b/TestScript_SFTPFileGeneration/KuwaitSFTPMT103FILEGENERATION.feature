...
Feature: Generate the KUWAIT SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for KUWAIT
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPKUWAIT.txt')
    * def referencenumber = "MT103SFTPKUWAIT" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPKUWAIT0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPKUWAIT0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPKUWAIT0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPKUWAIT0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPKUWAIT0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPKUWAIT0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPKUWAIT0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPKUWAIT0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPKUWAIT0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPKUWAIT0010", ":20:" + referencenumber +'10')
    * def fileName = 'KUWAIT' + 'SFTP'+ Uniquefilename + '.txt'
