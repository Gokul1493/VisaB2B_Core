...
Feature: Generate the KENYA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for KENYA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPKENYA.txt')
    * def referencenumber = "MT103SFTPKENYA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPKENYA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPKENYA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPKENYA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPKENYA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPKENYA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPKENYA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPKENYA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPKENYA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPKENYA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPKENYA0010", ":20:" + referencenumber +'10')
    * def fileName = 'KENYA' + 'SFTP'+ Uniquefilename + '.txt'
