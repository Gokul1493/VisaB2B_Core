...
Feature: Generate the LATVIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for LATVIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPLATVIA.txt')
    * def referencenumber = "MT103SFTPLATVIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPLATVIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPLATVIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPLATVIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPLATVIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPLATVIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPLATVIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPLATVIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPLATVIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPLATVIA0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPLATVIA0010", ":20:" + referencenumber +'10')
    * def fileName = 'LATVIA' + 'SFTP'+ Uniquefilename + '.txt'
