...
Feature: Generate the HONGKONG SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for HONGKONG
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPHONGKONG.txt')
    * def referencenumber = "MT103SFTPHONGKONG" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPHONGKONG0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPHONGKONG0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPHONGKONG0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPHONGKONG0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPHONGKONG0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPHONGKONG0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPHONGKONG0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPHONGKONG0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPHONGKONG0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPHONGKONG0010", ":20:" + referencenumber +'10')
    * def fileName = 'HONGKONG' + 'SFTP'+ Uniquefilename + '.txt'
