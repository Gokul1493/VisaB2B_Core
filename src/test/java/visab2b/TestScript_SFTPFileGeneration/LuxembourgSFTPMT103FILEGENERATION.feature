...
Feature: Generate the LUXEMBOURG SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for LUXEMBOURG
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPLUXEMBOURG.txt')
    * def referencenumber = "MT103SFTPLUXEMBOURG" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPLUXEMBOURG0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPLUXEMBOURG0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPLUXEMBOURG0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPLUXEMBOURG0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPLUXEMBOURG0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPLUXEMBOURG0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPLUXEMBOURG0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPLUXEMBOURG0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPLUXEMBOURG0009", ":20:" + referencenumber +'9')
    * def fileName = 'LUXEMBOURG' + 'SFTP'+ Uniquefilename + '.txt'
