...
Feature: Generate the CAYMANISLAND SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for CAYMANISLAND
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPCAYMANISLAND.txt')
    * def referencenumber = "MT103SFTPCAYMANISLAND" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPMT103CAYMANISLAND001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPMT103CAYMANISLAND002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPMT103CAYMANISLAND003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPMT103CAYMANISLAND004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPMT103CAYMANISLAND005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPMT103CAYMANISLAND006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPMT103CAYMANISLAND007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPMT103CAYMANISLAND008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPMT103CAYMANISLAND009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPMT103CAYMANISLAND010", ":20:" + referencenumber +'10')
    * def fileName = 'CAYMANISLAND' + 'SFTP'+ Uniquefilename + '.txt'
