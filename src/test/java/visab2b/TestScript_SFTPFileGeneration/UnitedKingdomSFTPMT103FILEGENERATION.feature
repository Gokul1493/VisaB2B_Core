...
Feature: Generate the UNITEDKINGDOM SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for UNITEDKINGDOM
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPUNITEDKINGDOM.txt')
    * def referencenumber = "MT103SFTPUNITEDKINGDOM" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPUNITEDKINGDOM0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPUNITEDKINGDOM0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPUNITEDKINGDOM0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPUNITEDKINGDOM0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPUNITEDKINGDOM0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPUNITEDKINGDOM0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPUNITEDKINGDOM0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPUNITEDKINGDOM0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPUNITEDKINGDOM0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPUNITEDKINGDOM0010", ":20:" + referencenumber +'10').replaceAll(":20:SFTPUNITEDKINGDOM0011", ":20:" + referencenumber +'10').replaceAll(":20:SFTPUNITEDKINGDOM0012", ":20:" + referencenumber +'10').replaceAll(":20:SFTPUNITEDKINGDOM0013", ":20:" + referencenumber +'10')
    * def fileName = 'UNITEDKINGDOM' + 'SFTP'+ Uniquefilename + '.txt'
