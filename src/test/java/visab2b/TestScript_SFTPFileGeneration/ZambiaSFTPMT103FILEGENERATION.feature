...
Feature: Generate the ZAMBIA SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for ZAMBIA
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPZAMBIA.txt')
    * def referencenumber = "MT103SFTPZAMBIA" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPZAMBIA0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPZAMBIA0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPZAMBIA0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPZAMBIA0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPZAMBIA0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPZAMBIA0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPZAMBIA0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPZAMBIA0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPZAMBIA0009", ":20:" + referencenumber +'9')
    * def fileName = 'ZAMBIA' + 'SFTP'+ Uniquefilename + '.txt'
