...
Feature: Generate the QATAR SFTP FILE
  ...
  Scenario: Generate SFTP MT103 File for QATAR
    * def filepath = read('classpath:visab2b/SFTPMT103_files/SFTPQATAR.txt')
    * def referencenumber = "MT103SFTPQATAR" + Uniquefilename
    * def finalMt103 = filepath.replaceAll(":20:SFTPQATAR0001", ":20:" + referencenumber +'1' ).replaceAll(":20:SFTPQATAR0002", ":20:" + referencenumber +'2' ).replaceAll(":20:SFTPQATAR0003", ":20:" + referencenumber +'3').replaceAll(":20:SFTPQATAR0004", ":20:" + referencenumber +'4').replaceAll(":20:SFTPQATAR0005", ":20:" + referencenumber +'5').replaceAll(":20:SFTPQATAR0006", ":20:" + referencenumber +'6').replaceAll(":20:SFTPQATAR0007", ":20:" + referencenumber +'7').replaceAll(":20:SFTPQATAR0008", ":20:" + referencenumber +'8').replaceAll(":20:SFTPQATAR0009", ":20:" + referencenumber +'9').replaceAll(":20:SFTPQATAR0010", ":20:" + referencenumber +'10')
    * def fileName = 'QATAR' + 'SFTP'+ Uniquefilename + '.txt'
