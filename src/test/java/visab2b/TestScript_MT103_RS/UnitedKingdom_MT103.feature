...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPUNITEDKINGDOM" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10GBP202208662378910112", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditPositiveUnitedKingdom",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/UNITEDKINGDOM.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10GBP202208662378910112", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/UNITEDKINGDOM.txt')
	* def finalMt103 = content.replaceAll(":59:/331926819", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for UNITED KINGDOM country with different currency  (currency:- USD)
  ...
  * def referencenumber = "AUTOMT103SFTPUNITEDKINGDOM" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10GBP202208662378910112", "20:" + referencenumber ).replaceAll(":32A:200408GBP138,28", ":32A:200408USD138.28")
  * print finalMt103
  * jutil.SetData("GetAuditCrossBorderUnitedKingdom",referencenumber)
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
