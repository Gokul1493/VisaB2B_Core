...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPBULGARIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BULGERIA20240330001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsBulgariamt103rsmpostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for BULGARIA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
  * def referencenumber = "AUTOMT103SFTPBULGARIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BULGERIA20240330001", "20:" + referencenumber ).replaceAll("32A:200408BGN18.28", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed BULGARIA", "70:")
  * print finalMt103
  * jutil.SetData("GetAuditsBulgariamt103rsthercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
	* def finalMt103 = content.replaceAll("20:MT103BULGERIA20240330001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BNBGBGSDXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BNBGBGSDXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BNBGBGSDXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BNBGBGSDXXX", ":57A:BNBGBGSDXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/BULGARIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/Payment as Agreed Bulgaria", "70:"  ).replaceAll("20:MT103BULGERIA20240330001", "20:AUTOMT103SFTPBULGARIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
