...
* print Accno
  ...
  * print finalMt103
  * jutil.SetData("GetAuditsIcelandmt103rspostive",referencenumber)
  ...
  * def referencenumber = "AutoIceland001" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:AutoIceland001", "20:" + referencenumber ).replaceAll("32A:200408EUR138", "32A:200408ALL138.28")
  * print finalMt103
  * jutil.SetData("GetAuditsIcelandmt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/ICELAND.txt')
	* def finalMt103 = content.replaceAll("20:AutoIceland001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/ICELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:ESJAISREXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/ICELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:ESJAISREXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/ICELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:ESJAISREXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/ICELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:ESJAISREXXX", ":57A:ESJAISREXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/ICELAND.txt')
	* def finalMt103 = content.replaceAll("59:IS140159260076545510730339", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
