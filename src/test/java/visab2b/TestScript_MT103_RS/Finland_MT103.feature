...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPFINLAND" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103FINLAND2024020001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsFinlandmt103rspostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for FINLAND country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
  * def referencenumber = "AUTOMT103SFTPFINLAND" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103FINLAND2024020001", "20:" + referencenumber ).replaceAll("32A:200408EUR123", "32A:200408ALL138.28").replaceAll(":59:/FI2112345600000785", ":59:/6508000000192000145")
  * print finalMt103  
  * jutil.SetData("GetAuditsFinlandmt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
	* def finalMt103 = content.replaceAll("20:MT103FINLAND2024020001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
	* def finalMt103 = content.replaceAll(":57A:SNDAFIH1XXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
	* def finalMt103 = content.replaceAll(":57A:SNDAFIH1XXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
	* def finalMt103 = content.replaceAll(":57A:SNDAFIH1XXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
	* def finalMt103 = content.replaceAll(":57A:SNDAFIH1XXX", ":57A:SNDAFIH1XXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/FINLAND.txt')
	* def finalMt103 = content.replaceAll("59:/FI2112345600000785", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
