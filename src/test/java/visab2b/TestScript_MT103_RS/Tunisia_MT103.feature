...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPTUNISIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10TND20220867556434345858", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsTunisiamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10TND20220867556434345858", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:ATBKTNTTXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:ATBKTNTTXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
	* def finalMt103 = content.replaceAll(":59:/TN5910006035183598478831", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Tunisia country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
  * def referencenumber = "AUTOMT103SFTPTUNISIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10TND20220867556434345858", "20:" + referencenumber ).replaceAll(":32A:200408TND138,28", ":32A:200408USD138.28").replaceAll(":70:/POP/Testing", "70:"  )
  * print finalMt103
  * jutil.SetData("GetAuditsTunisiamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:ATBKTNTTXXX", ":57A:ABCDAAAAAAAA"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * match response.error.message contains validations.InvalidBic
	 ...
	 Scenario: Currency is empty
	 * def content = read('classpath:visab2b/MT103_files/TUNISIA.txt')
	 * def finalMt103 = content.replaceAll(":32A:200408TND138,28", ":32A:200408138,28"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
