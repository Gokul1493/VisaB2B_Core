Feature: ANTIGUA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTP" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103ANTIGUA345447448", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsANTIGUAmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll("20:MT103ANTIGUA345447448", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll(":57A:ANCBAGAGXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll(":57A:ANCBAGAGXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll(":57A:ANCBAGAGXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll("59:/098574898768", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed for Antigua", "70:"  ).replaceAll("20:MT103ANTIGUA345447448", "20:MT103SFTPALBENIA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- starting with double slash
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed for Antigua", "70://POP/Payment as agreed for ANTIGUA"  ).replaceAll("20:MT103ANTIGUA345447448", "20:MT103SFTPALBENIA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for albania country with different currency  (currency:- USD)
    ...
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103ANTIGUA345447448", "20:" + referencenumber ).replaceAll(":32A:200408XCD138.28", ":32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditsANTIGUAmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Currency as empty
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
    * def finalMt103 = content.replaceAll("32A:200408XCD138.28", "32A:200408138.28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  @ignore
  Scenario: Debtor name with 90 percent match
    * def content = read('classpath:visab2b/MT103_files/ANTIGUA.txt')
