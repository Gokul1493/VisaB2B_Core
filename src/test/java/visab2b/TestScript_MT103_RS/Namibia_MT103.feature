Feature: Namibia_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditsnamibiamt103rspostive",referencenumber)
  ...
  Scenario: Transaction initated for Namibia country with different currency  (currency:- USD)
    ...
    * def referencenumber = "AUTONAMIBIA0010" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber ).replaceAll("32A:200408EUR138", "32A:200408ALL138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsNamibiamt103othercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/NAMIBIA.txt')
    * def finalMt103 = content.replaceAll("20:AUTONAMIBIA0010", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/NAMIBIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CBKNNANXXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/NAMIBIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CBKNNANXXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/NAMIBIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CBKNNANXXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/NAMIBIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CBKNNANXXXX", ":57A:CBKNNANXXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/NAMIBIA.txt')
    * def finalMt103 = content.replaceAll("59:5467687645351345", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
