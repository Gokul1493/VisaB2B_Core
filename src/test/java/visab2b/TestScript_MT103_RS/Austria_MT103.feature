Feature: AUSTRIA_MT103
  ...
  Scenario: verify the invalid iban
    ...
    * def iban = "SDSDFAXXX"
    * print iban
    * def finalMt103 = content.replaceAll("57A:BKAUATWWXXX", "57A:" + iban  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: verify the iban as empty
    * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
    * def finalMt103 = content.replaceAll(":59:/AT611904300234573201", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
    * def finalMt103 = content.replaceAll("20:SFTPAUSTRIA3276754549", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
    * def finalMt103 = content.replaceAll(":57A:BKAUATWWXXX", "57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
    * def finalMt103 = content.replaceAll(":57A:BKAUATWWXXX", "57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Austria country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
