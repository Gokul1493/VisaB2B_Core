...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPIRELAND" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103IRELAND20240402001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsirelandmt103rspostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for IRELAND country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
  * def referencenumber = "AUTOMT103SFTPIRELAND" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103IRELAND20240402001", "20:" + referencenumber ).replaceAll("32A:200408EUR12.98", "32A:200408USD138.28").replaceAll(":59:/IE29AIBK93115212345678", ":59:/6508000000192000145")
  * print finalMt103  
  * jutil.SetData("GetAuditsirelandmt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
	* def finalMt103 = content.replaceAll("20:MT103IRELAND20240402001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:BOFIIE2DXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:BOFIIE2DXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:BOFIIE2DXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
	* def finalMt103 = content.replaceAll(":57A:BOFIIE2DXXX", ":57A:BOFIIE2DXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/IRELAND.txt')
	* def finalMt103 = content.replaceAll("59:/IE29AIBK93115212345678", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
