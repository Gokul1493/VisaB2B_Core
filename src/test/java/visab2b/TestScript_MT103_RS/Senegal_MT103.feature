Feature: SENEGAL_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditPositiveSenegal",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/SENEGAL.txt')
    * def finalMt103 = content.replaceAll("20:MT103SENAGALSUBMIT", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/SENEGAL.txt')
    * def finalMt103 = content.replaceAll(":57A:ASSASNDAXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/SENEGAL.txt')
    * def finalMt103 = content.replaceAll(":57A:ASSASNDAXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/SENEGAL.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/VO23456 senegal", ":70:"  ).replaceAll("20:MT103SENAGALSUBMIT", "20:MT103SFTPPANAMA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Senegal country with different currency  (currency:- USD)
    ...
    * def referencenumber = "AUTOMT103SFTPSENEGAL" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103SENAGALSUBMIT", "20:" + referencenumber ).replaceAll(":32A:200408XOF138,28", ":32A:200408USD138.28").replaceAll("70:/POP/Testing", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditCrossBorderSenegal",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/SENEGAL.txt')
    * def finalMt103 = content.replaceAll(":57A:ASSASNDAXXX", ":57A:RZBSRSBGXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
