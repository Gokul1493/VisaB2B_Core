Feature: COTEDIVOIRE_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPCOTEDIVOIRE" + Accno
  ...
  Scenario: Transaction initated for COTEDIVOIRE country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def referencenumber = "AUTOMT103SFTPCOTEDIVOIRE" + Accno
    * print referencenumber
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll("20:MT103COTIEDIVOIRE202401040001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll(":57A:AFDBCIABXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll(":57A:AFDBCIABXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll(":57A:AFDBCIABXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll(":57A:AFDBCIABXXX", ":57A:AFDBCIABXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll("59:/123456789123456789123789", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber Less than 24 characterss
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll("59:/123456789123456789123789", "59:/12345678912345678912378"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    ...
    * def value = signsreq(reqadd,user)
    ...
    When method POST
    Then status 200
    * match response.error.message contains validations.MT103_AccNo_24Char

  Scenario: CreditorIBAN/AccountNumber More than 24 characterss
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll("59:/123456789123456789123789", "59:/1234567891234567891237891"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/COTEDIVOIRE.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/Payment as agreed COTEDIVOIRE", ":70:"  ).replaceAll("20:MT103COTIEDIVOIRE202401040001", "20:AUTOMT103SFTPCOTEDIVOIRE" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
