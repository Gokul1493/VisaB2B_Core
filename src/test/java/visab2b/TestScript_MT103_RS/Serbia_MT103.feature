...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPSERBIA" + Accno
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/SERBIA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10RSD20220867557563662121", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/SERBIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:RZBSRSBGXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/SERBIA.txt')
	* def finalMt103 = content.replaceAll(":59:/BH90RZBS61767777777777", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Serbia country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/SERBIA.txt')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * match response.error.message contains validations.InvalidBic
	 ...
	 Scenario: Payment of purpose is null
	 * def content = read('classpath:visab2b/MT103_files/SERBIA.txt')
