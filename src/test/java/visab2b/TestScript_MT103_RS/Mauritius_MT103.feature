Feature: MAURITIUS_MT103
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/MAURITIUS.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT103MAUTRITIUS55465434356", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/MAURITIUS.txt')
    * def finalMt103 = content.replaceAll(":57A:BOMMMUPLXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/MAURITIUS.txt')
    * def finalMt103 = content.replaceAll(":57A:BOMMMUPLXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/MAURITIUS.txt')
    * def finalMt103 = content.replaceAll("70:/POP/purpose of payment for Mauritius", "70:"  ).replaceAll("20:2603001SFTPMT103MAUTRITIUS55465434356", "20:MT103SFTPMAURITIUS" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic More than 11 digits
    * def content = read('classpath:visab2b/MT103_files/MAURITIUS.txt')
    * def finalMt103 = content.replaceAll(":57A:BOMMMUPLXXX", ":57A:BOMMMUPLXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
