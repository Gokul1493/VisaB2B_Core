Feature: ELSALVADOR_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPELSALVADOR" + Accno
  ...
  Scenario: Transaction initated for ELSALVADOR country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def referencenumber = "AUTOMT103SFTPELSALVADOR" + Accno
    * print referencenumber
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def finalMt103 = content.replaceAll("20:MT103EISALVADOR202404010001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def finalMt103 = content.replaceAll(":57A:BACUSVSSXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def finalMt103 = content.replaceAll(":57A:BACUSVSSXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def finalMt103 = content.replaceAll(":57A:BACUSVSSXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def finalMt103 = content.replaceAll(":57A:BACUSVSSXXX", ":57A:BACUSVSSXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/ELSALVADOR.txt')
    * def finalMt103 = content.replaceAll("59:/0000000000000123123", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
