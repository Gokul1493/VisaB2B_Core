Feature: SWITZERLAND_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPSWITZERLAND" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsswissmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll("20:MT10CHF2022086755733", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:KBAGCH22", "57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:KBAGCH22", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll(":59:/CH2289144633283464381", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Swiss country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def referencenumber = "AUTOMT103SFTPSWITZERLAND" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber ).replaceAll(":32A:200408CHF138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsswissmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic Less tha 8 digits
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:KBAGCH22", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
  ...
  Scenario: Creditor Bic More than 11 digits
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:KBAGCH22", ":57A:KBAGCH22ZZZZ"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Currency is empty
    * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
    * def finalMt103 = content.replaceAll(":32A:200408CHF138,28", ":32A:200408138,28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
