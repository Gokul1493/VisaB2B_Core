...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPGEORGIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103GEORGIA20240200001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsgeorgiamt103rspostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for GEORGIA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
  * def referencenumber = "AUTOMT103SFTPGEORGIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103GEORGIA20240200001", "20:" + referencenumber ).replaceAll("59:/GE29NB0000000101904917", "59:/9858855577"  ).replaceAll("32A:200408GEL12.98", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed GEORGIA", "70:")
  * print finalMt103
  * jutil.SetData("GetAuditsGeorgiamt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll("20:MT103GEORGIA20240200001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BAGAGE22XXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BAGAGE22XXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BAGAGE22XXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll(":57A:BAGAGE22XXX", ":57A:BAGAGE22XXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll("59:/GE29NB0000000101904917", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/GEORGIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/Payment as agreed GEORGIA", "70:"  ).replaceAll("20:MT103GEORGIA20240200001", "20:AUTOMT103SFTPGEORGIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
