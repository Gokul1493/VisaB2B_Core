Feature: BahrainBHD_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPBAHRAIN" + Accno
    ...
    * reqadd.params.Payload.swiftFiles[0].fileName = "BAHRAIN.txt"
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/BAHRAIN_BHD.txt')
    * def finalMt103 = content.replaceAll("20:MT103BHARAINSFTP202403260001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/BAHRAIN_BHD.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed Bahrain", "70:"  ).replaceAll("20:MT103BHARAINSFTP202403260001", "20:MT103SFTPALBENIA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- with double slash
    * def content = read('classpath:visab2b/MT103_files/BAHRAIN_BHD.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed Bahrain", "70://POP/Payment as agreed Bahrain"  ).replaceAll("20:MT103BHARAINSFTP202403260001", "20:MT103SFTPALBENIA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  @Ignore
  Scenario: Transaction initated for bahrainbhd country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/BAHRAIN_BHD.txt')
    * def referencenumber = "MT103BHARAINSFTP202403260001" + Accno
    * print referencenumber
