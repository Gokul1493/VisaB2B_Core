Feature: TRINIDADANDTOBAGO_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPTRINIDADANDTOBAGO" + Accno
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10TTD20220867556434345987", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
    * def finalMt103 = content.replaceAll(":57A:NOSCTTPSXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
    * def finalMt103 = content.replaceAll(":57A:NOSCTTPSXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/Testing", ":70:/"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Trinidadandtobago country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
  ...
  Scenario: Creditor Bic Greater than 11 digits
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
    * def finalMt103 = content.replaceAll(":57A:NOSCTTPSXXX", ":57A:NOSCTTPSXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Currency is empty
    * def content = read('classpath:visab2b/MT103_files/TRINIDADANDTOBAGO.txt')
    * def finalMt103 = content.replaceAll(":32A:200408TTD138,28", ":32A:200408138,28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
