Feature: POLAND_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPPOLAND" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PLN202208675575655", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditspolandmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/POLAND.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PLN202208675575655", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/POLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:BIGBPLPWXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/POLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:BIGBPLPWXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Poland country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/POLAND.txt')
    * def referencenumber = "MT103SFTPMALTA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PLN202208675575655", "20:" + referencenumber ).replaceAll(":32A:200408PLN138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditspolandmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic More than 11 digits
    * def content = read('classpath:visab2b/MT103_files/POLAND.txt')
    * def finalMt103 = content.replaceAll(":57A:BIGBPLPWXXX", ":57A:BIGBPLPWXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
