Feature: NICARAGUA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditsnicarmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/NICARAGUA.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10NICORIA220864535650", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/NICARAGUA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAPRNIMAXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/NICARAGUA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAPRNIMAXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/NICARAGUA.txt')
    * def finalMt103 = content.replaceAll(":59:/23224354657563847686454", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/NICARAGUA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/purpose of payment for Nicaragua", "70:"  ).replaceAll("20:2603001SFTPMT10NICORIA220864535650", "20:MT103SFTPMAURITIUS" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Nicaragua country with different currency  (currency:- USD)
    ...
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10NICORIA220864535650", "20:" + referencenumber ).replaceAll(":32A:200408NIO138,28", ":32A:200408USD138.28").replaceAll("70:/POP/Testing", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditsnicarmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/NICARAGUA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAPRNIMAXXX", ":57A:BAPRNIMAXXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
