Feature: NIGERIA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditsnigeriamt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10NIGERIA20220867543545", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CSCYNGLA", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CSCYNGLA", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll(":59:/2322435465756384768678544656", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/purpose of payment for Nigeria", "70:"  ).replaceAll("20:2603001SFTPMT10NIGERIA20220867543545", "20:MT103SFTPMAURITIUS" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Nigeria country with different currency  (currency:- USD)
    ...
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10NIGERIA20220867543545", "20:" + referencenumber ).replaceAll(":32A:200408NGN138,28", ":32A:200408USD138.28").replaceAll("70:/POP/Testing", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditsnigeriamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic LESSS THAN 8 DIGITS
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CSCYNGLA", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/NIGERIA.txt')
    * def finalMt103 = content.replaceAll(":57A:CSCYNGLA", ":57A:CSCYNGLAXXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
