Feature: HALTI_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPHALTI" + Accno
  ...
  Scenario: Transaction initated for HALTI country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def referencenumber = "AUTOMT103SFTPHALTI" + Accno
    * print referencenumber
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll("20:MT103HAITI202404020001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll(":57A:CPPLHTPPXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll(":57A:CPPLHTPPXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll(":57A:CPPLHTPPXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll(":57A:CPPLHTPPXXX", ":57A:CPPLHTPPXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll("59:/905436437658578", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/HALTI.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed HALTI", "70:"  ).replaceAll("20:MT103HAITI202404020001", "20:AUTOMT103SFTPHALTI" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
