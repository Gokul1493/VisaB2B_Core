Feature: ROMANIA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPROMANIA" + Accno
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/ROMANIA.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10RON2022086755756115", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Romania country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/ROMANIA.txt')
  ...
  Scenario: Creditor Bic Less than 11 digits
    * def content = read('classpath:visab2b/MT103_files/ROMANIA.txt')
