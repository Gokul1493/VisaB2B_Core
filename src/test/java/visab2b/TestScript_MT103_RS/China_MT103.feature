...
* print Accno
  ...
  * def content = read('classpath:visab2b/MT103_files/CHINA.txt')
  * def referencenumber = "AUTOMT103SFTPCHINA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103SFTPCHINA202401040001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsChinamt103rsmpostive",referencenumber)
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "CHINA.txt"
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for CHINA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/CHINA.txt')
  * def referencenumber = "AUTOMT103SFTPCHINA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103SFTPCHINA202401040001", "20:" + referencenumber ).replaceAll("32A:200408CNY18.28", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed CHINA", "70:").replaceAll("72:/CONT/Joe Smith", "72:/CONT/"  )
  * print finalMt103
  * jutil.SetData("GetAuditschinamt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103SFTPCHINA202401040001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll("20:MT103SFTPCHINA202401040001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll(":57A:ABOCCNBJ110", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll(":57A:ABOCCNBJ110", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll(":57A:ABOCCNBJ110", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll(":57A:ABOCCNBJ110", ":57A:ABOCCNBJ110X")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/CGODDR", "70:"  ).replaceAll("20:MT103SFTPCHINA202401040001", "20:AUTOMT103SFTPCHINA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.EmptyPOP
	...
	Scenario: CreditorContactName- as Empty
	* def content = read('classpath:visab2b/MT103_files/CHINA.txt')
	* def finalMt103 = content.replaceAll("72:/CONT/Joe Smith", "72:/CONT/"  ).replaceAll("20:MT103SFTPCHINA202401040001", "20:AUTOMT103SFTPCHINA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
