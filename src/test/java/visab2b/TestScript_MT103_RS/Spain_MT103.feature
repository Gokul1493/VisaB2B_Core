...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPSPAIN" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10EUR20220867557567531", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsspainmt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10EUR20220867557567531", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
	 * def finalMt103 = content.replaceAll(":57A:AYGBESMMXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
	 * def finalMt103 = content.replaceAll(":57A:AYGBESMMXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
	* def finalMt103 = content.replaceAll(":59:/ES1200753716916862595636", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Spain country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
  * def referencenumber = "AUTOMT103SFTPSPAIN" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10EUR20220867557567531", "20:" + referencenumber ).replaceAll(":32A:200408EUR138,28", ":32A:200408USD138.28")
  * print finalMt103
  * jutil.SetData("GetAuditsspainmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
	 * def finalMt103 = content.replaceAll(":57A:AYGBESMMXXX", ":57A:AYGBESMMXXXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/SPAIN.txt')
	 * def finalMt103 = content.replaceAll(":32A:200408EUR138,28", ":32A:200408138,28"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
