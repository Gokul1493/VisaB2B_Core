...
* def validations = validation_Messages.Validations
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditsUkrainemt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/UKRAINE.txt')
    * def finalMt103 = content.replaceAll("20:AutoUkraine001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/UKRAINE.txt')
    * def finalMt103 = content.replaceAll(":57A:RADAUA2NXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/UKRAINE.txt')
    * def finalMt103 = content.replaceAll(":57A:RADAUA2NXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/UKRAINE.txt')
    * def finalMt103 = content.replaceAll(":59:546486542354", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for albania country with different currency  (currency:- USD)
    ...
    * def referencenumber = "AutoUkraine001" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:AutoUkraine001", "20:" + referencenumber ).replaceAll(":32A:200408TZS138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsUkrainemt103rsothercurrency",referencenumber)
        * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
    ...
    * def content = read('classpath:visab2b/MT103_files/UKRAINE.txt')
    * def finalMt103 = content.replaceAll(":57A:RADAUA2NXXX", ":57A:TANZTZTXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    ...
    * def content = read('classpath:visab2b/MT103_files/UKRAINE.txt')
    * def finalMt103 = content.replaceAll(":32A:240529UAH10", ":32A:24052910"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
