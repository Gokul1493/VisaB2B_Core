Feature: SINGAPORE_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPSINGAPORE" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10SGD2022086755756359", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditssingaporemt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/SINGAPORE.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10SGD2022086755756359", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/SINGAPORE.txt')
    * def finalMt103 = content.replaceAll(":57A:INGPSGSGXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/SINGAPORE.txt')
    * def finalMt103 = content.replaceAll(":57A:INGPSGSGXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/SINGAPORE.txt')
    * def finalMt103 = content.replaceAll(":59:/4152648451201", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Singapore country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/SINGAPORE.txt')
    * def referencenumber = "MT103SFTPMALTA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10SGD2022086755756359", "20:" + referencenumber ).replaceAll(":32A:200408SGD138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditssingaporemt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/SINGAPORE.txt')
    * def finalMt103 = content.replaceAll(":57A:INGPSGSGXXX", ":57A:INGPSGSGXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
