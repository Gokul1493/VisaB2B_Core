Feature: botswana_MT103
  ...
  Scenario: Transaction initated for botswana country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/BOTSWANA.txt')
    * def referencenumber = "AutoBotswana0010" + Accno
    * print referencenumber
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/BOTSWANA.txt')
    * def finalMt103 = content.replaceAll("20:AutoBotswana0010", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/BOTSWANA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBOTBWGXXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/BOTSWANA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBOTBWGXXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/BOTSWANA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBOTBWGXXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/BOTSWANA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBOTBWGXXXX", ":57A:BBOTBWGXXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    ...
    * def referencenumber = "AutoBotswana0010" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("59:21545448787502", "59:").replaceAll("20:AutoBotswana0010", "20:" + referencenumber )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
