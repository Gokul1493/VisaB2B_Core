...
* def validations = validation_Messages.Validations
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
    * def finalMt103 = content.replaceAll("20:AUTOMT103SFTPBelarus", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
    * def finalMt103 = content.replaceAll(":57A:AKBBBY2XXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
    * def finalMt103 = content.replaceAll(":57A:AKBBBY2XXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for albania country with different currency  (currency:- USD)
    ...
    * def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
    * def finalMt103 = content.replaceAll(":57A:AKBBBY2XXXX", ":57A:TANZTZTXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
