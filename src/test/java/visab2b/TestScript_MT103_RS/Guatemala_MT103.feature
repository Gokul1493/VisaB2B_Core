Feature: GUATEMALA_MT103
  ...
  Scenario: Positive flow of the transaction with 11 Digit tax ID
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll("20:MT103GUTEMALA2024010001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAGUGTGCXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAGUGTGCXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAGUGTGCXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll(":57A:BAGUGTGCXXX", ":57A:BAGUGTGCXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll("59:/GT82TRAJ01020000001210029690", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Purpose of payment	GUATEMALA", "70:"  ).replaceAll("20:MT103GUTEMALA2024010001", "20:AUTOMT103SFTPGUATEMALA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: 11-digit Beneficiary Tax ID- as Empty
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll("72:/INN/11223344556", "72:/INN/"  ).replaceAll("20:MT103GUTEMALA2024010001", "20:AUTOMT103SFTPGUATEMALA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: More than 11-digit Beneficiary Tax ID
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll("72:/INN/11223344556", "72:/INN/112233445566"  ).replaceAll("20:MT103GUTEMALA2024010001", "20:AUTOMT103SFTPGUATEMALA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Less than 11-digit Beneficiary Tax ID
    * def content = read('classpath:visab2b/MT103_files/GUATEMALA.txt')
    * def finalMt103 = content.replaceAll("72:/INN/11223344556", "72:/INN/1122334455"  ).replaceAll("20:MT103GUTEMALA2024010001", "20:AUTOMT103SFTPGUATEMALA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
