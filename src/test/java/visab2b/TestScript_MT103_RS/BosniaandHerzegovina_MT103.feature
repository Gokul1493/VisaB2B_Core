Feature: BOSNIAANDHERZEGOVINA_MT103
...
* print Accno
  ...
  * print finalMt103
  * jutil.SetData("GetAuditPositiveBosniaandHerzegovina",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for BOSNIAANDHERZEGOVINA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
  * def referencenumber = "AUTOMT103SFTPBOSNIAANDHERZEGOVINA" + Accno
  * print referencenumber
  ...
  * print finalMt103
  * jutil.SetData("GetAuditCrossBorderBosniaandHerzegovina",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
	* def finalMt103 = content.replaceAll("20:MT103BOSINIAHERZEGO202430030001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
	* def finalMt103 = content.replaceAll(":57A:BBIBBA22XXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
	* def finalMt103 = content.replaceAll(":57A:BBIBBA22XXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
	* def finalMt103 = content.replaceAll(":57A:BBIBBA22XXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
	* def finalMt103 = content.replaceAll(":57A:BBIBBA22XXX", ":57A:BBIBBA22XXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/BOSNIAANDHERZEGOVINA.txt')
	* def finalMt103 = content.replaceAll("59:/BY13NBRB3600900000002Z00AB00", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
