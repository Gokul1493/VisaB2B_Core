...
* print Accno
  ...
  * print finalMt103
  * jutil.SetData("GetAuditsjanpanmt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/JAPAN.txt')
	* def finalMt103 = content.replaceAll("20:MT10JPY202208645435438", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/JAPAN.txt')
	 * def finalMt103 = content.replaceAll(":57A:BOJPJPJTXXX", "57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/JAPAN.txt')
	 * def finalMt103 = content.replaceAll(":57A:BOJPJPJTXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/JAPAN.txt')
	* def finalMt103 = content.replaceAll("59:/JP47212110090000000235698741", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Japan country with different currency  (currency:- USD)
  ...
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT10JPY202208645435438", "20:" + referencenumber ).replaceAll(":32A:200408ALL138.28", ":32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed", "70:"  )
  * print finalMt103
  * jutil.SetData("GetAuditsjapanmt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
 ...
 * match response.result.message == validations.successMessage
 ...
 Scenario: Creditor Bic Less than 8 digits
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/JAPAN.txt')
	 * def finalMt103 = content.replaceAll(":57A:BOJPJPJTXXX", ":57A:BOJPJPJTXXXXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
