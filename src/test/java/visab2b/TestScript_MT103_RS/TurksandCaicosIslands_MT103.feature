Feature: TURKSANDCAICOSISLANDS_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPTURKSANDCAICOSISLANDS" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10USD2022086755643435676", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditPositiveTurksandCaicosIslands",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10USD2022086755643435676", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:TCBCTCGPXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:TCBCTCGPXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def finalMt103 = content.replaceAll(":59:/2322435465756384762322222221", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Turksandcaicosislands country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def referencenumber = "AUTOMT103SFTPTURKSANDCAICOSISLANDS" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10USD2022086755643435676", "20:" + referencenumber ).replaceAll(":32A:200408USD138,28", ":32A:200408USD138.28").replaceAll(":70:/POP/Testing", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditCrossBorderTurksandCaicosIslands",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Currency as Empty
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def finalMt103 = content.replaceAll(":32A:200408USD138,28", ":32A:200408138,28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic greater than 11 digits
    * def content = read('classpath:visab2b/MT103_files/TURKSANDCAICOSISLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:TCBCTCGPXXX", ":57A:TCBCTCGPXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
