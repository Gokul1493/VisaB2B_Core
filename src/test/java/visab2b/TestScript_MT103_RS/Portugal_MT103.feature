Feature: PORTUGAL_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPPORTUGAL" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPSFTPPORTUGAL8975575625", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsportugalmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/PORTUGAL.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPSFTPPORTUGAL8975575625", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/PORTUGAL.txt')
    * def finalMt103 = content.replaceAll(":57A:PRTTPTP2XXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/PORTUGAL.txt')
    * def finalMt103 = content.replaceAll(":57A:PRTTPTP2XXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/PORTUGAL.txt')
    * def finalMt103 = content.replaceAll(":59:/PL61109010140000071219812874", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Portugal country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/PORTUGAL.txt')
    * def referencenumber = "MT103SFTPMALTA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPSFTPPORTUGAL8975575625", "20:" + referencenumber ).replaceAll(":32A:200408EUR138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsportugalmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/PORTUGAL.txt')
    * def finalMt103 = content.replaceAll(":57A:PRTTPTP2XXX", ":57A:PRTTPTP2XXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
