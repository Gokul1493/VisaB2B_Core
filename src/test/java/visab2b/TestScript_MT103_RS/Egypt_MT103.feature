Feature: EGYPT_MT103
  ...
  Scenario: Positive flow of the transaction with 12 Digit tax ID
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def referencenumber = "AUTOMT103SFTPEGYPT" + Accno
  ...
  ## Maker user intiate the transaction
  Scenario: Positive flow of the transaction with 13 Digit tax ID
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def referencenumber = "AUTOMT103SFTPEGYPT" + Accno
    * print referencenumber
  ...
  ## Maker user intiate the transaction
  Scenario: Positive flow of the transaction with 14 Digit tax ID
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def referencenumber = "AUTOMT103SFTPEGYPT" + Accno
    * print referencenumber
  ...
  ## Maker user intiate the transaction
  Scenario: Positive flow of the transaction with 15 Digit tax ID
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def referencenumber = "AUTOMT103SFTPEGYPT" + Accno
    * print referencenumber
  ...
  Scenario: Transaction initated for EGYPT country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def referencenumber = "AUTOMT103SFTPEGYPT" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber ).replaceAll("72:/BBB/Downtown Branch", "72:/BBB/"  ).replaceAll("32A:200408EGP134,67", "32A:200408USD138.28").replaceAll("70:/POP/Purpose of payment	EGYPT", "70:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll("20:MT103EGYPT20240204001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll(":57A:CBEGEGCXXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll(":57A:CBEGEGCXXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll(":57A:CBEGEGCXXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll(":57A:CBEGEGCXXXX", ":57A:CBEGEGCXXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Purpose of payment	EGYPT", "70:"  ).replaceAll("20:MT103EGYPT20240204001", "20:AUTOMT103SFTPEGYPT" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Branch Name- as Empty
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll("72:/BBB/Downtown Branch", "72:/BBB/"  ).replaceAll("20:MT103EGYPT20240204001", "20:AUTOMT103SFTPEGYPT" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Brach Name below 3 character
    * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
    * def finalMt103 = content.replaceAll("72:/BBB/Downtown Branch", "72:/BBB/DO"  ).replaceAll("20:MT103EGYPT20240204001", "20:AUTOMT103SFTPEGYPT" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
