...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPUGANDA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10UGX20220867556434344543142146", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsugnadamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10UGX20220867556434344543142146", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	 * def finalMt103 = content.replaceAll(":57A:UGBAUGKAXXX", "57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	 * def finalMt103 = content.replaceAll(":57A:UGBAUGKAXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	* def finalMt103 = content.replaceAll(":59:/23224354657563847686784524356", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/UGX for Uganda", "70:").replaceAll("20:2603001SFTPMT10RSD20220867557563662121", "20:MT103SFTPUGANDA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Uganda country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
  * def referencenumber = "AUTOMT103SFTPUGANDA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10UGX20220867556434344543142146", "20:" + referencenumber ).replaceAll(":32A:200408UGX138,28", ":32A:200408USD138.28").replaceAll(":70:/POP/UGX", "70:"  )
  * print finalMt103
  * jutil.SetData("GetAuditsugandamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	* def finalMt103 = content.replaceAll(":32A:200408UGX138,28", ":32A:200408138,28"  ).replaceAll("20:AUTOUGANDAMT103", "20:AUTOUGANDAMT103" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.MT103_Invalid_CurMin3Alpha
	...
	Scenario: BIC less than 8 digits
	* def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	* def finalMt103 = content.replaceAll(":57A:UGBAUGKAXXX", ":57A:UGBA"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.InvalidBic
	...
	Scenario: BIC Greater than 11 digits
	* def content = read('classpath:visab2b/MT103_files/UGANDA.txt')
	* def finalMt103 = content.replaceAll(":57A:UGBAUGKAXXX", ":57A:UGBAUGKAXXXX"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
