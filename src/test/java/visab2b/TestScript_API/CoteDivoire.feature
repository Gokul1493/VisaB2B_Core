Feature: Cote Divoire Transaction
...
* def ref = "CoteDivoireAPI"+ jUtil.PLtoken()
* req.params.Payload.EndToEndIdentification = ref
* req.params.Payload.CreditorAgent.ClearingMemberId = "BS234567"
* def user = testData.Visa_API_MK
* req.params.Api.Credential = testData.Visa_API_MK.Credential

Scenario: Cote Divoire Positive flow
* req.params.Payload.CreditorAgent.Bic = "AFRICIABXXX"
...
* jUtil.SetData("GetAuditsCoteDivoireAPIpostive",ref)
...
Scenario: Cote Divoire Positive flow with other currency code (ALL)
...
* jUtil.SetData("GetAuditsCoteDivoireAPIothercurrency",ref)
* def value = signsreq(req,user)
* request value
* method post
* status 200
...
Scenario: Cote Divoire Bic as Invalid
...
Scenario: Cote Divoire Bic as Empty
...
Scenario: Cote Divoire AccountNumber as Empty
* req.params.Payload.CreditorAgent.Bic = "AFDBCIABXXX"
* req.params.Payload.InstructedAmount.Currency = "XOF"
...
Scenario: Cote Divoire purpose as Empty
* req.params.Payload.CreditorAgent.Bic = "AFDBCIABXXX"
* req.params.Payload.InstructedAmount.Currency = "XOF"
* req.params.Payload.CreditorAccount.AccountNumber = "685390075470346663456789"
* req.params.Payload.PaymentPurpose = ""
...
Scenario: Cote Divoire AccountNumber Less than 24 characters
* req.params.Payload.CreditorAgent.Bic = "AFDBCIABXXX"
* req.params.Payload.InstructedAmount.Currency = "XOF"
...
Scenario: Cote Divoire AccountNumber Greater than 24 characters
* req.params.Payload.CreditorAgent.Bic = "AFDBCIABXXX"
* req.params.Payload.InstructedAmount.Currency = "XOF"
