...
* def ref = "BelgiumAPI"+ jUtil.PLtoken()
* req.params.Payload.EndToEndIdentification = ref
* req.params.Payload.CreditorAgent.ClearingMemberId = "BS234567"
* def user = testData.Visa_API_MK
* req.params.Api.Credential = testData.Visa_API_MK.Credential

Scenario: Belgium Positive flow
* req.params.Payload.CreditorAgent.Bic = "AARBBEB1XXX" 
...
* jUtil.SetData("GetAuditsBelgiumAPIpostive",ref)
...
* jUtil.SetData("GetAuditsBelgiumAPIothercurrency",ref)
* def value = signsreq(req,user)
* request value
* method post
* status 200
...
Scenario: Belgium Bic as Invalid
...
Scenario: Belgium iban as Empty
* req.params.Payload.CreditorAgent.Bic = "AARBBEB1XXX"
* req.params.Payload.InstructedAmount.Currency = "EUR"
