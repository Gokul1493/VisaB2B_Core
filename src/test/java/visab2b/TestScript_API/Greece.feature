...
* def ref = "GreeceAPI"+ jUtil.PLtoken()
* req.params.Payload.EndToEndIdentification = ref
* req.params.Payload.CreditorAgent.ClearingMemberId = "BS234567"
* def user = testData.Visa_API_MK
* req.params.Api.Credential = testData.Visa_API_MK.Credential

Scenario: Greece Positive flow
* req.params.Payload.CreditorAgent.Bic = "BNGRGRAAACO"
* req.params.Payload.InstructedAmount.Currency = "EUR"
* req.params.Payload.CreditorAccount.Iban = "GR9608100010000001234567890"
* jUtil.SetData("GetAuditsGreeceAPIpostive",ref)
...
Scenario: Greece Positive flow with usd currency
* req.params.Payload.CreditorAgent.Bic = "BNGRGRAAACO"
* req.params.Payload.InstructedAmount.Currency = "USD"
* req.params.Payload.CreditorAccount.Iban = "GR9608100010000001234567890"
* jUtil.SetData("GetAuditsGreeceAPIothercurrency",ref)
* def value = signsreq(req,user)
* request value
* method post
* status 200
...
Scenario: Greece Positive flow Without enterprise id
* req.params.Payload.CreditorAgent.Bic = "BNGRGRAAACO"
* req.params.Payload.InstructedAmount.Currency = "EUR"
* req.params.Payload.CreditorAccount.Iban = "GR9608100010000001234567890"
* req.params.Payload.DebtorAccount.EnterpriseId = ""
* jUtil.SetData("GetAuditsGreeceAPIpostivewithoutEID",ref)
* def value = signsreq(req,user)
* request value
* method post
* status 200
