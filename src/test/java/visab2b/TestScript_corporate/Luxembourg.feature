Feature: Luxembourg
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Luxembourg.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Luxembourg.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Luxembourg.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Luxembourg.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Luxembourg.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Luxembourg.creditorName
    * match creditorAgentBic == beneTestData.Luxembourg.creditorAgentBic
    * match creditorIBAN == beneTestData.Luxembourg.creditorIBAN
    * match creditorAddress == beneTestData.Luxembourg.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Luxembourg.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Luxembourg.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Luxembourg.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Luxembourg.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Luxembourg.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Luxembourg.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Luxembourg.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Luxembourg.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Luxembourg.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
