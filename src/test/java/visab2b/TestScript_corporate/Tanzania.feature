Feature: Tanzania
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Tanzania.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Tanzania.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Tanzania.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Tanzania.creditorAddress
    * beneficiaries.params.payload.beneficiary.CreditorAgentBranchName = beneTestData.Tanzania.CreditorAgentBranchName
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Tanzania.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Tanzania.creditorName
    * match creditorAgentBic == beneTestData.Tanzania.creditorAgentBic
    * match creditorIBAN == beneTestData.Tanzania.creditorIBAN
    * match creditorAddress == beneTestData.Tanzania.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Tanzania.instructedCurrency
	 * Transactions.params.payload.instructedAmount.branchName = beneTestData.Tanzania.CreditorAgentBranchName
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Tanzania.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Tanzania.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Tanzania.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Tanzania.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Tanzania.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Tanzania.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Tanzania.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Tanzania.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
