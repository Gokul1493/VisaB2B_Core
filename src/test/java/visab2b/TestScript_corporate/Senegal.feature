Feature: Application Login
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Senegal.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Senegal.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Senegal.creditorName
    * beneficiaries.params.payload.beneficiary.creditorContactPhoneNumber = beneTestData.Senegal.creditorContactPhoneNumber
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Senegal.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Senegal.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Senegal.creditorName
    * match creditorAgentBic == beneTestData.Senegal.creditorAgentBic
    * match creditorIBAN == beneTestData.Senegal.creditorIBAN
    * match creditorAddress == beneTestData.Senegal.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Senegal.instructedCurrency
	 * Transactions.params.payload.creditorAccount.accountNumber = beneTestData.Senegal.creditorAccountNumber
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Senegal.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Senegal.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Senegal.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Senegal.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Senegal.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Senegal.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Senegal.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Senegal.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
