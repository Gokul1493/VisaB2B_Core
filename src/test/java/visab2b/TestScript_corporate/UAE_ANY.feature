Feature: UAE
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.UAE.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.UAE.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.UAE.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.UAE.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.UAE.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.UAE.creditorName
    * match creditorAgentBic == beneTestData.UAE.creditorAgentBic
    * match creditorIBAN == beneTestData.UAE.creditorIBAN
    * match creditorAddress == beneTestData.UAE.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.UAE.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UAE.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.UAE.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.UAE.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UAE.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.UAE.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UAE.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UAE.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.UAE.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
