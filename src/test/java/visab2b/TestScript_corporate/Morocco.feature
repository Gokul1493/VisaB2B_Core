Feature: Morocco
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Morocco.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Morocco.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Morocco.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Morocco.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Morocco.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Morocco.creditorName
    * match creditorAgentBic == beneTestData.Morocco.creditorAgentBic
    * match creditorIBAN == beneTestData.Morocco.creditorIBAN
    * match creditorAddress == beneTestData.Morocco.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Morocco.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Morocco.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Morocco.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Morocco.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Morocco.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Morocco.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Morocco.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Morocco.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Morocco.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
