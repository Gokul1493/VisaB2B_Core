Feature: Nigeria
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Nigeria.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Nigeria.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Nigeria.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Nigeria.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Nigeria.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Nigeria.creditorName
    * match creditorAgentBic == beneTestData.Nigeria.creditorAgentBic
    * match creditorIBAN == beneTestData.Nigeria.creditorIBAN
    * match creditorAddress == beneTestData.Nigeria.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Nigeria.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Nigeria.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Nigeria.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Nigeria.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Nigeria.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Nigeria.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Nigeria.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Nigeria.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Nigeria.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
