Feature: Portugal
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Portugal.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Portugal.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Portugal.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Portugal.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Portugal.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Portugal.creditorName
    * match creditorAgentBic == beneTestData.Portugal.creditorAgentBic
    * match creditorIBAN == beneTestData.Portugal.creditorIBAN
    * match creditorAddress == beneTestData.Portugal.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Portugal.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Portugal.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Portugal.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Portugal.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Portugal.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Portugal.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Portugal.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Portugal.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Portugal.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
