Feature: Netherlands
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Netherlands.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Netherlands.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Netherlands.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Netherlands.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Netherlands.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Netherlands.creditorName
    * match creditorAgentBic == beneTestData.Netherlands.creditorAgentBic
    * match creditorIBAN == beneTestData.Netherlands.creditorIBAN
    * match creditorAddress == beneTestData.Netherlands.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Netherlands.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Netherlands.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Netherlands.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Netherlands.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Netherlands.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Netherlands.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Netherlands.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Netherlands.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Netherlands.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
