Feature: Slovenia(SL)
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Slovenia.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Slovenia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Slovenia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Slovenia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Slovenia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Slovenia.creditorName
    * match creditorAgentBic == beneTestData.Slovenia.creditorAgentBic
    * match creditorIBAN == beneTestData.Slovenia.creditorIBAN
    * match creditorAddress == beneTestData.Slovenia.creditorAddress
    #Select Beneficiary
...
@withoutamount
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Slovenia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Slovenia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Slovenia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Slovenia.creditorIBAN
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    * Transactions.params.payload.beneficiaryId = beneficiaryid_value
    * Transactions.params.payload.creditorAccount.name = beneTestData.Slovenia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Slovenia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Slovenia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
  ...
  Scenario: Transactions for Slovenia
