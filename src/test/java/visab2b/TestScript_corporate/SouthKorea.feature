Feature: SouthKorea
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.SouthKorea.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.SouthKorea.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.SouthKorea.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAgentClearingMemberID = beneTestData.SouthKorea.creditorAgentClearingMemberID
    * beneficiaries.params.payload.beneficiary.creditorContactPhoneNumber = beneTestData.SouthKorea.creditorContactPhoneNumber
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.SouthKorea.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.SouthKorea.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.SouthKorea.creditorName
    * match creditorAgentBic == beneTestData.SouthKorea.creditorAgentBic
    * match creditorIBAN == beneTestData.SouthKorea.creditorIBAN
    * match creditorAddress == beneTestData.SouthKorea.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.SouthKorea.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.instructedAmount.amount = ""
    #* Transactions.params.payload.paymentPurpose= "POP"
    * Transactions.params.payload.creditorAccount.name = beneTestData.SouthKorea.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.SouthKorea.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.SouthKorea.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.SouthKorea.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.SouthKorea.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.SouthKorea.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.SouthKorea.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.SouthKorea.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
  ...
  Scenario: positive with BIC as 8-Digit
    Given url 'https://connectors.cbwpayments.com/visab2b/api'
    # generate Totp
  ...
  Scenario: positive with BIC as 11-Digit
    Given url 'https://connectors.cbwpayments.com/visab2b/api'
    # generate Totp
    * def Gauth = testData.Visa_CorporateMK.gauth
    * def Totp = jutil.getTOTPCode(Gauth)
    ...
    * def auth = "Bearer "+ bearer
    * configure headers = {"Authorization":'#(auth)'}
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = "KOEXKRSEXXX"
    * beneficiaries.params.payload.beneficiary.creditorAgentClearingMemberID = ""
    * def user = testData.Visa_CorporateMK
    * beneficiaries.params.api.deviceId = user.keyId
    * def sig = signscorp(beneficiaries,user)
    * request beneficiaries
  ...
  Scenario: invalid ClearingMemberID
    Given url 'https://connectors.cbwpayments.com/visab2b/api'
    # generate Totp
    * def Gauth = testData.Visa_CorporateMK.gauth
    * def Totp = jutil.getTOTPCode(Gauth)
    ...
    * def auth = "Bearer "+ bearer
    * configure headers = {"Authorization":'#(auth)'}
    * beneficiaries.params.payload.beneficiary.creditorAgentClearingMemberID = "0120"
    * def user = testData.Visa_CorporateMK
    * beneficiaries.params.api.deviceId = user.keyId
    * def sig = signscorp(beneficiaries,user)
    * request beneficiaries
  ...
  Scenario: without ClearingMemberID
    Given url 'https://connectors.cbwpayments.com/visab2b/api'
    # generate Totp
    * def Gauth = testData.Visa_CorporateMK.gauth
    * def Totp = jutil.getTOTPCode(Gauth)
  ...
  Scenario: invalid ContactPhoneNumber
    Given url 'https://connectors.cbwpayments.com/visab2b/api'
    # generate Totp
    * def Gauth = testData.Visa_CorporateMK.gauth
    * def Totp = jutil.getTOTPCode(Gauth)
    ...
    * def auth = "Bearer "+ bearer
    * configure headers = {"Authorization":'#(auth)'}
    * beneficiaries.params.payload.beneficiary.creditorContactPhoneNumber = "5798456545"
    * def user = testData.Visa_CorporateMK
    * beneficiaries.params.api.deviceId = user.keyId
    * def sig = signscorp(beneficiaries,user)
    * request beneficiaries
  ...
  Scenario: without ContactPhoneNumber
    Given url 'https://connectors.cbwpayments.com/visab2b/api'
    # generate Totp
    * def Gauth = testData.Visa_CorporateMK.gauth
    * def Totp = jutil.getTOTPCode(Gauth)
    ...
    * def auth = "Bearer "+ bearer
    * configure headers = {"Authorization":'#(auth)'}
    * beneficiaries.params.payload.beneficiary.creditorContactPhoneNumber = ""
    * def user = testData.Visa_CorporateMK
    * beneficiaries.params.api.deviceId = user.keyId
    * def sig = signscorp(beneficiaries,user)
    * request beneficiaries
