Feature: Pakistan
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Pakistan.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Pakistan.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Pakistan.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Pakistan.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Pakistan.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Pakistan.creditorName
    * match creditorAgentBic == beneTestData.Pakistan.creditorAgentBic
    * match creditorIBAN == beneTestData.Pakistan.creditorIBAN
    * match creditorAddress == beneTestData.Pakistan.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Pakistan.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Pakistan.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Pakistan.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Pakistan.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Pakistan.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Pakistan.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Pakistan.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Pakistan.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Pakistan.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
