Feature: Poland
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Poland.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Poland.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Poland.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Poland.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Poland.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Poland.creditorName
    * match creditorAgentBic == beneTestData.Poland.creditorAgentBic
    * match creditorIBAN == beneTestData.Poland.creditorIBAN
    * match creditorAddress == beneTestData.Poland.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Poland.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Poland.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Poland.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Poland.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Poland.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Poland.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Poland.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Poland.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Poland.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
