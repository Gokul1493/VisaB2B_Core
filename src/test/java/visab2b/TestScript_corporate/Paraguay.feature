Feature: Paraguay
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Paraguay.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Paraguay.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Paraguay.creditorName
    * beneficiaries.params.payload.beneficiary.creditorTaxID = beneTestData.Paraguay.creditorTaxID
    * beneficiaries.params.payload.beneficiary.CreditorAgentBranchName = beneTestData.Paraguay.CreditorAgentBranchName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Paraguay.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Paraguay.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Paraguay.creditorName
    * match creditorAgentBic == beneTestData.Paraguay.creditorAgentBic
    * match creditorIBAN == beneTestData.Paraguay.creditorIBAN
    * match creditorAddress == beneTestData.Paraguay.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAccount.TaxId = beneTestData.Paraguay.creditorTaxID
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Paraguay.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Paraguay.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Paraguay.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Paraguay.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Paraguay.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Paraguay.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Paraguay.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Paraguay.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Paraguay.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
  ...
  Scenario: Tax ID < 6-digit
    ...
    * def auth = "Bearer "+ bearer
    * configure headers = {"Authorization":'#(auth)'}
    * beneficiaries.params.payload.beneficiary.creditorTaxID = "84562"
    * def user = testData.Visa_CorporateMK
    * beneficiaries.params.api.deviceId = user.keyId
    * def sig = signscorp(beneficiaries,user)
    * request beneficiaries
