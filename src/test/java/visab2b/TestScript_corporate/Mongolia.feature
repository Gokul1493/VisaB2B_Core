Feature: Mongolia
   ...
   * def testData = read('classpath:visab2b/TestData/Config.json')
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Mongolia.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Mongolia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Mongolia.creditorName
    * beneficiaries.params.payload.beneficiary.CreditorAgentBranchName = beneTestData.Mongolia.CreditorAgentBranchName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Mongolia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Mongolia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Mongolia.creditorName
    * match creditorAgentBic == beneTestData.Mongolia.creditorAgentBic
    * match creditorIBAN == beneTestData.Mongolia.creditorIBAN
    * match creditorAddress == beneTestData.Mongolia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Mongolia.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Mongolia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Mongolia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Mongolia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Mongolia.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Mongolia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Mongolia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Mongolia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Mongolia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
