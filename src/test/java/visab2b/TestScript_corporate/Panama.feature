Feature: Panama
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Panama.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Panama.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Panama.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Panama.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Panama.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Panama.creditorName
    * match creditorAgentBic == beneTestData.Panama.creditorAgentBic
    * match creditorIBAN == beneTestData.Panama.creditorIBAN
    * match creditorAddress == beneTestData.Panama.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Panama.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Panama.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Panama.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Panama.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Panama.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Panama.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Panama.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Panama.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Panama.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
