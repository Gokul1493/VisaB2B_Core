Feature: Mexico
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Mexico.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Mexico.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Mexico.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Mexico.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Mexico.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Mexico.creditorName
    * match creditorAgentBic == beneTestData.Mexico.creditorAgentBic
    * match creditorIBAN == beneTestData.Mexico.creditorIBAN
    * match creditorAddress == beneTestData.Mexico.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Mexico.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Mexico.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Mexico.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Mexico.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Mexico.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Mexico.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Mexico.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Mexico.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Mexico.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
