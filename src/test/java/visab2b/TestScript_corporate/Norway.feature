Feature: Norway
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Norway.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Norway.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Norway.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Norway.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Norway.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Norway.creditorName
    * match creditorAgentBic == beneTestData.Norway.creditorAgentBic
    * match creditorIBAN == beneTestData.Norway.creditorIBAN
    * match creditorAddress == beneTestData.Norway.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Norway.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Norway.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Norway.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Norway.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Norway.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Norway.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Norway.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Norway.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Norway.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
