Feature: Romania
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Romania.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Romania.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Romania.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Romania.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Romania.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Romania.creditorName
    * match creditorAgentBic == beneTestData.Romania.creditorAgentBic
    * match creditorIBAN == beneTestData.Romania.creditorIBAN
    * match creditorAddress == beneTestData.Romania.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Romania.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Romania.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Romania.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Romania.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Romania.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Romania.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Romania.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Romania.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Romania.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
