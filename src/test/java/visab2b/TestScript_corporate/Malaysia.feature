Feature: Malaysia
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Malaysia.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Malaysia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Malaysia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Malaysia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Malaysia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Malaysia.creditorName
    * match creditorAgentBic == beneTestData.Malaysia.creditorAgentBic
    * match creditorIBAN == beneTestData.Malaysia.creditorIBAN
    * match creditorAddress == beneTestData.Malaysia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Malaysia.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Malaysia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Malaysia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Malaysia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Malaysia.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Malaysia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Malaysia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Malaysia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Malaysia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
