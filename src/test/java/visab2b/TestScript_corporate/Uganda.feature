Feature: Uganda
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Uganda.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Uganda.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Uganda.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Uganda.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Uganda.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Uganda.creditorName
    * match creditorAgentBic == beneTestData.Uganda.creditorAgentBic
    * match creditorIBAN == beneTestData.Uganda.creditorIBAN
    * match creditorAddress == beneTestData.Uganda.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Uganda.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Uganda.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Uganda.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Uganda.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Uganda.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Uganda.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Uganda.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Uganda.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Uganda.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
