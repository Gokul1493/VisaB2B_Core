Feature: Tunisia
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Tunisia.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Tunisia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Tunisia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Tunisia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Tunisia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Tunisia.creditorName
    * match creditorAgentBic == beneTestData.Tunisia.creditorAgentBic
    * match creditorIBAN == beneTestData.Tunisia.creditorIBAN
    * match creditorAddress == beneTestData.Tunisia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Tunisia.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Tunisia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Tunisia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Tunisia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Tunisia.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Tunisia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Tunisia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Tunisia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Tunisia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
