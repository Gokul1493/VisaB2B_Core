Feature: Philippines
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Philippines.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Philippines.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Philippines.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Philippines.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Philippines.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Philippines.creditorName
    * match creditorAgentBic == beneTestData.Philippines.creditorAgentBic
    * match creditorIBAN == beneTestData.Philippines.creditorIBAN
    * match creditorAddress == beneTestData.Philippines.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Philippines.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Philippines.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Philippines.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Philippines.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Philippines.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Philippines.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Philippines.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Philippines.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Philippines.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
