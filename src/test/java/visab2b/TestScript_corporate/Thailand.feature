Feature: Thailand
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Thailand.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Thailand.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Thailand.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Thailand.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Thailand.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Thailand.creditorName
    * match creditorAgentBic == beneTestData.Thailand.creditorAgentBic
    * match creditorIBAN == beneTestData.Thailand.creditorIBAN
    * match creditorAddress == beneTestData.Thailand.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Thailand.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Thailand.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Thailand.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Thailand.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Thailand.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Thailand.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Thailand.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Thailand.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Thailand.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
