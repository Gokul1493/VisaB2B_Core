Feature: NewZealand
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.NewZealand.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.NewZealand.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.NewZealand.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAgentClearingMemberID = beneTestData.NewZealand.creditorAgentClearingMemberID
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.NewZealand.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.NewZealand.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.NewZealand.creditorName
    * match creditorAgentBic == beneTestData.NewZealand.creditorAgentBic
    * match creditorIBAN == beneTestData.NewZealand.creditorIBAN
    * match creditorAddress == beneTestData.NewZealand.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.NewZealand.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.NewZealand.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.NewZealand.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.NewZealand.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.NewZealand.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.NewZealand.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.NewZealand.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.NewZealand.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.NewZealand.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
