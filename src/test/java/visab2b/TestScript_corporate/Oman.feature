Feature: Oman
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Oman.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Oman.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Oman.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Oman.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Oman.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Oman.creditorName
    * match creditorAgentBic == beneTestData.Oman.creditorAgentBic
    * match creditorIBAN == beneTestData.Oman.creditorIBAN
    * match creditorAddress == beneTestData.Oman.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Oman.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Oman.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Oman.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Oman.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Oman.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Oman.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Oman.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Oman.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Oman.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
