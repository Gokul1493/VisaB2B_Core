Feature: UAE_AED
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.UAE_AED.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.UAE_AED.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.UAE_AED.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.UAE_AED.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.UAE_AED.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.UAE_AED.creditorName
    * match creditorAgentBic == beneTestData.UAE_AED.creditorAgentBic
    * match creditorIBAN == beneTestData.UAE_AED.creditorIBAN
    * match creditorAddress == beneTestData.UAE_AED.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.UAE_AED.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UAE_AED.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.UAE_AED.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.UAE_AED.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UAE_AED.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.UAE_AED.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UAE_AED.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UAE_AED.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.UAE_AED.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
