Feature: SaudiArabia
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.SaudiArabia.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.SaudiArabia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.SaudiArabia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.SaudiArabia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.SaudiArabia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.SaudiArabia.creditorName
    * match creditorAgentBic == beneTestData.SaudiArabia.creditorAgentBic
    * match creditorIBAN == beneTestData.SaudiArabia.creditorIBAN
    * match creditorAddress == beneTestData.SaudiArabia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.SaudiArabia.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.SaudiArabia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.SaudiArabia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.SaudiArabia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.SaudiArabia.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.SaudiArabia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.SaudiArabia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.SaudiArabia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.SaudiArabia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
