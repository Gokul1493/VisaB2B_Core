Feature: Serbia
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Serbia.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Serbia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Serbia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Serbia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Serbia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Serbia.creditorName
    * match creditorAgentBic == beneTestData.Serbia.creditorAgentBic
    * match creditorIBAN == beneTestData.Serbia.creditorIBAN
    * match creditorAddress == beneTestData.Serbia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Serbia.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Serbia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Serbia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Serbia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Serbia.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Serbia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Serbia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Serbia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Serbia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
