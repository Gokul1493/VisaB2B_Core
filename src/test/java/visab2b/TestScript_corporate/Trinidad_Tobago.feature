Feature: TrinidadAndTobago
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.TT.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.TT.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.TT.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.TT.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.TT.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.TT.creditorName
    * match creditorAgentBic == beneTestData.TT.creditorAgentBic
    * match creditorIBAN == beneTestData.TT.creditorIBAN
    * match creditorAddress == beneTestData.TT.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.TT.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.TT.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.TT.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.TT.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.TT.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.TT.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.TT.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.TT.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.TT.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
