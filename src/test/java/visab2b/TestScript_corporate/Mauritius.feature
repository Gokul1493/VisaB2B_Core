Feature: Mauritius
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Mauritius.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Mauritius.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Mauritius.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Mauritius.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Mauritius.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Mauritius.creditorName
    * match creditorAgentBic == beneTestData.Mauritius.creditorAgentBic
    * match creditorIBAN == beneTestData.Mauritius.creditorIBAN
    * match creditorAddress == beneTestData.Mauritius.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Mauritius.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Mauritius.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Mauritius.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Mauritius.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Mauritius.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Mauritius.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Mauritius.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Mauritius.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Mauritius.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
