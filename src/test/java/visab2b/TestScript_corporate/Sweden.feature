Feature: Sweden(SE)
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Sweden.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Sweden.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Sweden.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Sweden.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Sweden.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Sweden.creditorName
    * match creditorAgentBic == beneTestData.Sweden.creditorAgentBic
    * match creditorIBAN == beneTestData.Sweden.creditorIBAN
    * match creditorAddress == beneTestData.Sweden.creditorAddress
    #Select Beneficiary
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Sweden.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Sweden.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Sweden.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Sweden.creditorIBAN
    #* Transactions.params.payload.paymentPurpose= "POP"
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Sweden.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Sweden.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Sweden.creditorAgentBic
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Sweden.instructedCurrency
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
