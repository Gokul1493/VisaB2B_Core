Feature: Uzbekistan
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Uzbekistan.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Uzbekistan.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Uzbekistan.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Uzbekistan.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Uzbekistan.instructedCurrency
    * beneficiaries.params.payload.beneficiary.creditorAgentBranchName = beneTestData.Uzbekistan.creditorAgentBranchName
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Uzbekistan.creditorAccountNumber
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Uzbekistan.creditorName
    * match creditorAgentBic == beneTestData.Uzbekistan.creditorAgentBic
    * match creditorIBAN == beneTestData.Uzbekistan.creditorIBAN
    * match creditorAddress == beneTestData.Uzbekistan.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Uzbekistan.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Uzbekistan.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Uzbekistan.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Uzbekistan.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Uzbekistan.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Uzbekistan.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Uzbekistan.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Uzbekistan.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Uzbekistan.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
