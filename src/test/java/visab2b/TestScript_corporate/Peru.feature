Feature: Peru
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Peru.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Peru.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Peru.creditorName
    * beneficiaries.params.payload.beneficiary.creditorTaxID = beneTestData.Peru.creditorTaxID
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Peru.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Peru.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Peru.creditorName
    * match creditorAgentBic == beneTestData.Peru.creditorAgentBic
    * match creditorIBAN == beneTestData.Peru.creditorIBAN
    * match creditorAddress == beneTestData.Peru.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAccount.TaxId = beneTestData.Peru.creditorTaxID
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Peru.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Peru.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Peru.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Peru.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Peru.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Peru.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Peru.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Peru.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Peru.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
