Feature: SouthAfrica
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.SouthAfrica.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.SouthAfrica.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.SouthAfrica.creditorName
    * beneficiaries.params.payload.beneficiary.creditorContactPhoneNumber = beneTestData.SouthAfrica.creditorContactPhoneNumber
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.SouthAfrica.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.SouthAfrica.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.SouthAfrica.creditorName
    * match creditorAgentBic == beneTestData.SouthAfrica.creditorAgentBic
    * match creditorIBAN == beneTestData.SouthAfrica.creditorIBAN
    * match creditorAddress == beneTestData.SouthAfrica.creditorAddress
    #Select Beneficiary
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.SouthAfrica.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.SouthAfrica.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.SouthAfrica.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.SouthAfrica.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.SouthAfrica.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    * Transactions.params.payload.beneficiaryId = beneficiaryid_value
    * Transactions.params.payload.creditorAccount.name = beneTestData.SouthAfrica.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.SouthAfrica.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.SouthAfrica.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
