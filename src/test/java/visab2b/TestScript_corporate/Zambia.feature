Feature: Zambia
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Zambia.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Zambia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Zambia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Zambia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Zambia.instructedCurrency
    * beneficiaries.params.payload.beneficiary.creditorAgentBranchName = beneTestData.Zambia.creditorAgentBranchName
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Zambia.creditorAccountNumber
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Zambia.creditorName
    * match creditorAgentBic == beneTestData.Zambia.creditorAgentBic
    * match creditorIBAN == beneTestData.Zambia.creditorIBAN
    * match creditorAddress == beneTestData.Zambia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Zambia.instructedCurrency
    ...
    * print endToendID
    * jutil.SetData("transactionIDZambia",endToendID)
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Zambia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Zambia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Zambia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Zambia.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Zambia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Zambia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Zambia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Zambia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
