Feature: UnitedStates
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.UnitedStates.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.UnitedStates.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.UnitedStates.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAgentClearingMemberID = beneTestData.UnitedStates.creditorAgentClearingMemberID
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.UnitedStates.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.UnitedStates.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.UnitedStates.creditorName
    * match creditorAgentBic == beneTestData.UnitedStates.creditorAgentBic
    * match creditorIBAN == beneTestData.UnitedStates.creditorIBAN
    * match creditorAddress == beneTestData.UnitedStates.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.UnitedStates.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UnitedStates.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.UnitedStates.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.UnitedStates.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UnitedStates.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.UnitedStates.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UnitedStates.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UnitedStates.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.UnitedStates.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
