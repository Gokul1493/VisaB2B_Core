Feature: Nicaragua
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Nicaragua.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Nicaragua.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Nicaragua.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Nicaragua.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Nicaragua.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Nicaragua.creditorName
    * match creditorAgentBic == beneTestData.Nicaragua.creditorAgentBic
    * match creditorIBAN == beneTestData.Nicaragua.creditorIBAN
    * match creditorAddress == beneTestData.Nicaragua.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Nicaragua.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Nicaragua.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Nicaragua.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Nicaragua.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Nicaragua.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Nicaragua.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Nicaragua.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Nicaragua.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Nicaragua.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
