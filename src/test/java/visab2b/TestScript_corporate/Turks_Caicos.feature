Feature: TurksAndCaicos
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.TurksAndCaicos.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.TurksAndCaicos.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.TurksAndCaicos.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.TurksAndCaicos.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.TurksAndCaicos.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.TurksAndCaicos.creditorName
    * match creditorAgentBic == beneTestData.TurksAndCaicos.creditorAgentBic
    * match creditorIBAN == beneTestData.TurksAndCaicos.creditorIBAN
    * match creditorAddress == beneTestData.TurksAndCaicos.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.TurksAndCaicos.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.TurksAndCaicos.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.TurksAndCaicos.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.TurksAndCaicos.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.TurksAndCaicos.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.TurksAndCaicos.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.TurksAndCaicos.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.TurksAndCaicos.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.TurksAndCaicos.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
