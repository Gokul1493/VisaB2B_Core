Feature: Singapore
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Singapore.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Singapore.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Singapore.creditorName
    * beneficiaries.params.payload.beneficiary.creditorContactPhoneNumber = beneTestData.Singapore.creditorContactPhoneNumber
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Singapore.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Singapore.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Singapore.creditorName
    * match creditorAgentBic == beneTestData.Singapore.creditorAgentBic
    * match creditorIBAN == beneTestData.Singapore.creditorIBAN
    * match creditorAddress == beneTestData.Singapore.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Singapore.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Singapore.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Singapore.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Singapore.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Singapore.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Singapore.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Singapore.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Singapore.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Singapore.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
