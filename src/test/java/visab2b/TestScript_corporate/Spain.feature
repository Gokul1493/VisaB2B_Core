Feature: Spain
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Spain.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Spain.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Spain.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Spain.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Spain.instructedCurrency
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Spain.creditorAccountNumber
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Spain.creditorName
    * match creditorAgentBic == beneTestData.Spain.creditorAgentBic
    * match creditorIBAN == beneTestData.Spain.creditorIBAN
    * match creditorAddress == beneTestData.Spain.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Spain.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Spain.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Spain.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Spain.creditorIBAN
    #* Transactions.params.payload.paymentPurpose= "POP"
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Spain.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Spain.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Spain.creditorAgentBic
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Spain.instructedCurrency
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
