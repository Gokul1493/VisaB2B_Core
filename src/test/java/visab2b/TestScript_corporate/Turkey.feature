Feature: Turkey
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Turkey.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Turkey.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Turkey.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Turkey.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Turkey.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Turkey.creditorName
    * match creditorAgentBic == beneTestData.Turkey.creditorAgentBic
    * match creditorIBAN == beneTestData.Turkey.creditorIBAN
    * match creditorAddress == beneTestData.Turkey.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Turkey.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Turkey.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Turkey.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Turkey.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Turkey.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Turkey.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Turkey.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Turkey.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Turkey.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
