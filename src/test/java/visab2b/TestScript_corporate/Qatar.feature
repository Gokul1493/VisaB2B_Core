Feature: Qatar
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorIBAN = beneTestData.Qatar.creditorIBAN
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Qatar.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Qatar.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Qatar.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Qatar.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Qatar.creditorName
    * match creditorAgentBic == beneTestData.Qatar.creditorAgentBic
    * match creditorIBAN == beneTestData.Qatar.creditorIBAN
    * match creditorAddress == beneTestData.Qatar.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Qatar.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Qatar.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Qatar.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Qatar.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Qatar.creditorIBAN
    * Transactions.params.payload.instructedAmount.currency = beneTestData.Qatar.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Qatar.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Qatar.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Qatar.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
