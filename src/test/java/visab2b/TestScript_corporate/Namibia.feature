Feature: Namibia
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Namibia.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Namibia.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Namibia.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Namibia.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Namibia.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Namibia.creditorName
    * match creditorAgentBic == beneTestData.Namibia.creditorAgentBic
    * match creditorIBAN == beneTestData.Namibia.creditorIBAN
    * match creditorAddress == beneTestData.Namibia.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Namibia.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Namibia.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Namibia.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Namibia.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Namibia.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Namibia.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Namibia.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Namibia.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Namibia.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
