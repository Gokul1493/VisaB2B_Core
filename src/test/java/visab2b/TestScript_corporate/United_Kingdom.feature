Feature: UnitedKingdom
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.UnitedKingdom.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.UnitedKingdom.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.UnitedKingdom.creditorName
    * beneficiaries.params.payload.beneficiary.creditorAgentClearingMemberID = beneTestData.UnitedKingdom.creditorAgentClearingMemberID
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.UnitedKingdom.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.UnitedKingdom.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.UnitedKingdom.creditorName
    * match creditorAgentBic == beneTestData.UnitedKingdom.creditorAgentBic
    * match creditorIBAN == beneTestData.UnitedKingdom.creditorIBAN
    * match creditorAddress == beneTestData.UnitedKingdom.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.UnitedKingdom.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UnitedKingdom.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.UnitedKingdom.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.UnitedKingdom.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UnitedKingdom.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.UnitedKingdom.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.UnitedKingdom.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.UnitedKingdom.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.UnitedKingdom.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
  ...
  Scenario: invalid ClearingMemberID
    ...
    * status 200
    * print response
    * match response.error contains {message:"Creditor Agent Clearing MemberID must be starts with NZ and followed by 6 numeric digit."}
