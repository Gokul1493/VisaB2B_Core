Feature: Maldives
  ...
  Background: 
    ...
    * beneficiaries.params.payload.beneficiary.creditorAccountNumber = beneTestData.Maldives.creditorAccountNumber
    * beneficiaries.params.payload.beneficiary.creditorAgentBic = beneTestData.Maldives.creditorAgentBic
    * beneficiaries.params.payload.beneficiary.creditorName = beneTestData.Maldives.creditorName
    * beneficiaries.params.payload.beneficiary.CreditorAgentBranchName = beneTestData.Maldives.CreditorAgentBranchName
    * beneficiaries.params.payload.beneficiary.creditorAddress = beneTestData.Maldives.creditorAddress
    * beneficiaries.params.payload.beneficiary.instructedCurrency = beneTestData.Maldives.instructedCurrency
  ...
  Scenario: positive
    ...
    * match creditorName == beneTestData.Maldives.creditorName
    * match creditorAgentBic == beneTestData.Maldives.creditorAgentBic
    * match creditorIBAN == beneTestData.Maldives.creditorIBAN
    * match creditorAddress == beneTestData.Maldives.creditorAddress
    #Select Beneficiary
    ...
    * Transactions.params.payload.creditorAgent.bic = creditorAgentBic
	 * Transactions.params.payload.instructedAmount.currency = beneTestData.Maldives.instructedCurrency
  ...
  Scenario: transaction without amount
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Maldives.creditorName
    * Transactions.params.payload.creditorAccount.creditorAgentBic = beneTestData.Maldives.creditorAgentBic
    * Transactions.params.payload.creditorAccount.address = beneTestData.Maldives.creditorAddress
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Maldives.creditorIBAN
   * Transactions.params.payload.instructedAmount.currency = beneTestData.Maldives.instructedCurrency
    * def user = testData.Visa_CorporateMK
    * Transactions.params.api.deviceId = user.keyId
    * def beneficiaryid_value = response.result.beneficiaries[0].id
    ...
    * Transactions.params.payload.creditorAccount.name = beneTestData.Maldives.creditorName
    * Transactions.params.payload.creditorAccount.iban = beneTestData.Maldives.creditorIBAN
    * Transactions.params.payload.creditorAgent.bic = beneTestData.Maldives.creditorAgentBic
    * def sig = signscorp(Transactions,user)
    * request Transactions
    * method POST
    * status 200
