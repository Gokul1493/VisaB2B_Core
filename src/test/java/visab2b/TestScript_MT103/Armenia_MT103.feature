...
* print Accno
  ...
  * def referencenumber = "MT103ARMENIADIRECT" + Accno
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103ARMENIA20243005001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	* def finalMt103 = content.replaceAll("20:MT103ARMENIA20243005001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:CDAMAM22XXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:CDAMAM22XXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	* def finalMt103 = content.replaceAll("59:454566845313", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/POP", "70:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/POP", "70://POP/POP"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for ARMENIA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
  * def referencenumber = "MT103ARMENIADIRECT" + Accno
  * print referencenumber
 ...
 * match response.result.message == validations.successMessage
 ...
 Scenario: Currency as empty
	* def content = read('classpath:visab2b/MT103_files/ARMENIA.txt')
	* def finalMt103 = content.replaceAll("32A:240424AMD10", "32A:24042410"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
