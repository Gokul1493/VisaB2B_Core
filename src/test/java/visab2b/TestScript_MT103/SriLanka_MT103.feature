Feature: SRILANKA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPSRILANKA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10LKR202208675573654654576", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditssrilankamt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10LKR202208675573654654576", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYLKLXXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYLKLXXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def finalMt103 = content.replaceAll(":59:/41776146214641", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Srilanka country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def referencenumber = "AUTOMT103SFTPSRILANKA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10LKR202208675573654654576", "20:" + referencenumber ).replaceAll(":32A:200408LKR138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditssrilankamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYLKLXXXX", ":57A:BCEYLKLXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Currency is empty
    * def content = read('classpath:visab2b/MT103_files/SRILANKA.txt')
    * def finalMt103 = content.replaceAll(":32A:200408LKR138,28", ":32A:200408138,28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
