...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPVIETNAM" + Accno
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPREHMT1021234545", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
	 * def finalMt103 = content.replaceAll(":57A:/ABOCVNVXXXX", "57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
	 * def finalMt103 = content.replaceAll(":57A:/ABOCVNVXXXX", "57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: To verify the Beneficiary Bank Branch Name above length 3
	...
	* def finalMt103 = content.replaceAll(":72:/BBB/HANOI", ":72:/BBB/HANO")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.MT103_Empty_DebtorName_Address
	...
	Scenario: To verify the Beneficiary Bank Branch Name below length 3
		* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll(":72:/BBB/HANOI", ":72:/BBB/HA")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.MT103_Empty_DebtorName_Address
	...
	Scenario: To verify the Beneficiary Bank Branch Name without prefix
		* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll.replaceAll(":72:/BBB/HANOI", ":72:/HANOI")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: To verify the Beneficiary Bank Branch Name as empty
		* def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
	* def finalMt103 = content.replaceAll(":72:/BBB/HANOI", "")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
	* def finalMt103 = content.replaceAll(":59:/45564987545468", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def finalMt103 = content.replaceAll(":70:/POP/POP", "70:"  ).replaceAll("20:2603001SFTPMT10RSD20220867557563662121", "20:MT103SFTPPANAMA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Vietnam country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
