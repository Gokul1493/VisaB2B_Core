Feature: VIETNAM_MT103
  ...
  Scenario: To verify the Beneficiary Bank Branch Name without prefix
    * def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
    * def finalMt103 = content.replaceAll(":72:/BBB/HANOI", ":72:/HANOI")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/VIETNAM.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/Payment as agreed VIETNAM", ":70:"  ).replaceAll("20:2603001SFTPMT10RSD20220867557563662121", "20:MT103SFTPPANAMA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
