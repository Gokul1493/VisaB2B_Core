Feature: LUXEMBOURG_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditsluxemt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/LUXEMBOURG.txt')
    * def finalMt103 = content.replaceAll("20:MT103LUXEMBURG2022543655435455", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/LUXEMBOURG.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEELULL", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/LUXEMBOURG.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEELULL", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Luxembourg country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/LUXEMBOURG.txt')
    * def referencenumber = "MT103SFTPALBENIA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103LUXEMBURG2022543655435455", "20:" + referencenumber ).replaceAll(":32A:200408EUR10,10", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsluxemt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/LUXEMBOURG.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEELULL", ":57A:BCEELULLXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
