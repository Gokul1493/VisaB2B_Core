...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPPANAMA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PANAMA8357438522121", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditspanamamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/PANAMA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10PANAMA8357438522121", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/PANAMA.txt')
	 * def finalMt103 = content.replaceAll(":57A:BAGEPAPAXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PANAMA.txt')
	 * def finalMt103 = content.replaceAll(":57A:BAGEPAPAXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/PANAMA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/Testing panama", "70:"  ).replaceAll("20:2603001SFTPMT10PANAMA8357438522121", "20:MT103SFTPPANAMA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Panama country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/PANAMA.txt')
  * def referencenumber = "MT103SFTPMALTA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PANAMA8357438522121", "20:" + referencenumber ).replaceAll(":32A:200408PAB138,28", ":32A:200408USD138.28")
  * print finalMt103
  * jutil.SetData("GetAuditsPanamamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PANAMA.txt')
	 * def finalMt103 = content.replaceAll(":57A:BAGEPAPAXXX", ":57A:BAGEPAPAXXXXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
