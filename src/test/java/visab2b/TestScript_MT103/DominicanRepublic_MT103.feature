Feature: DOMINICANREPUBLIC_MT103
...
* print Accno
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for DOMINICANREPUBLIC country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
  * def referencenumber = "AUTOMT103SFTPDOMINICANREPUBLIC" + Accno
  * print referencenumber
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BPDODOSXXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BPDODOSXXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BPDODOSXXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BPDODOSXXXX", ":57A:BPDODOSXXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("59:/DO22ACAU00000000000123456789", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.EmptyPOP
	...
	Scenario: 9-digit Beneficiary Tax ID- as Empty
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("72:/INN/112233444", "72:/INN/"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:AUTOMT103SFTPDOMINICANREPUBLIC" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.EmptyTaxID
	...
	Scenario: More than 9-digit Beneficiary Tax ID
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("72:/INN/112233444", "72:/INN/1122334455"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:AUTOMT103SFTPDOMINICANREPUBLIC" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	When method POST
	Then status 200
	* match response.error.message contains validations.MT103_Invalid_TaxID9Num
	
	Scenario: Less than 9-digit Beneficiary Tax ID
	* def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("72:/INN/112233444", "72:/INN/11223344"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:AUTOMT103SFTPDOMINICANREPUBLIC" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
