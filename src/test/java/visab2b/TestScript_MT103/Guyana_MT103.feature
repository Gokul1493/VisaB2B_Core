Feature: GUYANA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPGUYANA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103GUYANA202402040001", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsGuyanamt103rspostive",referencenumber)
  ...
  Scenario: Transaction initated for GUYANA country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def referencenumber = "AUTOMT103SFTPGUYANA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103GUYANA202402040001", "20:" + referencenumber ).replaceAll("59:/1210029690", "59:/9858855577"  ).replaceAll("32A:200408GYD12.98", "32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsGuyanamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll("20:MT103GUYANA202402040001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll(":57A:GUTIGYGEXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll(":57A:GUTIGYGEXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll(":57A:GUTIGYGEXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll(":57A:GUTIGYGEXXX", ":57A:GUTIGYGEXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll("59:/1210029690", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/GUYANA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed GUYANA", "70:"  ).replaceAll("20:MT103GUYANA202402040001", "20:AUTOMT103SFTPGUYANA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
