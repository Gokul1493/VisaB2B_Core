Feature: maldives_MT103
  ...
  Scenario: Transaction initated for maldives country with different currency  (currency:- USD)
    ...
    * def getReferenceNumber = jutil.GetData('getAuditsReferenceNumberothercurrency')
    * print getReferenceNumber
    * def sleep = function(millis){ java.lang.Thread.sleep(millis) }
    * eval sleep(30000)
    ### Checker user approve transaction
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/MALDIVES.txt')
    * def finalMt103 = content.replaceAll("20:Automaldives001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/MALDIVES.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYMVMV", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/MALDIVES.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYMVMV", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/MALDIVES.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYMVMV", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/MALDIVES.txt')
    * def finalMt103 = content.replaceAll(":57A:BCEYMVMV", ":57A:BCEYMVMVX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Branchname as Empty
    * def content = read('classpath:visab2b/MT103_files/MALDIVES.txt')
    * def finalMt103 = content.replaceAll("/BBB/Downtown Branch", ""  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
