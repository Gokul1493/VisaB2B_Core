Feature: Bermuda_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPBERMUDA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103BERMUDA202430030001", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsBermudamt103rspostive",referencenumber)
  ...
  Scenario: Transaction initated for BERMUDA country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def referencenumber = "AUTOMT103SFTPBERMUDA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103BERMUDA202430030001", "20:" + referencenumber ).replaceAll("32A:200408BMD108.28", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed BERMUDA", "70:")
    * print finalMt103
    * jutil.SetData("GetAuditsBermudamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll("20:MT103BERMUDA202430030001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBDABMHMXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBDABMHMXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBDABMHMXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll(":57A:BBDABMHMXXX", ":57A:BBHOBDDHXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll("59:/01299123456", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/purpose of payment Bermuda", "70:"  ).replaceAll("20:MT103BERMUDA202430030001", "20:AUTOMT103SFTPBERMUDA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- with double slash
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/Payment as agreed BERMUDA", "70://POP/Payment as agreed BERMUDA"  ).replaceAll("20:MT103BERMUDA202430030001", "20:AUTOMT103SFTPBERMUDA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- with no slash
    * def content = read('classpath:visab2b/MT103_files/BERMUDA.txt')
    * def finalMt103 = content.replaceAll("70:/POP/purpose of payment Bermuda", "70:POP/Payment as agreed BERMUDA"  ).replaceAll("20:MT103BERMUDA202430030001", "20:AUTOMT103SFTPBERMUDA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
