Feature: NETHERLANDS_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "MT103SFTPNERTHERLANDS" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsnetherlandsmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:ABNCNL2AECP", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:ABNCNL2AECP", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Netherlands country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
    * def referencenumber = "MT103SFTPMALTA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber ).replaceAll(":32A:200408MUR138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsnetherlandsmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic Less than 8 digits
    * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:ABNCNL2AECP", ":57A:ACV"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
    * def finalMt103 = content.replaceAll(":57A:ABNCNL2AECP", ":57A:ABNCNL2AECPXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
