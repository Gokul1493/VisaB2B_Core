...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPCZECHREPUBLIC" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CZECHREPUBLIC202401040001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsczechmt103rspostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for CZECHREPUBLIC country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
  * def referencenumber = "AUTOMT103SFTPCZECHREPUBLIC" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CZECHREPUBLIC202401040001", "20:" + referencenumber ).replaceAll("32A:200408CZK108.28", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed BRITISHVIRGINISLANDS", "70:").replaceAll(":59:/CZ6508000000192000145399", ":59:/6508000000192000145")
  * print finalMt103  
  * jutil.SetData("GetAuditsCzechmt103rsothercurrency",referencenumber) 
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103CZECHREPUBLIC202401040001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("20:MT103CZECHREPUBLIC202401040001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BOIOCZP1XXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BOIOCZP1XXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BOIOCZP1XXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
	* def finalMt103 = content.replaceAll(":57A:BOIOCZP1XXX", ":57A:BOIOCZP1XXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/CZECHREPUBLIC.txt')
	* def finalMt103 = content.replaceAll("59:/CZ6508000000192000145399", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
