Feature: ISRAEL_MT103
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/ISRAEL.txt')
    * def finalMt103 = content.replaceAll("20:MT103ISRAEL4235765765759", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/ISRAEL.txt')
    * def finalMt103 = content.replaceAll(":57A:ISRAILIJXXX", "57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/ISRAEL.txt')
    * def finalMt103 = content.replaceAll(":57A:ISRAILIJXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/ISRAEL.txt')
    * def finalMt103 = content.replaceAll("59:/IL170108000000012612345", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Isreal country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/ISRAEL.txt')
  ...
  Scenario: Creditor Bic more than 8 digits
    * def content = read('classpath:visab2b/MT103_files/ISRAEL.txt')
    * def finalMt103 = content.replaceAll(":57A:ISRAILIJXXX", ":57A:ISRAILIJXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
