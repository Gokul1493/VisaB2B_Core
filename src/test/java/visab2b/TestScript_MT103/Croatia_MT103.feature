...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPCROATIA" + Accno
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for CROATIA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/CROATIA.txt')
  * def referencenumber = "AUTOMT103SFTPCROATIA" + Accno
  * print referencenumber
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/CROATIA.txt')
	* def finalMt103 = content.replaceAll("20:MT103CORATIA2024010400001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
