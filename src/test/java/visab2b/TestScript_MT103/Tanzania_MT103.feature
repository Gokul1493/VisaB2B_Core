...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPTANZANIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10TZS202208675564343457590", "20:" + referencenumber )
  * print finalMt103
    * jutil.SetData("GetAuditstanzaniamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10TZS202208675564343457590", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
    * def finalMt103 = content.replaceAll(":57A:TANZTZTXXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
    * def finalMt103 = content.replaceAll(":57A:TANZTZTXXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: To verify the Beneficiary Bank Branch Name above length 3
		* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll(":72:/BBB/Downtown Branch", ":72:/BBB/Bran")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.MT103_Empty_DebtorName_Address
	...
	Scenario: To verify the Beneficiary Bank Branch Name below length 3
		* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll(":72:/BBB/Downtown Branch", ":72:/BBB/Br")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.MT103_Empty_DebtorName_Address
	...
	Scenario: To verify the Beneficiary Bank Branch Name without prefix
		* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll(":72:/BBB/Downtown Branch", ":72:/Branchdown")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: To verify the Beneficiary Bank Branch Name as empty
		* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll(":72:/BBB/Downtown Branch", "")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
    * def finalMt103 = content.replaceAll(":59:/232243546575638476867", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
    ...
    * def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
	* def finalMt103 = content.replaceAll(":70:/POP/Testing", "70:"  ).replaceAll("20:2603001SFTPMT10RSD20220867557563662121", "20:MT103SFTPPANAMA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Tanzania country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
  * def referencenumber = "AUTOMT103SFTPTANZANIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10TZS202208675564343457590", "20:" + referencenumber ).replaceAll(":32A:200408TZS138,28", ":32A:200408USD138.28").replaceAll(":70:/POP/Testing", "70:"  )
  * print finalMt103
    * jutil.SetData("GetAuditstanzaniamt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
    ...
    * def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
    * def finalMt103 = content.replaceAll(":57A:TANZTZTXXXX", ":57A:TANZTZTXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    ...
    * def content = read('classpath:visab2b/MT103_files/TANZANIA.txt')
    * def finalMt103 = content.replaceAll(":32A:200408TZS138,28", ":32A:200408138,28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
