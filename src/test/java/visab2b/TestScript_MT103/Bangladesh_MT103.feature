...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPBANGLA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsbanglamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll("20:MT103BANGALADESH202428001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll(":57A:BBHOBDDHXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll(":57A:BBHOBDDHXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll(":57A:BBHOBDDHXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll(":57A:BBHOBDDHXXX", ":57A:BBHOBDDHXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll("59:/0001299123456", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll("70:/POP/Payment as agreed bangladesh", "70:"  ).replaceAll("20:MT103BANGALADESH202428001", "20:MT103SFTPALBENIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll("70:/POP/Payment as agreed bangladesh", "70://POP/Payment as agreed bangladesh"  ).replaceAll("20:MT103BANGALADESH202428001", "20:MT103SFTPALBENIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll("72:/BRI/Bangladesh", "72:/BRI/"  ).replaceAll("20:MT103BANGALADESH202428001", "20:MT103SFTPALBENIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.BranchID
	...
	Scenario: Beneficiary Bank Branch ID Minimum 2 character
	* def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
	* def finalMt103 = content.replaceAll("72:/BRI/Bangladesh", "72:/BRI/Ba"  ).replaceAll("20:MT103BANGALADESH202428001", "20:MT103SFTPALBENIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	When method POST
	Then status 200
	* match response.error.message contains validations.MT103_Invalid_BranchIDMin3
	
	

Scenario: Transaction initated for Bangladesh country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
  * def referencenumber = "AUTOMT103SFTPBANGLA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber ).replaceAll("32A:200408BDT108.28", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed bangladesh", "70:").replaceAll("72:/BRI/Bangladesh", "72:")
  * print finalMt103
  * jutil.SetData("GetAuditsbanglamt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
