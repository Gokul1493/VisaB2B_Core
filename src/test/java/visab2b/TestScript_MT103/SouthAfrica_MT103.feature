...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPSOUTHAFRICA" + Accno
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPSFTPSOUTHAFRICA6755776714211", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
    * def finalMt103 = content.replaceAll(":57A:AFEPZAJ2CLO", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
    * def finalMt103 = content.replaceAll(":57A:AFEPZAJ2CLO", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: To verify the Beneficiary Contact Phone Number as empty
		* def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
	* def finalMt103 = content.replaceAll("/PHN/+1-8099087766", "")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
  ...
  * def value = signsreq(reqadd,user)
    ...
    * def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
	* def finalMt103 = content.replaceAll(":77B:/POP/purpose of payment", ":77B:"  ).replaceAll("20:2603001SFTPMT10RSD20220867557563662121", "20:MT103SFTPPANAMA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for SouthAfrica country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
  * def referencenumber = "AUTOMT103SFTPSOUTHAFRICA" + Accno
  * print referencenumber
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
  ...
  Scenario: Creditor Bic More than 12 digits
    * def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
    * def finalMt103 = content.replaceAll(":57A:AFEPZAJ2CLO", ":57A:AFEPZAJ2CLOXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Currency is empty
    * def content = read('classpath:visab2b/MT103_files/SOUTHAFRICA.txt')
    * def finalMt103 = content.replaceAll(":32A:200408ZAR138,28", ":32A:200408138,28"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
