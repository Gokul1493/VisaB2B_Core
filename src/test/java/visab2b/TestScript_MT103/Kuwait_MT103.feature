Feature: swift_file_transfer_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPKUMAIT" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT10KWAIT364632746355426599", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsKUWAITmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/KUWAIT.txt')
    * def finalMt103 = content.replaceAll("20:MT10KWAIT364632746355426599", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/KUWAIT.txt')
    * def finalMt103 = content.replaceAll(":57A:KWIBKWKWXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/KUWAIT.txt')
    * def finalMt103 = content.replaceAll(":57A:KWIBKWKWXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/KUWAIT.txt')
    * def finalMt103 = content.replaceAll("59:/KW81CBKU0000000000001234560101", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for KUWAIT country with different currency  (currency:- USD)
    ...
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT10KWAIT364632746355426599", "20:" + referencenumber ).replaceAll(":32A:200408KWD138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsKUWAITmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic is more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/KUWAIT.txt')
    * def finalMt103 = content.replaceAll(":57A:KWIBKWKWXXX", ":57A:KWIBKWKWXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
