Feature: QATAR_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPQATAR" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10QAR202208675575615", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsqatarmt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/QATAR.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10QAR202208675575615", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Qatar country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/QATAR.txt')
    * def referencenumber = "MT103SFTPMALTA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10QAR202208675575615", "20:" + referencenumber ).replaceAll(":32A:200408QAR138,28", ":32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsqatarmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
