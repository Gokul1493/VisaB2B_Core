...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10PRAGUAY863565645858", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":57A:UBBRPYPXXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":57A:UBBRPYPXXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: DebtorName as Empty
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.error.message contains validations.MT103_Empty_DebtorName_Address
	...
	Scenario: To verify the Beneficiary Branch Name above length 3
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":72:/BBB/Testing", ":72:/BBB/Testing"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":72:/BBB/Testing", ":72:/BBB/Te"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":72:/BBB/Testing", ":72:/Tes"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":77B:/INN/1122399", ":77B:/INN/1122399889"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 When method POST
	 Then status 200
	 * match response.error.message contains validations.MT103_Invalid_TaxID6_9Char
	 ##
	 Scenario: To verify the Beneficiary Tax ID below 6 characters
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":77B:/INN/1122399", ":77B:/INN/11223"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":77B:/INN/1122399", ":77B:/1122399889"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	* def finalMt103 = content.replaceAll(":70:/POP/purpose of payment", "70:"  ).replaceAll("20:2603001SFTPMT10PRAGUAY863565645858", "20:MT103SFTPMAURITIUS" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Paragauy country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/PARAGUAY.txt')
	 * def finalMt103 = content.replaceAll(":57A:UBBRPYPXXXX", ":57A:UBBRPYPXXXXXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
