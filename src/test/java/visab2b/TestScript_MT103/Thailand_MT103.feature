...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPTHAILAND" + Accno
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT10THB20220867556434345533", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	 * def finalMt103 = content.replaceAll(":57A:BKKBTHBKXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	 * def finalMt103 = content.replaceAll(":57A:BKKBTHBKXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	* def finalMt103 = content.replaceAll(":59:/2322435465756384768678698543535", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	* def finalMt103 = content.replaceAll(":70:/POP/Testing", ":70:"  ).replaceAll("20:AUTOTHAILANDMT103", "20:AUTOTHAILANDMT103" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Thailand country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
  * def referencenumber = "AUTOMT103SFTPTHAILAND" + Accno
  * print referencenumber
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	 * def finalMt103 = content.replaceAll(":57A:BKKBTHBKXXX", ":57A:BKKBTHBKXXXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/THAILAND.txt')
	 * def finalMt103 = content.replaceAll(":32A:200408THB138,28", ":32A:200408138,28"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
