...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPCAMBODIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103COMBODIA202431030001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsCambodiamt103rspostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for CAMBODIA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
  * def referencenumber = "AUTOMT103SFTPCAMBODIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103COMBODIA202431030001", "20:" + referencenumber ).replaceAll("32A:200408KHR18.28", "32A:200408USD138.28").replaceAll("70:/POP/purpose of payment COMBODIA", "70:")
  * print finalMt103
  * jutil.SetData("GetAuditscambodiamt103othercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
	* def finalMt103 = content.replaceAll("20:MT103COMBODIA202431030001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
	* def finalMt103 = content.replaceAll(":57A:SICOKHPPXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
	* def finalMt103 = content.replaceAll(":57A:SICOKHPPXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
	* def finalMt103 = content.replaceAll(":57A:SICOKHPPXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
	* def finalMt103 = content.replaceAll(":57A:SICOKHPPXXX", ":57A:SICOKHPPXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/CAMBODIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/purpose of payment COMBODIA", "70:"  ).replaceAll("20:MT103COMBODIA202431030001", "20:AUTOMT103SFTPCAMBODIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
