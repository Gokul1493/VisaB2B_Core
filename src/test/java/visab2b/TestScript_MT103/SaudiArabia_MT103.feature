Feature: SAUDIARABIA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPSAUDIARABIA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10RON2022086755756752", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsAsaudimt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10RON2022086755756752", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def finalMt103 = content.replaceAll(":57A:SBHQSARRXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def finalMt103 = content.replaceAll(":57A:SBHQSARRXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def finalMt103 = content.replaceAll(":59:/BH71SBHQ17376718757136", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/Testing", "70:"  ).replaceAll("20:2603001SFTPMT10RON2022086755756752", "20:MT103SFTPPANAMA" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Saudi Arabia country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def referencenumber = "AUTOMT103SFTPSAUDIARABIA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10RON2022086755756752", "20:" + referencenumber ).replaceAll(":32A:200408SAR138,28", ":32A:200408USD138.28").replaceAll("70:/POP/Testing", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditssuadimt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic More than 11 digits
    * def content = read('classpath:visab2b/MT103_files/SAUDIARABIA.txt')
    * def finalMt103 = content.replaceAll(":57A:SBHQSARRXXX", ":57A:SBHQSARRXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
