...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPCHILE" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditschilemt103rspostive",referencenumber)
  ...
  * def referencenumber = "AUTOMT103SFTPCHILE" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber ).replaceAll("77B:/INN/4343434343", "77B:/INN/112233445")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for CHILE country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/CHILE.txt')
  * def referencenumber = "AUTOMT103SFTPCHILE" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber ).replaceAll("32A:200408CLP18.28", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed CHILE", "70:")
  * print finalMt103
  * jutil.SetData("GetAuditsChilemt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll(":57A:BECHCLRMXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll(":57A:BECHCLRMXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll(":57A:BECHCLRMXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll(":57A:BECHCLRMXXX", ":57A:BECHCLRMXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll("77B:/INN/4343434343", "77B:/INN/"  ).replaceAll("20:MT103CHILE20240104001", "20:AUTOMT103SFTPCHILE" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll("77B:/INN/4343434343", "77B:/INN/11223344556"  ).replaceAll("20:MT103CHILE20240104001", "20:AUTOMT103SFTPCHILE" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/CHILE.txt')
	* def finalMt103 = content.replaceAll("77B:/INN/4343434343", "77B:/INN/11223344"  ).replaceAll("20:MT103CHILE20240104001", "20:AUTOMT103SFTPCHILE" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
