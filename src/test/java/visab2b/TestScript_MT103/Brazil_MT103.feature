Feature: BRAZIL
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPBRAZIL" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103BRAZIL202403300001", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsBrazilmt103rspostive",referencenumber)
  ...
  Scenario: Transaction initated for BRAZIL country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def referencenumber = "AUTOMT103SFTPBRAZIL" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103BRAZIL202403300001", "20:" + referencenumber ).replaceAll("32A:200408BAM108.28", "32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditsBrazilmt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll("20:MT103BRAZIL202403300001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll(":57A:ABCBBRSPXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll(":57A:ABCBBRSPXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll(":57A:ABCBBRSPXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll(":57A:ABCBBRSPXXX", ":57A:ABCBBRSPXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: PhoneNumber without ISD code
    ...
    * def value = signsreq(reqadd,user)
    ...
    When method POST
    Then status 200
    * match response.error.message contains validations.Invalidphno
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll("70:/POP/payment of purpose Brazil", "70:"  ).replaceAll("20:MT103BRAZIL202403300001", "20:AUTOMT103SFTPBRAZIL" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    ...
    * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
    * reqadd.params.Payload.swiftFiles[0].file = finalMt103
    * reqadd.params.Payload.swiftFiles[0].fileName = "s.txt"
    * def value = signsreq(reqadd,user)
    And request value
    When method POST
    Then status 200
  ...
  Scenario: 14-digit Beneficiary Tax ID- as Empty
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll("72:/INN/11223344556677", "72:/INN/"  ).replaceAll("20:MT103BRAZIL202403300001", "20:AUTOMT103SFTPBRAZIL" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: More than 14-digit Beneficiary Tax ID
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll("72:/INN/11223344556677", "72:/INN/112233445566778"  ).replaceAll("20:MT103BRAZIL202403300001", "20:AUTOMT103SFTPBRAZIL" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    ...
    * def value = signsreq(reqadd,user)
    ...
    When method POST
    Then status 200
    * match response.error.message contains validations.lessmoreTaxid_Brazil

  Scenario: Less than 14-digit Beneficiary Tax ID
    * def content = read('classpath:visab2b/MT103_files/BRAZIL.txt')
    * def finalMt103 = content.replaceAll("72:/INN/11223344556677", "72:/INN/1122334455667"  ).replaceAll("20:MT103BRAZIL202403300001", "20:AUTOMT103SFTPBRAZIL" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
