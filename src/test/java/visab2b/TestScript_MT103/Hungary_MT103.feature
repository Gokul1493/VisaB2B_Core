Feature: HUNGARY_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPHUNGARY" + Accno
  ...
  Scenario: Transaction initated for HUNGARY country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/HUNGARY.txt')
    * def referencenumber = "AUTOMT103SFTPHUNGARY" + Accno
    * print referencenumber
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/HUNGARY.txt')
    * def finalMt103 = content.replaceAll("20:MT103HUNGARY202402004001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/HUNGARY.txt')
    * def finalMt103 = content.replaceAll(":57A:BKCHHKHHXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/HUNGARY.txt')
    * def finalMt103 = content.replaceAll(":57A:BKCHHKHHXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/HUNGARY.txt')
    * def finalMt103 = content.replaceAll("59:/HU93116000060000000012345676", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/HUNGARY.txt')
    * def finalMt103 = content.replaceAll(":57A:BKCHHKHHXXX", ":57A:BKCHHKHHXXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
