...
* print Accno
  ...
  * print finalMt103
  * jutil.SetData("GetAuditsmalysiamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
	* def finalMt103 = content.replaceAll("20:MT10000MALYSIA000236", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:/CIBBMYKLXXX", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:/CIBBMYKLXXX", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
	* def finalMt103 = content.replaceAll(":59:/4554546887655", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/purpose of payment for Malaysia", "70:"  ).replaceAll("20:MT10000MALYSIA000236", "20:MT103SFTPALBENIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Malaysia country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
  * def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT10000MALYSIA000236", "20:" + referencenumber ).replaceAll(":32A:240326MYR12", ":32A:200408USD138.28").replaceAll(":70:/POP/POP", "70:"  )
  * print finalMt103
  * jutil.SetData("GetAuditsmalysiamt103rsothercurrency",referencenumber)
   * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
 ...
 * match response.result.message == validations.successMessage
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/MALAYSIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:/CIBBMYKLXXX", ":57A:CIBBMYKLXXXXXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
