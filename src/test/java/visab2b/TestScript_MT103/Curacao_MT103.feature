Feature: CURACAO_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPCURACAO" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103CURACAO202401040001", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsCuracomt103rspostive",referencenumber)
  ...
  Scenario: Transaction initated for CURACAO country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def referencenumber = "AUTOMT103SFTPCURACAO" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103CURACAO202401040001", "20:" + referencenumber ).replaceAll("32A:200408ANG108.28", "32A:200408USD138.28")
    * print finalMt103
    * jutil.SetData("GetAuditscuracaomt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll("20:MT103CURACAO202401040001", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll(":57A:CBCSCWCUXXX", ":57A:")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll(":57A:CBCSCWCUXXX", ":57A:ABCD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic Less than 8 character
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll(":57A:CBCSCWCUXXX", ":57A:BBHOBDD")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic MORE THAN 11 CHARACTER
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll(":57A:CBCSCWCUXXX", ":57A:CBCSCWCUXXXX")
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll("59:/0305000010009795493P1", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/CURACAO.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/Payment as agreed CURACAO", ":70:"  ).replaceAll("20:MT103CURACAO202401040001", "20:AUTOMT103SFTPCURACAO" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
