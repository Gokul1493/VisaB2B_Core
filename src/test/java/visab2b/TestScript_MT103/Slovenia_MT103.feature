...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPSLOVENIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT103EUR20228521461215", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditssloveniamt103rspostive",referencenumber)
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/SLOVENIA.txt')
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT103EUR20228521461215", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/SLOVENIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:BSLJSI2XB2B", ":57A:"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/SLOVENIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:BSLJSI2XB2B", ":57A:ABC"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/SLOVENIA.txt')
	* def finalMt103 = content.replaceAll(":59:/SI56263300012039086", ":59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Transaction initated for Slovenia country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/SLOVENIA.txt')
  * def referencenumber = "MT103SFTPMALTA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT103EUR20228521461215", "20:" + referencenumber ).replaceAll(":32A:200408EUR11,28", ":32A:200408USD138.28")
  * print finalMt103
  * jutil.SetData("GetAuditssloveniamt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
   ...
   * def value = signsreq(reqadd,user)
	 ...
	 * def content = read('classpath:visab2b/MT103_files/SLOVENIA.txt')
	 * def finalMt103 = content.replaceAll(":57A:BSLJSI2XB2B", ":57A:BSLJSI2XB2BXX"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
