Feature: MALTA_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * print finalMt103
    * jutil.SetData("GetAuditsmaltamt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/MALTA.txt')
    * def finalMt103 = content.replaceAll("20:MT103MALTA202254324738274834", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/MALTA.txt')
    * def finalMt103 = content.replaceAll(":57A:MALTMTMTXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/MALTA.txt')
    * def finalMt103 = content.replaceAll(":57A:MALTMTMTXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/MALTA.txt')
    * def finalMt103 = content.replaceAll("59:/MT04MALT01100123456789000004715", "59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for MALTA country with different currency  (currency:- USD)
    ...
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:MT103MALTA202254324738274834", "20:" + referencenumber ).replaceAll(":32A:200408ALL138.28", ":32A:200408USD138.28").replaceAll("70:/POP/POP", "70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditsmaltamt103othercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic more than 11 digits
    * def content = read('classpath:visab2b/MT103_files/MALTA.txt')
    * def finalMt103 = content.replaceAll(":57A:MALTMTMTXXX", ":57A:MALTMTMTXXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
