Feature: PERU_MT103
  ...
  Scenario: Positive flow of the transaction
    ...
    * def referencenumber = "AUTOMT103SFTPPERU" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PEN2022086755736364734246", "20:" + referencenumber )
    * print finalMt103
    * jutil.SetData("GetAuditsperumt103rspostive",referencenumber)
  ...
  Scenario: Transaction with end to end as Empty
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PEN2022086755736364734246", "20:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Empty
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":57A:ICBKPEPLXXX", ":57A:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Creditor Bic as Invaild
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":57A:ICBKPEPLXXX", ":57A:ABC"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: To verify the Beneficiary Tax ID is above 11-digit
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":77B:/INN/11223344556", ":77B:/INN/112233445566"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: To verify the Beneficiary Tax ID is below 11-digit
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":77B:/INN/11223344556", ":77B:/INN/1122334455"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: To verify the Beneficiary Tax ID without prefix
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":77B:/INN/11223344556", ":77B:/1122334455"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: CreditorIBAN/AccountNumber as Empty
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":59:/435465465", ":59:"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Purpose of payment(POP)- as Empty
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":70:/POP/purpose of payment peru", ":70:"  ).replaceAll("20:2603001SFTPMT10PEN2022086755736364734246", "20:MT103SFTPMAURITIUS" + Accno )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  Scenario: Transaction initated for Peru country with different currency  (currency:- USD)
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def referencenumber = "MT103SFTPMALTA" + Accno
    * print referencenumber
    * def finalMt103 = content.replaceAll("20:2603001SFTPMT10PEN2022086755736364734246", "20:" + referencenumber ).replaceAll(":32A:200408PEN138,28", ":32A:200408USD138.28").replaceAll(":70:/POP/purpose of payment peru", ":70:"  )
    * print finalMt103
    * jutil.SetData("GetAuditsperumt103rsothercurrency",referencenumber)
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
    * print reqadd
  ...
  Scenario: Creditor Bic More than 11 digits
    * def content = read('classpath:visab2b/MT103_files/PERU.txt')
    * def finalMt103 = content.replaceAll(":57A:ICBKPEPLXXX", ":57A:ICBKPEPLXXXXX"  )
    * print finalMt103
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
