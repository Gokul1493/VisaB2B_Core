...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPINDONESIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
  * print finalMt103
  * jutil.SetData("GetAuditsindomt103rspostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == validations.successMessage
	...
	Scenario: Transaction initated for INDONESIA country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
  * def referencenumber = "AUTOMT103SFTPINDONESIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber ).replaceAll("59:/45465787686456465", "59:/9858855577"  ).replaceAll("32A:240326IDR10,45", "32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed INDONESIA", "70:")
  * print finalMt103
  * jutil.SetData("GetAuditsindomt103rsothercurrency",referencenumber)
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  * print reqadd
...
Scenario: Transaction with end to end as Empty
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Empty
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Creditor Bic as Invaild
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:ABCD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:BBHOBDD")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:SUNIIDJAXXXX")
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll("59:/45465787686456465", "59:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
	* def finalMt103 = content.replaceAll("70:/POP/Payment as agreed INDONESIA", "70:"  ).replaceAll("20:MT103INDONESIA20240402001", "20:AUTOMT103SFTPINDONESIA" + Accno )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_Review_transaction.json')
