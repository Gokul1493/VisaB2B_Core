...
* reqadd.params.Payload.CreditorAgent.Bic = "ICBKPEPLXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "PEN"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsPeruformpostive",referencenumber)
...
Scenario: Using 12 digits of Tax id 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "ICBKPEPLXXX"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsPeruformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
