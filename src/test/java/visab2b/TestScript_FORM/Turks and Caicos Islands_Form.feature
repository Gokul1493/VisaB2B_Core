...
* def country = "TRUKSCAICOSISLANDS"
* print Accno
...
* reqadd.params.Payload.CreditorAgent.Bic = "TCBCTCGPXXX"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsTurksandCaicosIslandsformpostive",referencenumber)
...
Scenario: Positive flow with KRW currency (Other currency)
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "TCBCTCGPXXX"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsTurksandCaicosIslandsformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
