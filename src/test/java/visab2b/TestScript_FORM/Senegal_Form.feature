...
* reqadd.params.Payload.CreditorAgent.Bic = "AFRISNDAXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "XOF"
...
* reqadd.params.Payload.InstructingReimbursementAgent = "NATAAU3303M"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSenegalformpostive",referencenumber)
 ...
 * match response.error.message contains validations.EmptyPOP
	...
	Scenario: Using 23 digits of account number 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "AFRISNDAXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "XOF"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "68539007547034666345678"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.InstructingReimbursementAgent = "NATAAU3303M"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 * def value = signsreq(reqadd,user)
 ...
 When method POST
 Then status 200
* match response.error contains {message:"Creditor AccountNumber must be 24-Characters.",data:null}		
	
 
	Scenario: Using 25 digits of account number 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "AFRISNDAXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "XOF"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "6853900754703466634567855"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.InstructingReimbursementAgent = "NATAAU3303M"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSenegalformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
