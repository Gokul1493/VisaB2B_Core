...
* reqadd.params.Payload.CreditorAgent.Bic = "BNMXMXMMXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "MXN"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "689054364376585782"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsMexcioformpostive",referencenumber)
...
* match response.error.message contains validations.EmptyIban_AccNumber	
 ...
 Scenario: 17 digits of account number
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BNMXMXMMXXX"
 ...
 * def value = signsreq(reqadd,user)
 ...
 Then status 200
 * print response
 * match response.error contains {message:"Creditor AccountNumber must be 18-numeric.",data:null}	


 Scenario: 19 digits of account number
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BNMXMXMMXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "MXN"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "6890543643765857818"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 * def value = signsreq(reqadd,user)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsMexcioformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
