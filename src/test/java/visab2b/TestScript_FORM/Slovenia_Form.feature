...
* reqadd.params.Payload.CreditorAgent.Bic = "BSLJSI2XB2B"
* reqadd.params.Payload.InstructedAmount.Currency = "EUR"
* reqadd.params.Payload.CreditorAccount.Iban = "SI56263300012039086"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsSloveniaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsSloveniaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
