...
* reqadd.params.Payload.CreditorAgent.Bic = "BIGBPLPWXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "PLN"
* reqadd.params.Payload.CreditorAccount.Iban = "PL61109010140000071219812874"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsPolandformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsPolandformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
