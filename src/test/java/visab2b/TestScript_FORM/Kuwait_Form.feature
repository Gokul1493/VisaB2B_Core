...
* reqadd.params.Payload.CreditorAgent.Bic = "NBOKKWKWXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "KWD"
* reqadd.params.Payload.CreditorAccount.Iban = "KW81CBKU0000000000001234560101"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsKuwaitformpostive",referencenumber)
...
* reqadd.params.Payload.CreditorAgent.Bic = "NBOKKWKWXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "KWD"
* reqadd.params.Payload.CreditorAccount.Iban = "GR9608100010000001234567890"
* reqadd.params.Api.Credential = testData.Visa_Mk.Credential
   * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsKuwaitformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
