Feature: swift_file_transfer_Form_belarus
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.InstructedAmount.Currency = "BYN"
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "454566845313"
    * reqadd.params.Payload.CreditorAgent.Bic = "AKBBBY2XXXX"
