...
* reqadd.params.Payload.CreditorAgent.Bic = "COLOCOBMXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "COP"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "5800021000011130000102"
* reqadd.params.Payload.CreditorAccount.TaxId = "012345678"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsColombiaformpostive",referencenumber)
...
* reqadd.params.Payload.InstructedAmount.Currency = "COP"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "5800021000011130000102"
* reqadd.params.Payload.CreditorAccount.TaxId = "12345678"
* reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
* reqadd.params.Payload.PaymentPurpose = "COCADR"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 * def value = signsreq(reqadd,user)
 ...
 When method POST
 Then status 200
* match response.error contains {message:"Creditor TaxId must be 9 or 10-numeric.",data:null}
...
* reqadd.params.Payload.InstructedAmount.Currency = "COP"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "5800021000011130000102"
* reqadd.params.Payload.CreditorAccount.TaxId = "01234567890"
* reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
* reqadd.params.Payload.PaymentPurpose = "COCADR"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsColombiaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
