...
* reqadd.params.Payload.CreditorAgent.Bic = "CONKKENAXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "KES"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "5758585858758"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsKenyaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsKenyaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
