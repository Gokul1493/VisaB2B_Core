...
* reqadd.params.Payload.CreditorAgent.Bic = "SBHQSARRXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "SAR"
* reqadd.params.Payload.CreditorAccount.Iban = "SA0380000000608010167519"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSaudiArabiaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSaudiArabiaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
