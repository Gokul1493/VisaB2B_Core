...
* reqadd.params.Payload.CreditorAgent.Bic = "AAFCSEMM"
* reqadd.params.Payload.InstructedAmount.Currency = "SEK"
* reqadd.params.Payload.CreditorAccount.Iban = "SE9524946551426876936529"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
     * jutil.SetData("GetAuditsSwedenformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSwedenformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
