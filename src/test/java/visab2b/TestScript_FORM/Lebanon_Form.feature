...
* reqadd.params.Payload.CreditorAgent.Bic = "BABELBBEXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "LBP"
* reqadd.params.Payload.CreditorAccount.Iban = "LB62099900000001001901229114"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsLebanonformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsLebanonformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
