...
* reqadd.params.Payload.CreditorAgent.Bic = "BOMMMUPLXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "MUR"
* reqadd.params.Payload.CreditorAccount.Iban = "MR1300020001010000123456753"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsMauritiusformpostive",referencenumber)
...
* reqadd.params.Payload.CreditorAgent.Bic = "BOMMMUPLXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "MUR"
* reqadd.params.Payload.CreditorAccount.Iban = "GE29NB0000000101904917"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Api.Credential = testData.Visa_Mk.Credential
   * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsMauritiusformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
