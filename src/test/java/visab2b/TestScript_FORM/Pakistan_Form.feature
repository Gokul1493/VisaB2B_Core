Feature: swift_file_transfer_Form_Pakistan
 ...
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
	* reqadd.params.Payload.CreditorAgent.Bic = "HABBPKKA007"
* reqadd.params.Payload.InstructedAmount.Currency = "PKR"
* reqadd.params.Payload.CreditorAccount.Iban = "PK36SCBL0000001123456702"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsPakistanformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsPakistanformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
