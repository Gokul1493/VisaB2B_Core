...
* reqadd.params.Payload.CreditorAgent.Bic = "BPPIITRRXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "EUR"
* reqadd.params.Payload.CreditorAccount.Iban = "IT60X0542811101000000123456"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsItalyformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsItalyformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
