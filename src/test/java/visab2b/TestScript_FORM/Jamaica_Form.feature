...
* reqadd.params.Payload.CreditorAgent.Bic = "BAJAJMKNXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "JMD"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "68905436437658578"
* reqadd.params.Payload.CreditorAgent.BranchId = "12345"
 ...
 * match response.error.message contains validations.EmptyPOP	
	...
	Scenario: Branch ID as empty
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BAJAJMKNXXX"
* reqadd.params.Payload.CreditorAgent.BranchId = ""
* reqadd.params.Payload.InstructedAmount.Currency = "JMD"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "68905436437658578"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 ...
 * match response.error.message contains validations.BranchID	
	...
	Scenario:  Branch id Less than 2 character
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BAJAJMKNXXX"
* reqadd.params.Payload.CreditorAgent.BranchId = "12"
* reqadd.params.Payload.InstructedAmount.Currency = "JMD"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "68905436437658578"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 ...
 * def value = signsreq(reqadd,user)
 ...
 When method POST
 Then status 200
 * match response.error contains {message:"CreditorAgentBranchID must be min 3 and max 5 characters",data:null}	
 
 
 	Scenario: Branch id more than 5 character
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BAJAJMKNXXX"
* reqadd.params.Payload.CreditorAgent.BranchId = "123456"
* reqadd.params.Payload.InstructedAmount.Currency = "JMD"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "68905436437658578"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
