...
* reqadd.params.Payload.CreditorAgent.Bic = "GHUNHUHBXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "HUF"
* reqadd.params.Payload.CreditorAccount.Iban = "HU42117730161111101800000000"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsHungaryformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsHungaryformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
