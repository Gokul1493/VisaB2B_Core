 ...
 * reqadd.params.Payload.InstructedAmount.Currency = "BAM"
 * reqadd.params.Payload.CreditorAgent.Bic = "CBBSBA22PDS"
 * reqadd.params.Payload.CreditorAccount.Iban = "BA391290079401028494"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsBosniaandherzegovinaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsBosniaandherzegovinaFormothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
