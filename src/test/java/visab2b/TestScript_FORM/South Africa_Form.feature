...
* reqadd.params.Payload.CreditorAgent.Bic = "AFEPZAJ2CLO"
* reqadd.params.Payload.InstructedAmount.Currency = "ZAR"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsSouthAfricaformpostive",referencenumber)
...
* reqadd.params.Payload.CreditorAgent.Bic = "AFEPZAJ2CLO"
* reqadd.params.Payload.InstructedAmount.Currency = "ZAR"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "45435435435435"
* reqadd.params.Payload.PaymentPurpose = "VO23456 Payment as Agreed"
...
* reqadd.params.Payload.CreditorAgent.Bic = "AFEPZAJ2CLO"
* reqadd.params.Payload.InstructedAmount.Currency = "ZAR"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "45554545455454"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsSouthAfricaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
