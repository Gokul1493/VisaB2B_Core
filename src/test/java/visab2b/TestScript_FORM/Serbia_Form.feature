...
* reqadd.params.Payload.CreditorAgent.Bic = "RZBSRSBGXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "RSD"
* reqadd.params.Payload.CreditorAccount.Iban = "RS35260005601001611379"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsSerbiaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsSerbiaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
