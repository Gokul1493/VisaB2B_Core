...
* reqadd.params.Payload.CreditorAgent.Bic = "BNBGBGSDXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "BGN"
* reqadd.params.Payload.CreditorAccount.Iban = "BG80BNBG96611020345678" 
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsBulgariaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsBulgariaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
