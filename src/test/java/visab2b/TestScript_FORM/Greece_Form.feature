Feature: swift_file_transfer_Form_albania
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.CreditorAgent.Bic = "BNGRGRAAACO"
    * reqadd.params.Payload.InstructedAmount.Currency = "EUR"
    * reqadd.params.Payload.CreditorAccount.Iban = "GR1601101250000000012300695"
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsGreeceformpostive",referencenumber)
  ...
  Scenario: Positive flow with other currency
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsGreeceformothercurrency",referencenumber)
    * jutil.SetData("Duplicaterefnumber",referencenumber)
    * print jutil.SetData('Duplicaterefnumber',referencenumber)
