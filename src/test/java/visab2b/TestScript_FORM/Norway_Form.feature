...
* reqadd.params.Payload.CreditorAgent.Bic = "CHASNO33XXX"
* reqadd.params.Payload.InstructedAmount.Currency = "NOK"
* reqadd.params.Payload.CreditorAccount.Iban = "NO9386011117947"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsNorwayformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsNorwayformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
