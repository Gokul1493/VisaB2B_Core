Feature: swift_file_transfer_Form_Antigua
...
* def validations = validation_Messages.Validations
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.InstructedAmount.Currency = "MZN"
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "2103654789987456321002145"
    * reqadd.params.Payload.CreditorAgent.Bic = "BMOCMZMAXXX"
    ...
    * jutil.SetData("GetAuditPositive_Mozambique",referencenumber)
...
* def sleep = function(millis){ return java.lang.Thread.sleep(millis) }
  ...
  Scenario: Transaction with end to end identification already exists
    ...
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "ANTIGUAACCNO9399393"
    * reqadd.params.Payload.CreditorAgent.Bic = "BMOCMZMAXXX"
    * reqadd.params.Payload.CreditorAgent.BranchName = "Downtown Branch"
    * reqadd.params.Payload.PaymentPurpose = "purpose of the Payment"
    * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
  ...
  Scenario: Transaction initiated for Namibia country with different currency
    ...
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "3214569870012365478932145"
    * reqadd.params.Payload.CreditorAgent.Bic = "BMOCMZMAXXX"
    * reqadd.params.Payload.CreditorAgent.BranchName = "Downtown Branch"
    * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
    * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
    ...
    * jutil.SetData("Duplicaterefnumber",referencenumber)
    * print jutil.SetData('Duplicaterefnumber',referencenumber)
    * jutil.SetData("GetAuditCrossBorder_Mozambique",referencenumber)
