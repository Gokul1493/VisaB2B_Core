...
* reqadd.params.Payload.CreditorAgent.Bic = "BOMUMNUBXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "MNT"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "78787878778"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsMongoliaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsMongoliaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
