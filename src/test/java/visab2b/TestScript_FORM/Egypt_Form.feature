...
* def validations = validation_Messages.Validations
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.CreditorAgent.Bic = "CBEGEGCXXXX"
    * reqadd.params.Payload.InstructedAmount.Currency = "EGP"
    * reqadd.params.Payload.CreditorAccount.Iban = "EG800002000156789012345"
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsEgyptformpostive",referencenumber)
...
* def sleep = function(millis){ return java.lang.Thread.sleep(millis) }
  ...
  Scenario: Transaction with end to end identification already exists
    ...
    * reqadd.params.Payload.CreditorAgent.Bic = "CBEGEGCXXXX"
    * reqadd.params.Payload.InstructedAmount.Currency = "EGP"
    * reqadd.params.Payload.CreditorAccount.Iban = "EG800002000156789012345180002"
    * reqadd.params.Payload.CreditorAgent.BranchName = "Downtown Branch"
    * reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
    * reqadd.params.Payload.PaymentPurpose = "VO23456 Payment as Agreed"
    * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
  ...
  Scenario: Bic as Inavalid
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
    * reqadd.params.Payload.CreditorAgent.Bic = "GGGGGGGGGGGG"
    * reqadd.params.Payload.InstructedAmount.Currency = "EGP"
    * reqadd.params.Payload.CreditorAccount.Iban = "EG800002000156789012345180002"
    * reqadd.params.Payload.CreditorAgent.BranchName = "Downtown Branch"
    * reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
  ...
  Scenario: Positive flow with other currency
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsEgyptformothercurrency",referencenumber)
    * jutil.SetData("Duplicaterefnumber",referencenumber)
    * print jutil.SetData('Duplicaterefnumber',referencenumber)
