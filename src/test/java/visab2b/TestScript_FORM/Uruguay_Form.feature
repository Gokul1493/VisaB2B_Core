...
* reqadd.params.Payload.CreditorAgent.Bic = "BROUUYMMXXX"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsUruguayformpostive",referencenumber)
...
Scenario: Using 11 digits of Tax id 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BROUUYMMXXX"
...
Scenario: Using 13 digits of Tax id 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BROUUYMMXXX"
...
* reqadd.params.Payload.CreditorAgent.BranchName = "Downtown Branch"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.CreditorAccount.TaxId = "1122334455655"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 * def value = signsreq(reqadd,user)
 And request value
...
Scenario: Positive flow using USD currency
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "BROUUYMMXXX"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsUruguayformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
