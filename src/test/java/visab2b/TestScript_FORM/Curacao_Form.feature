...
* reqadd.params.Payload.CreditorAgent.Bic = "TOTLCWCUXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "ANG"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsCuracaoformpostive",referencenumber)
 ...
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "GGGGGGGG"
* reqadd.params.Payload.InstructedAmount.Currency = "ANG"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "2322435465756384768678698797896709806890"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsCuracaoformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
