Feature: swift_file_transfer_Form_albania
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.CreditorAgent.Bic = "TNISROB2XXX"
    * reqadd.params.Payload.InstructedAmount.Currency = "RON"
    * reqadd.params.Payload.CreditorAccount.Iban = "RO49AAAA1B31007593840000"
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsRomaniaformpostive",referencenumber)
  ...
  Scenario: Positive flow with other currency
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsRomaniaformothercurrency",referencenumber)
    * jutil.SetData("Duplicaterefnumber",referencenumber)
    * print jutil.SetData('Duplicaterefnumber',referencenumber)
