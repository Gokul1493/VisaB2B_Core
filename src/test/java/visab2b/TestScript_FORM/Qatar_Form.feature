...
* reqadd.params.Payload.CreditorAgent.Bic = "QNBAQAQASLB"
* reqadd.params.Payload.InstructedAmount.Currency = "QAR"
* reqadd.params.Payload.CreditorAccount.Iban = "QA58DOHB00001234567890ABCDEFG"
