...
* def validations = validation_Messages.Validations
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.InstructedAmount.Currency = "TWD"
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "54875432132468"
    * reqadd.params.Payload.CreditorAgent.Bic = "BKTWTWTP053"
