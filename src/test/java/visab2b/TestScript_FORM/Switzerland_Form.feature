...
* reqadd.params.Payload.CreditorAgent.Bic = "KBAGCH22"
* reqadd.params.Payload.InstructedAmount.Currency = "CHF"
* reqadd.params.Payload.CreditorAccount.Iban = "CH2289144633283464381"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSwitzerlandformothercurrency",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsSwitzerlandformpostive",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
