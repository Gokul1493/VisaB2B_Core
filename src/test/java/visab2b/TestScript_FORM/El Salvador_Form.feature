...
* reqadd.params.Payload.CreditorAgent.Bic = "BACUSVSSXXX"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsElSalvadorformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsElSalvadorformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
