...
* reqadd.params.Payload.CreditorAgent.Bic = "BOIOCZP1XXX"
* reqadd.params.Payload.InstructedAmount.Currency = "CZK"
* reqadd.params.Payload.CreditorAccount.Iban = "CZ6508000000192000145399"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsCzechRepublicformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsCzechRepublicformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
