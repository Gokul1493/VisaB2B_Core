...
* def validations = validation_Messages.Validations
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.CreditorAgent.Bic = "BPDODOSXXXX"
    * reqadd.params.Payload.InstructedAmount.Currency = "DOP"
    * reqadd.params.Payload.CreditorAccount.Iban = "DO22ACAU00000000000123456789"
    * reqadd.params.Payload.CreditorAccount.TaxId = "112233445"
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsDominicanRepublicformpostive",referencenumber)
  ...
  Scenario: using 8 digit of Tax ID
    * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
    * reqadd.params.Payload.CreditorAgent.Bic = "BPDODOSXXXX"
    * reqadd.params.Payload.InstructedAmount.Currency = "DOP"
    * reqadd.params.Payload.CreditorAccount.Iban = "DO22ACAU00000000000123456789"
    * reqadd.params.Payload.CreditorAccount.TaxId = "11223344"
    * reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
    * reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
    * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
    * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
    * def value = signsreq(reqadd,user)
    ...
    When method POST
    Then status 200
    * match response.error contains {message:"Creditor TaxId must be 9-numeric.",data:null}
  ...
  Scenario: Positive flow with other currency
    ...
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "2322435465756384768678698797896709806890"
    * reqadd.params.Payload.CreditorAccount.TaxId = "112233445"
    * reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
    * reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
    * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
    ...
    * def value = signsreq(approve,user)
    ...
    When method POST
    Then status 200
    * jutil.SetData("GetAuditsDominicanRepublicformothercurrency",referencenumber)
    * jutil.SetData("Duplicaterefnumber",referencenumber)
    * print jutil.SetData('Duplicaterefnumber',referencenumber)
