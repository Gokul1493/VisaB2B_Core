...
* reqadd.params.Payload.CreditorAgent.Bic = "ISRAILIJXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "ILS"
* reqadd.params.Payload.CreditorAccount.Iban = "IL620108000000099999999"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
  * jutil.SetData("GetAuditsIsraelformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsIsraelformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
