...
* reqadd.params.Payload.CreditorAgent.Bic = "UBBRPYPXXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "PYG"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "4325435465"
* reqadd.params.Payload.CreditorAgent.BranchName = "Downtown Branch"
* reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.CreditorAccount.TaxId = "112233"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsParaguayformpostive",referencenumber)
...
* reqadd.params.Payload.InstructedAmount.Currency = "PYG"
* reqadd.params.Payload.CreditorAccount.AccountNumber = "4325435465"
* reqadd.params.Payload.CreditorAgent.BranchName = ""
* reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.CreditorAccount.TaxId = "112233"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 ...
 * def value = signsreq(reqadd,user)
 ...
 When method POST
 Then status 200
* match response.error contains {message:"Parameter 'CreditorAgentBranchName' cannot be null.",data:null}		 


	
Scenario: Empty Taxid case 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "UBBRPYPXXXX"
...
Scenario: Using 5 digits of Tax id 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "UBBRPYPXXXX"
...
* reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.CreditorAccount.TaxId = "12345"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 * def value = signsreq(reqadd,user)
 And request value
 When method POST
* match response.error contains {message:"Creditor TaxId must be 6 to 9-Characters.",data:null} 



Scenario: Using 10 digits of Tax id 
 * def user = testData.Visa_Mk
 Given url QaUrl + 'api'
 * def reqadd = read('classpath:visab2b/Payload/form_Review_transaction.json')
* reqadd.params.Payload.CreditorAgent.Bic = "UBBRPYPXXXX"
...
* reqadd.params.Payload.CreditorAccount.PhoneNumber = "+1-8099087766"
* reqadd.params.Payload.PaymentPurpose = "Payment as Agreed"
* reqadd.params.Payload.CreditorAccount.TaxId = "0123456789"
 * reqadd.params.Api.Credential = testData.Visa_Mk.Credential
 * reqadd.params.Api.deviceId = testData.Visa_Mk.keyId
 * def value = signsreq(reqadd,user)
 And request value
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsParaguayformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
