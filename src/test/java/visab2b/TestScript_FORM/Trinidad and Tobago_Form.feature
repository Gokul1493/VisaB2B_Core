...
* reqadd.params.Payload.CreditorAgent.Bic = "NOSCTTPSXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "TTD"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsTrinidadandTobagoformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
 * jutil.SetData("GetAuditsTrinidadandTobagoformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
