...
* reqadd.params.Payload.CreditorAgent.Bic = "BCEYLKLXXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "LKR"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
    * jutil.SetData("GetAuditsSriLankaformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
    * jutil.SetData("GetAuditsSriLankaformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
