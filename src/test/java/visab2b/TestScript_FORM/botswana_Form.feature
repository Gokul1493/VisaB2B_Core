...
* def validations = validation_Messages.Validations
  ...
  Scenario: Positive flow of the transaction
    ...
    * reqadd.params.Payload.InstructedAmount.Currency = "BWP"
    * reqadd.params.Payload.CreditorAccount.AccountNumber = "21545448787502"
    * reqadd.params.Payload.CreditorAgent.Bic = "BBOTBWGXXXX"
    ...
    * jutil.SetData("GetAuditPositive_botswana",referencenumber)
...
* def sleep = function(millis){ return java.lang.Thread.sleep(millis) }
  ...
  Scenario: Transaction with cross border currency
    ...
    * jutil.SetData("Duplicaterefnumber",referencenumber)
    * print jutil.SetData('Duplicaterefnumber',referencenumber)
    * jutil.SetData("GetAuditCrossBorder_botswana",referencenumber)
