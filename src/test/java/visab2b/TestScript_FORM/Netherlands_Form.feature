...
* reqadd.params.Payload.CreditorAgent.Bic = "INGBNL2AXXX"
* reqadd.params.Payload.InstructedAmount.Currency = "EUR"
* reqadd.params.Payload.CreditorAccount.Iban = "NL91ABNA0417164300"
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsNetherlandsformpostive",referencenumber)
 ...
 * print referencenumber
 ...
 When method POST
 Then status 200
   * jutil.SetData("GetAuditsNetherlandsformothercurrency",referencenumber)
 * jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
