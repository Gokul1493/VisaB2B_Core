Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromcote = Driver.GetData("ReferenceNo")
    * print randomNumberFromcote
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Cote")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFCI50")
    ...
    * waitFor('{span}Beneficiary Address').input("COTE street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromcote)
    * delay(10000)
