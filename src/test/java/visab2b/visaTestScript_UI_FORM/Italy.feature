Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromitaly = Driver.GetData("ReferenceNo")
    * print randomNumberFromitaly
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("MADIRD")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFIT50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromitaly)
    * delay(10000)
