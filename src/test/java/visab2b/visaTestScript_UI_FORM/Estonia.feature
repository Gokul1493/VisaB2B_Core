Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromEstonia = Driver.GetData("ReferenceNo")
    * print randomNumberFromEstonia
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromEstonia)
    * delay(10000)
