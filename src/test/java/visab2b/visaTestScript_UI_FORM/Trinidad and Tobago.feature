Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromTTD = Driver.GetData("ReferenceNo")
    * print randomNumberFromTTD
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}TT - TrinidadandTobago').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("Bravo")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFTT50")
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromTTD)
    * delay(10000)
