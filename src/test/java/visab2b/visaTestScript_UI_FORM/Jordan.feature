Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromJordan = Driver.GetData("ReferenceNo")
    * print randomNumberFromJordan
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Jordan")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFJO50")
    ...
    * waitFor('{span}PurposeCode').click()
    * waitFor('{span}PurposeCode').input("0811")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromJordan)
    * delay(10000)
