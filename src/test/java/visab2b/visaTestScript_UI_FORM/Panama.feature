Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromPanama = Driver.GetData("ReferenceNo")
    * print randomNumberFromPanama
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("PHILP")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFPA50")
    ...
    * waitFor('{span}Beneficiary Address').input("PHIL street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromPanama)
    * delay(10000)
