Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromGuat = Driver.GetData("ReferenceNo")
    * print randomNumberFromGuat
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("GAUTH")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFGT50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("GT215486478")
    ...
    * waitFor('{span}Beneficiary Contact Phone Number').input("+1-685765")
    * waitFor('{span}Beneficiary TaxId').click()
    * waitFor('{span}Beneficiary TaxId').input("23654789632")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromGuat)
    * delay(10000)
