Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromDRE = Driver.GetData("ReferenceNo")
    * print randomNumberFromDRE
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}DO - DominicanRepublic').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("DRE")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFDO50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("DO5202366")
    * waitFor('{span}Beneficiary TaxId').click()
    * waitFor('{span}Beneficiary TaxId').input("123654789")       
    * waitFor('{span}Beneficiary Address').click()
    * waitFor('{span}Beneficiary Address').input("Domi street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromDRE)
    * delay(10000)
