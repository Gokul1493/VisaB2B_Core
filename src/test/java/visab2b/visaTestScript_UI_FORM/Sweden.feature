Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromSweden = Driver.GetData("ReferenceNo")
    * print randomNumberFromSweden
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Doeschate")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFSE50")
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromSweden)
    * delay(10000)
