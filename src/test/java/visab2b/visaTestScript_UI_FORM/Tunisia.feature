Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromTunisia = Driver.GetData("ReferenceNo")
    * print randomNumberFromTunisia
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("TUNSA")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFTN50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("AL520552366")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromTunisia)
    * delay(10000)
