Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromBAH = Driver.GetData("ReferenceNo")
    * print randomNumberFromBAH
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}BA - BosniaandHerzegovina').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Bic').input("ASDFBA50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromBAH)
    * delay(10000)
