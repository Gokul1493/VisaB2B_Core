Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromHK = Driver.GetData("ReferenceNo")
    * print randomNumberFromHK
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("TUNSUIEH")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFHK50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromHK)
    * delay(10000)
