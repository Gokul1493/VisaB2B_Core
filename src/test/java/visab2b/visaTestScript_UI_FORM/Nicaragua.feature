Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromNicaragua = Driver.GetData("ReferenceNo")
    * print randomNumberFromNicaragua
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("SEN")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFNI50")
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromNicaragua)
    * delay(10000)
