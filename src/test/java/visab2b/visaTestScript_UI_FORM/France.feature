Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromFrance = Driver.GetData("ReferenceNo")
    * print randomNumberFromFrance
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Bic').input("ASDFFR50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("FR5202366")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromFrance)
    * delay(10000)
