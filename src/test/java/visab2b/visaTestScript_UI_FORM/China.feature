Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForChina = Driver.GetData("ReferenceNo")
    * print randomNumberForChina
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("JACKIE")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFCN50")
    ...
    * waitFor('{span}Beneficiary Account Number').input("2365478996655")
    ...
    * waitFor('{span}Purpose').input("CGODDR")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForChina)
    * delay(10000)
