Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromBVI = Driver.GetData("ReferenceNo")
    * print randomNumberFromBVI
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}VG - BritishVirginIslands').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("BRITISH")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFVG50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("AL5458562254548787878767")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromBVI)
    * delay(10000)
