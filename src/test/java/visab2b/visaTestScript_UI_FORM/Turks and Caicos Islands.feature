Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromTAC = Driver.GetData("ReferenceNo")
    * print randomNumberFromTAC
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}TC - TurksandCaicosIslands').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("TIGO")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFTC50")
    * waitFor('{span}Beneficiary Account Number').click()
    * waitFor('{span}Beneficiary Account Number').input("32654879")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromTAC)
    * delay(10000)
