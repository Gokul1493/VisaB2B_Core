Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromuk = Driver.GetData("ReferenceNo")
    * print randomNumberFromuk
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}GB - UnitedKingdom').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("Root")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFGB50")
    * waitFor('{span}Beneficiary ClearingMemberId').click()
    * waitFor('{span}Beneficiary ClearingMemberId').input("123654")
    * waitFor('{span}Beneficiary Account Number').click()
    * waitFor('{span}Beneficiary Account Number').input("2365478996655")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("GB215486478")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromuk)
    * delay(10000)
