Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromMauritius = Driver.GetData("ReferenceNo")
    * print randomNumberFromMauritius
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromMauritius)
    * delay(10000)
