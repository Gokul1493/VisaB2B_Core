Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromParaguay = Driver.GetData("ReferenceNo")
    * print randomNumberFromParaguay
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Paragy")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFPY50")
    * waitFor('{span}Beneficiary Account Number').click()
    * waitFor('{span}Beneficiary Account Number').input("123654")
    * waitFor('{span}Beneficiary BranchName').click()
    * waitFor('{span}Beneficiary BranchName').input("PARAGUAYIAN")
    ...
    * waitFor('{span}Beneficiary TaxId').input("123233")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromParaguay)
    * delay(10000)
