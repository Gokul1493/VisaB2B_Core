Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromCYI = Driver.GetData("ReferenceNo")
    * print randomNumberFromCYI
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}KY - CaymanIslands').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("CAYMAN")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFKY50")
    ...
    * waitFor('{span}Beneficiary Address').input("CAYY street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromCYI)
    * delay(10000)
