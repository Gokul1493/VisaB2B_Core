Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForVietnam = Driver.GetData("ReferenceNo")
    * print randomNumberForVietnam
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("vietan")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFVN50")
    ...
    * waitFor('{span}Beneficiary Address').input("VIETTSE street")
    * delay(2000)
    * waitFor('{span}Beneficiary BranchName').click()
    * waitFor('{span}Beneficiary BranchName').input('hanoi branch')
    #Transaction details
  ...
  @checker
  Scenario: Login into Visab2b Checker
    Given driver 'about:blank'
    And maximize()
    # Open the login page
    * driver Url + "login"
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForVietnam)
    * delay(10000)
