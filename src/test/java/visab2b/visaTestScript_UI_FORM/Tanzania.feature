Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForTanzania = Driver.GetData("ReferenceNo")
    * print randomNumberForTanzania
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Tanza")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFTZ50")
    * waitFor('{span}Beneficiary BranchName').click()
    * waitFor('{span}Beneficiary BranchName').input("Tansu")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForTanzania)
    * delay(10000)
