Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromQatar = Driver.GetData("ReferenceNo")
    * print randomNumberFromQatar
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromQatar)
    * delay(10000)
