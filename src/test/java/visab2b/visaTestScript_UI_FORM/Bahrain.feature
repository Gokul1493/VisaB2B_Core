Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForBahrain = Driver.GetData("ReferenceNo")
    * print randomNumberForBahrain
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("BAHI")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFBH50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("2365478996655")
    * waitFor('{span}Beneficiary Address').click()
    * waitFor('{span}Beneficiary Address').input("bahrain street")
    * delay(2000)
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForBahrain)
    * delay(10000)
