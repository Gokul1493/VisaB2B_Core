Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForSA = Driver.GetData("ReferenceNo")
    * print randomNumberForSA
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Smith")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFZA50")
    * waitFor('{span}Beneficiary Contact Phone Number').click()
    * waitFor('{span}Beneficiary Contact Phone Number').input("+1-342654")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForSA)
    * delay(10000)
