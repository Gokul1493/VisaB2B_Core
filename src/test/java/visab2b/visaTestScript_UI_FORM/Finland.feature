Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromFinland = Driver.GetData("ReferenceNo")
    * print randomNumberFromFinland
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Finny")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFFI50")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("FI5202366")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromFinland)
    * delay(10000)
