Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromMalaysia = Driver.GetData("ReferenceNo")
    * print randomNumberFromMalaysia
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("MALAI")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFMY50")
    ...
    * waitFor('{span}Beneficiary Address').input("MALAI street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromMalaysia)
    * delay(10000)
