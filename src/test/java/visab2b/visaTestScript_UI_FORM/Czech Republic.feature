Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromCZR = Driver.GetData("ReferenceNo")
    * print randomNumberFromCZR
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}CZ - CzechRepublic').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("CZRR")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFCZ50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromCZR)
    * delay(10000)
