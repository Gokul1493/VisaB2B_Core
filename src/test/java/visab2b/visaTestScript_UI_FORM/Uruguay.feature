Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromUru = Driver.GetData("ReferenceNo")
    * print randomNumberFromUru
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("UYGA")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFUY50")
    * waitFor('{span}Beneficiary BranchName').click()
    * waitFor('{span}Beneficiary BranchName').input("UYUGAY")
    * waitFor('{span}Beneficiary Account Number').click()
    * waitFor('{span}Beneficiary Account Number').input("546787987")
    ...
    * waitFor('{span}Beneficiary TaxId').input("125666699885")
    * delay(2000)
    #Transaction details
    ...
    * waitFor('{span}Purpose').input("VO23456")
    * delay(2000)
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromUru)
    * delay(10000)
