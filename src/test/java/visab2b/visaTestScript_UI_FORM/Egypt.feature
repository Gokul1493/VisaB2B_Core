Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromEgypt = Driver.GetData("ReferenceNo")
    * print randomNumberFromEgypt
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("EGYPTI")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFEG50")
    * waitFor('{span}Beneficiary Contact Phone Number').click()
    * waitFor('{span}Beneficiary Contact Phone Number').input("+1-123654579")
    * waitFor('{span}Beneficiary BranchName').click()
    * waitFor('{span}Beneficiary BranchName').input("EGYTP")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromEgypt)
    * delay(10000)
