Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromAzer = Driver.GetData("ReferenceNo")
    * print randomNumberFromAzer
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("AZER")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFAZ50")
    ...
    * waitFor('{span}Beneficiary Iban').input("AZ01224487797864589633201254")
    ...
    * waitFor('{span}Beneficiary TaxId').input("1236547898")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromAzer)
    * delay(10000)
