Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromCuracao = Driver.GetData("ReferenceNo")
    * print randomNumberFromCuracao
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("Cura")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFCW50")
    * waitFor('{span}Beneficiary Account Number').click()
    * waitFor('{span}Beneficiary Account Number').input("156468468464")
    * waitFor('{span}Beneficiary Address').click()
    * waitFor('{span}Beneficiary Address').input("CURA street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromCuracao)
    * delay(10000)
