Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromNigeria = Driver.GetData("ReferenceNo")
    * print randomNumberFromNigeria
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Bic').input("ASDFNG50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromNigeria)
    * delay(10000)
