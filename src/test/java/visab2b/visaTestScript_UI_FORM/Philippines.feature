Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromPHIL = Driver.GetData("ReferenceNo")
    * print randomNumberFromPHIL
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Bic').input("ASDFPH50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromPHIL)
    * delay(10000)
