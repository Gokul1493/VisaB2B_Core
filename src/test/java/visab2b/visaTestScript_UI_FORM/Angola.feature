Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromAngola = Driver.GetData("ReferenceNo")
    * print randomNumberFromAngola
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromAngola)
    * delay(10000)
