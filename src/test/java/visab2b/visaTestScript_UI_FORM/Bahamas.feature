Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromBahamas = Driver.GetData("ReferenceNo")
    * print randomNumberFromBahamas
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("BHAMA")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFBS50")
    ...
    * waitFor('{span}Beneficiary Address').input("BAHA street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromBahamas)
    * delay(10000)
