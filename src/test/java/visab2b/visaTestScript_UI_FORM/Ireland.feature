Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromIreland = Driver.GetData("ReferenceNo")
    * print randomNumberFromIreland
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromIreland)
    * delay(10000)
