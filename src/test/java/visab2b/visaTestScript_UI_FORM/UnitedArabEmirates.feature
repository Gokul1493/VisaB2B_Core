Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForUAE = Driver.GetData("ReferenceNo")
    * print randomNumberForUAE
  ...
  Scenario: Login into Visab2b maker
    ...
    * delay(2000)
    * waitFor('{}AE - UnitedArabEmirates').click()
    * delay(2000)
    ...
    * waitFor('{span}Beneficiary Name').input("Rashid")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFAE50")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForUAE)
    * delay(10000)
