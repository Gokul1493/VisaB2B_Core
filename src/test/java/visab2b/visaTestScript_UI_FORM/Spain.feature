Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromSpain = Driver.GetData("ReferenceNo")
    * print randomNumberFromSpain
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromSpain)
    * delay(10000)
