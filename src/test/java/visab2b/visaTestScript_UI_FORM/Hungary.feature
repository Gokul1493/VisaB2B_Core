Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromHungary = Driver.GetData("ReferenceNo")
    * print randomNumberFromHungary
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("HUNG")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFHU08")
    * waitFor('{span}Beneficiary Iban').click()
    * waitFor('{span}Beneficiary Iban').input("HU688202366")
    * waitFor('{span}Beneficiary Address').click()
    * waitFor('{span}Beneficiary Address').input("HUNGARY street")
    * delay(2000)
    #Transaction details
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromHungary)
    * delay(10000)
