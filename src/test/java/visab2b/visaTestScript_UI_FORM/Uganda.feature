Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromUganda = Driver.GetData("ReferenceNo")
    * print randomNumberFromUganda
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Bic').input("ASDFUG50")
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromUganda)
    * delay(10000)
