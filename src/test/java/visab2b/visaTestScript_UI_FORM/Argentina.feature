Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromARG = Driver.GetData("ReferenceNo")
    * print randomNumberFromARG
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("MESSI")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFAR50")
    * waitFor('{span}Beneficiary Account Number').click()
    * waitFor('{span}Beneficiary Account Number').input("3455687645368762554878")
    * waitFor('{span}Beneficiary Contact Phone Number').click()
    * waitFor('{span}Beneficiary Contact Phone Number').input("+1-5685865")
    * waitFor('{span}Beneficiary TaxId').click()
    * waitFor('{span}Beneficiary TaxId').input("12365478903")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromARG)
    * delay(10000)
