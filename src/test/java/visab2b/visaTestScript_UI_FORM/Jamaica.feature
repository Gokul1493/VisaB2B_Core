Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberForjam = Driver.GetData("ReferenceNo")
    * print randomNumberForjam
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Name').input("GAYLE")
    * delay(2000)
    * waitFor('{span}Beneficiary Bic').click()
    * waitFor('{span}Beneficiary Bic').input("ASDFJM50")
    * waitFor('{span}Beneficiary BranchId').click()
    * waitFor('{span}Beneficiary BranchId').input("12365")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberForjam)
    * delay(10000)
