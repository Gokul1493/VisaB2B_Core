Feature: Test the Visab2b transactions For Albania Country
  ...
  Background: 
    ...
    * def randomNumberFromSK = Driver.GetData("ReferenceNo")
    * print randomNumberFromSK
  ...
  Scenario: Login into Visab2b maker
    ...
    * waitFor('{span}Beneficiary Bic').input("ASDFKR50")
    * waitFor('{span}Beneficiary ClearingMemberId').click()
    * waitFor('{span}Beneficiary ClearingMemberId').input("123")
    ...
    * waitFor('{span}Beneficiary Contact Phone Number').input("+1-2154845")
  ...
  Scenario: validate response
    ...
    * waitFor('{}EndToEnd ID').input(randomNumberFromSK)
    * delay(10000)
