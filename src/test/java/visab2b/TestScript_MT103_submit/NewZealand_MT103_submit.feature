Feature: NEWZEALAND_MT103_SUMBIT
...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsNewZealandDirectSubmitpostive",referencenumber)
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/NEWZEALAND.txt')
	   * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKNZNZ22", ""  ).replaceAll(":57D://NZ234534", ":57D:"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def content = read('classpath:visab2b/MT103_files/NEWZEALAND.txt')
	   * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKNZNZ22", ":57A:ABC"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 * def content = read('classpath:visab2b/MT103_files/NEWZEALAND.txt')
	   * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	* def content = read('classpath:visab2b/MT103_files/NEWZEALAND.txt')
	  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408NZD138.28", ":32A:200408138.28"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408NZD138.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
## National Clearing Code above 6-digit 
	 ...
	 * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKNZNZ22", ":57A:"  ).replaceAll(":57D://NZ234534", ":57D://NZ2345343"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Creditor Agent Clearing MemberID must be starts with NZ and followed by 6 numeric digit."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKNZNZ22", ":57A:"  ).replaceAll(":57D://NZ234534", ":57D://NZ23453"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKNZNZ22", "57A:"  ).replaceAll(":57D://NZ234534", ":57D:"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/NEWZEALAND.txt')
	  * def referencenumber = "AUTOMT103SFTPNEWZEALAND" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/4567235422", "59:"  ).replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for italt country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/NEWZEALAND.txt')
  * def referencenumber = "MT103SFTPNEWZEALAND" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT10NEWZELAND208674653545648", "20:" + referencenumber ).replaceAll(":32A:200408NZD138.28", ":32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed", "70:"  )
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsNewZealandDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
