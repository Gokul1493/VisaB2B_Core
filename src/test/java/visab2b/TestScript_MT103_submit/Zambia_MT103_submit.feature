...
* print Accno
  ...
  * def referencenumber = "AUTOZAMBIA0001" + Accno
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll(":20:AUTOZAMBIA0001", ":20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 ...
	 * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BAZAZMLUASA", ""  ).replaceAll("20:AUTOZAMBIA0001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BAZAZMLUASA", ":57A:ABC"  ).replaceAll("20:AUTOZAMBIA0001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 ...
	 * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:9100910001", ""  ).replaceAll("20:AUTOZAMBIA0001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	...
	* def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:AUTOZAMBIA0001", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240424ZMW10", ":32A:200408138.28"  ).replaceAll(":20:AUTOZAMBIA0001", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:9100910001", ":50K:43234344"  ).replaceAll(":20:AUTOZAMBIA0001", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll(":20:AUTOZAMBIA0001", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240424ZMW10", ":32A:200408ABC138.28"  ).replaceAll(":20:AUTOZAMBIA0001", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/Zambia.txt')
		* def referencenumber = "AUTOZAMBIA0001" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:4564786431346", "59:"  ).replaceAll("20:AUTOZAMBIA0001", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Zambia country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/Zambia.txt')
  * def referencenumber = "MT103SFTPZambia" + Accno
  * print referencenumber
* def finalMt103 = content.replaceAll("20:AUTOZAMBIA0001", "20:" + referencenumber ).replaceAll(":32A:240424ZMW10", ":32A:200408USD138.28")
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
