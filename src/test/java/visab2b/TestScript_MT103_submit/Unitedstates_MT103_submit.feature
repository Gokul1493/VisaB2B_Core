Feature: UNITEDSTATES_MT103_direct_submit
...
* print Accno
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsUnitedstatesDirectSubmitpostive",referencenumber)
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:USBKUS44XXX", ":57A:ABC"  ).replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/232243546575638476867869", "59:"  ).replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	...
	Scenario: To verify without Creditor Agent Clearing Member ID when BIC is not present
	* def content = read('classpath:visab2b/MT103_files/UNITEDSTATES.txt')
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57A:USBKUS44XXX", ":57A:"  ).replaceAll(":57D:FW123456789", ":57D:"  ).replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber)
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  # Maker user intiate the transaction
 Scenario: Initiating the transaction with other currency than UNITEDSTATES
  * def content = read('classpath:visab2b/MT103_files/UNITEDSTATES.txt')
  * def referencenumber = "AUTOMT103UNITEDSTATESSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT10US4234535435465654625212", "20:" + referencenumber ).replaceAll("59:/232243546575638476867869", "59:ACCNO7098765433"  ).replaceAll(":32A:200408USD138,28", ":32A:200408USD138.28").replaceAll("70:/POP/Testing", "70:")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsUnitedstatesDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
