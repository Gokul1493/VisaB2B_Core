...
* print Accno
 ...
 Scenario: Transaction initated for EGYPT currency 
  * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "EGYPT.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsEgyptDirectSubmitpostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
	...
	#### Maker user intiate the transaction
 Scenario: Initiate the transaction with other Currency without Mandatory field
  * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber ).replaceAll(":70:/POP/Purpose of paymentEGYPT ", ":70:").replaceAll(":77B:/CONT/Joe Smith", ":77B:/INN/1122334455" ).replaceAll("59:/BR9700360305000010009795493P1", "59:/7098765433"  ).replaceAll(":32A:200408EGP134,67", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsEgyptDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
	...
	#### Maker user intiate the transaction
 Scenario: Initiate the transaction with other Currency with Mandatory fields
  * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber ).replaceAll("59:/BR9700360305000010009795493P1", "59:/7098765433"  ).replaceAll(":32A:200408EGP134,67", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103EGYPT20240204001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BHARAINSFTPANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408EGP134,67", ":32A:200408ABC138.28"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber ).replaceAll(":70:/POP/Payment as agreed EGYPT", ":70:/PPC/CBP")
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll("57A:CBEGEGCXXXX", "57A:"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:CBEGEGCXXXX", "57A:ABC"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:CBEGEGCXXXX", "57A:ABCIBHB"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:CBEGEGCXXXX", "57A:CBEGEGCXXXXV"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/BR9700360305000010009795493P1", "59:"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
    ...
    Scenario:  Branch Name as Empty
  * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:72:/BBB/Downtown Branch", "72:/BBB/"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
   ...
   Scenario:  Branch Name Less than 3 character
  * def content = read('classpath:visab2b/MT103_files/EGYPT.txt')
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:72:/BBB/Downtown Branch", "72:/BBB/Do"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("/PHN/+1-8099087766", "/PHN/"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("/PHN/+1-8099087766", "/PHN/8099087766"  ).replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103EGYPTSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":70:/POP/Purpose of paymentEGYPT ", ":70:").replaceAll("20:MT103EGYPT20240204001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
