...
* print Accno
  ...
  * def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
  * def referencenumber = "AUTOMT103SFTPBelarus" + Accno
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "BELARUS.txt"
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 ...
	 * def referencenumber = "AUTOMT103SFTPBelarus" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:AKBBBY2XXXX", ""  ).replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AUTOMT103SFTPBelarus" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:AKBBBY2XXXX", ":57A:ABC"  ).replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 ...
	 * def referencenumber = "AUTOMT103SFTPBelarus" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:9100910001", ""  ).replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240529USD10", ":32A:200408138.28"  ).replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
		* def referencenumber = "AUTOMT103SFTPBelarus" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:232243546575638476867", ""  ).replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for angola country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/BELARUS.txt')
  * def referencenumber = "MT103SFTPBelarus" + Accno
  * print referencenumber
* def finalMt103 = content.replaceAll(":20:AUTOMT103SFTPBelarus", ":20:" + referencenumber ).replaceAll(":32A:240529USD10", ":32A:200408USD138.28")
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
