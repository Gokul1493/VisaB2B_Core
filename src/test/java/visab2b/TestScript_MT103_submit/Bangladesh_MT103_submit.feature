Feature: BANGLADESH_MT103_submit
...
* print Accno
 ...
 Scenario: Transaction initated for BANGLADESH currency
  * def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
  * def referencenumber = "AUTOMT103BANGLADESHSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "BANGLADESH.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsBangladeshAnyDirectSubmitpostive",referencenumber)
  ...
  * def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber ).replaceAll(":72:/BRI/Bangladesh", ":70:").replaceAll(":70:/POP/Payment as agreed BANBLADESH", ":70:").replaceAll("59:/0001299123456", "59:/7098765433"  ).replaceAll(":32A:200408BDT108.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103BANGALADESH202428001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BHARAINSFTPANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408BDT108.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber ).replaceAll(":70:/POP/Payment as agreed BANBLADESH", ":70:/PPC/CBP")
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll("57A:BBHOBDDHXXX", "57A:"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:BBHOBDDHXXX", "57A:ABC"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  Scenario: Beneficiary Bank Branch ID as Empty
  * def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:/BRI/Bangladesh", "72:/BRI/"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Parameter 'CreditorAgentBranchID' cannot be null."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
  
  Scenario: Beneficiary Bank Branch ID less than 2 character
  * def content = read('classpath:visab2b/MT103_files/BANGLADESH.txt')
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:/BRI/Bangladesh", "72:/BRI/Ba"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "CreditorAgentBranchID must be min 3 characters"
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:BBHOBDDHXXX", "57A:ABCIBHB"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:BBHOBDDHXXX", "57A:BBHOBDDHXXXV"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/0001299123456", "59:"  ).replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BANBLADESHSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":70:/POP/Payment as agreed BANBLADESH", ":70:").replaceAll("20:MT103BANGALADESH202428001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
