...
* print Accno
 ...
 Scenario: Transaction initated for BELGIUM currency 
  * def content = read('classpath:visab2b/MT103_files/BELGIUM.txt')
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
		* jutil.SetData("GetAuditsBelgiumAnyDirectSubmitpostive",referencenumber)
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber ).replaceAll("59:/BE68539007547034", "59:/7098765433"  ).replaceAll(":32A:200408EUR198.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408EUR198.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll("57A:AARBBEB1XXX", "57A:"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:AARBBEB1XXX", "57A:ABC"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:AARBBEB1XXX", "57A:ABCIBHB"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:AARBBEB1XXX", "57A:AARBBEB1XXXV"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BELGIUMSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/BE68539007547034", "59:"  ).replaceAll("20:MT103BELGIUM2024000101", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
