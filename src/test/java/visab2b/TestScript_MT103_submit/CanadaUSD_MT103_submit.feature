Feature: CANADAUSD_MT103_submit
...
* print Accno
 ...
 Scenario: Transaction initated for CANADAUSD currency with BIC only
  * def content = read('classpath:visab2b/MT103_files/CANADAUSD.txt')
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsCanadaUSADirectSubmitpostiveBIC",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
	 ...
	 #######Maker user intiate the transaction
 Scenario: Transaction initated for CANADAUSD currency with clearing Member ID only(CC)
  * def content = read('classpath:visab2b/MT103_files/CANADAUSD.txt')
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsCanadaUSADirectSubmitpostiveClearingID(CC)",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
	* jutil.SetData("getAuditsReferenceNumber",referencenumber)
	* def sleep = function(millis){ java.lang.Thread.sleep(millis) }
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
		 ...
		 #######Maker user intiate the transaction
 Scenario: Transaction initated for CANADAUSD currency with clearing Member ID only(FW)
  * def content = read('classpath:visab2b/MT103_files/CANADAUSD.txt')
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsCanadaUSADirectSubmitpostiveClearingID(FW)",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
	* jutil.SetData("getAuditsReferenceNumber",referencenumber)
	* def sleep = function(millis){ java.lang.Thread.sleep(millis) }
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
	 ...
	 #######Maker user intiate the transaction
 Scenario: Transaction initated for CANADAUSD currency with BIC and clearing Member ID only
  * def content = read('classpath:visab2b/MT103_files/CANADAUSD.txt')
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsCanadaUSADirectSubmitpostiveBICandClearingId",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
	* jutil.SetData("getAuditsReferenceNumber",referencenumber)
	* def sleep = function(millis){ java.lang.Thread.sleep(millis) }
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber ).replaceAll(":57D://CC123456789", ":57D://").replaceAll("59:/68539007034666", "59:/7098765433"  ).replaceAll(":32A:200408USD18.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsCanadaUSADirectSubmitothercurrencyBIConly",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber ).replaceAll(":57A:ACFXCAW1XXX", ":57A:"  ).replaceAll("59:/68539007034666", "59:/7098765433"  ).replaceAll(":32A:200408USD18.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsCanadaUSADirectSubmitothercurrencyClearingMemberIdonly",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
	* jutil.SetData("getAuditsReferenceNumberothercurrency",referencenumber)
	* def sleep = function(millis){ java.lang.Thread.sleep(millis) }
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408USD18.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll("57A:ACFXCAW1XXX", "57A:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:ACFXCAW1XXX", "57A:ABC"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:ACFXCAW1XXX", "57A:ABCIBHB"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:ACFXCAW1XXX", "57A:ACFXCAW1XXXV"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/68539007034666", "59:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57D://CC123456789", ":57D://"  ).replaceAll("::57A:ACFXCAW1XXX", "::57A:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57D://CC123456789", ":57D://123456789"  ).replaceAll("::57A:ACFXCAW1XXX", "::57A:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57D://CC123456789", ":57D://AC123456789"  ).replaceAll("::57A:ACFXCAW1XXX", "::57A:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57D://CC123456789", ":57D://AC1234567891"  ).replaceAll("::57A:ACFXCAW1XXX", "::57A:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CANADAUSDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57D://CC123456789", ":57D://AC12345678"  ).replaceAll("::57A:ACFXCAW1XXX", "::57A:"  ).replaceAll("20:MT103CANADAUSD202431030001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
