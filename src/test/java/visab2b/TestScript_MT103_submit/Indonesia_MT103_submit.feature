Feature: INDONESIA_MT103_submit
...
* print Accno
 ...
 Scenario: Transaction initated for INDONESIA currency 
  * def content = read('classpath:visab2b/MT103_files/INDONESIA.txt')
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "INDONESIA.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsIndonesiaDirectSubmitpostive",referencenumber)
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber ).replaceAll(":70:/POP/Payment as agreed INDONESIA", ":70:").replaceAll("59:/45465787686456465", "59:/7098765433"  ).replaceAll(":32A:240326IDR10,45", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsIndonesiaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber ).replaceAll("59:/45465787686456465", "59:/7098765433"  ).replaceAll(":32A:240326IDR10,45", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103INDONESIA20240402001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BHARAINSFTPANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240326IDR10,45", ":32A:200408ABC138.28"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber ).replaceAll(":70:/POP/Payment as agreed INDONESIA", ":70:/POP/")
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:ABC"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", ":57A:ABCIBHB"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:/SUNIIDJAXXX", "57A:/SUNIIDJAXXXV"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/45465787686456465", "59:"  ).replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103INDONESIASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":70:/POP/Payment as agreed INDONESIA", ":70:").replaceAll("20:MT103INDONESIA20240402001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
