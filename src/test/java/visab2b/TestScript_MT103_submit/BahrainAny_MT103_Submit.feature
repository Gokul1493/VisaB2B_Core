Feature: BAHRAIN_ANY_MT103_direct_submit
...
* print Accno
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "MT103BHARAINSFTPANY202403260001" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408USD108.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:ABCIBHBMXXX", ":57A:"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  * def content = read('classpath:visab2b/MT103_files/BAHRAIN_ANY.txt')
  * def referencenumber = "AUTOBHARAINANYSUBMITs" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:ABCIBHBMXXX", ":57A:ABC"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:ABCIBHBMXXX", ":57A:ABCIBHB"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:ABCIBHBMXXX", ":57A:ABCIBHBMXXXV"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Invalid BIC"
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/BH67BMAG00001299123456", "59:"  ).replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("70:/PPC/CBP", "70:").replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Parameter 'PaymentPurposeCode' cannot be null."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
  
  Scenario: Payment Purpose Code Less than 3 character
  * def content = read('classpath:visab2b/MT103_files/BAHRAIN_ANY.txt')
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("70:/PPC/CBP", "70:/PPC/CB").replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Payment Purpose Code Number must be 3-UpperCase Characters."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  * def referencenumber = "AUTOBHARAINANYSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103BHARAINSFTPANY202403260001", "20:" + referencenumber ).replaceAll("59:/BH67BMAG00001299123456", "59:/7098765433"  ).replaceAll(":32A:200408USD108.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsBahrainAnyDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
