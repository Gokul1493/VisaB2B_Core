Feature: ALGERIA_MT103_DIRCET_SUBMIT
...
* print Accno
  ...
  * print creaccno
  * def finalMt103 = content.replaceAll("20:500442805", "20:" + referencenumber )
  * print finalMt103
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsAlgeriaDirectSubmitpostive",referencenumber)
...
## Maker user intiate the transaction
  ...
  * print creditorAccNo
  * def finalMt103 = content.replaceAll("20:500442805", "20:" + referencenumber ).replaceAll("59:/AG472121100900000002", "59:" + creditorAccNo )
  * print finalMt103
  * def user = testData.Visa_Mk
    Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	Then status 200
	* print response
	* match response.result.fileAudits[0].error == "Creditor AccountNumber must be 20-alphanumeric."
  ...
  * def PhnNo = ''
  * print PhnNo
  * def finalMt103 = content.replaceAll("20:500442805", "20:" + referencenumber ).replaceAll("/PHN/+1-8099087766", "" + PhnNo )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
## Maker user intiate the transaction
  ...
  * def creditorName = ''
  * print creditorName
  * def finalMt103 = content.replaceAll("20:500442805", "20:" + referencenumber ).replaceAll("72:/CONT/Joe Smith", "" + creditorName )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
    * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	Then status 200
		* print response
	* match response.result.fileAudits[0].error == "Parameter 'CreditorContactName' cannot be null."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll(":20:500442805", ":20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/ALGERIA.txt')
	   * def referencenumber = "AUTOMT103SFTPALGERIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BALGDZAPXXX", ":57A:"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
     * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def content = read('classpath:visab2b/MT103_files/ALGERIA.txt')
	   * def referencenumber = "AUTOMT103SFTPALGERIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BALGDZAPXXX", ":57A:ABC"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 * def content = read('classpath:visab2b/MT103_files/ALGERIA.txt')
	   * def referencenumber = "AUTOMT103SFTPALGERIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	* def content = read('classpath:visab2b/MT103_files/ALGERIA.txt')
	  * def referencenumber = "AUTOMT103SFTPALGERIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll(":20:500442805", ":20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240101DZD1000", ":32A:200408138.28"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240101DZD1000", ":32A:200408ABC138.28"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/ALGERIA.txt')
	  * def referencenumber = "AUTOMT103SFTPALGERIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":59:/AG472121100900000002", ""  ).replaceAll(":20:500442805", ":20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Purpose of payment(POP)- as Empty
	* def content = read('classpath:visab2b/MT103_files/ALGERIA.txt')
	  * def referencenumber = "AUTOMT103SFTPALGERIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("70:/POP/Payment as agreed for Algeria", "70:"  ).replaceAll(":20:500442805", ":20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Algeria country with different currency  (currency:- USD)
  ...
  * print referencenumber
  * def finalMt103 = content.replaceAll(":20:500442805", ":20:" + referencenumber ).replaceAll(":32A:240101DZD1000", ":32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed for Algeria", "70:"  )
  * print finalMt103
  * def user = testData.Visa_Mk
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsAlgeriaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
