...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsMexicoDirectSubmitpostive",referencenumber)
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	   * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BNMXMXMMXXX", ":57A:"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	   * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BNMXMXMMXXX", ":57A:ABC"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 * def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	   * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	* def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408MXN138.28", ":32A:200408138.28"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408MXN138.28", ":32A:200408ABC138.28"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  ##Beneficiary Account Number (18 digits)
	...
	* def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	 * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":59:/451258741254578452", ":59:/9632587410963025874"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Creditor AccountNumber must be 18-numeric."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
	...
	* def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	 * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":59:/451258741254578452", ":59:/96325874109630258"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
	  * def referencenumber = "AUTOMT103SFTPMEXICO" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/451258741254578452", ":59:"  ).replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for italt country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/MEXICO.txt')
  * def referencenumber = "MT103SFTPMEXICO" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT103MEXICO4564553427823750", "20:" + referencenumber ).replaceAll(":32A:200408MXN138.28", ":32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed", "70:"  )
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsMexicoDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
