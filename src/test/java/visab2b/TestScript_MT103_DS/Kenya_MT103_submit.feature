Feature: KENYA_MT103_DIRECT_SUBMIT
...
* print Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsKenyaDirectSubmitpostive",referencenumber)
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:CONKKENAXXX", "57A:"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:CONKKENAXXX", "57A:ABC"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
   ...
   ## Beneficiary Branch Name Minimum length 3
		 ## Beneficiary Branch Name less length 3
 Scenario: To verify the Beneficiary Branch Name less length min 3
  * def content = read('classpath:visab2b/MT103_files/KENYA.txt')
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
  * def branchName = "/BBB/Te" 
  * print branchName
  * def finalMt103 = content.replaceAll(":72:/BBB/Tes", ":72:" + branchName ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
		 ...
		 ## Beneficiary Branch Name less length 3
 Scenario: To verify the without prefix Beneficiary Branch Name 
  * def content = read('classpath:visab2b/MT103_files/KENYA.txt')
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
  * def branchName = "/Tet" 
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll(":72:/BBB/Tes", ":72:" ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408KES10,10", ":32A:200408138.28"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408KES10,10", ":32A:200408ABC138.28"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/4325435465", "59:"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPKENYA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("70:/POP/Purpose of Payment for Kenya", "70:"  ).replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Kenya country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/KENYA.txt')
  * def referencenumber = "MT103SFTPKENYA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103KENYA20225432565443355470110", "20:" + referencenumber ).replaceAll(":32A:200408KES10,10", ":32A:200408USD138.28").replaceAll("70:/POP/Purpose of Payment for Kenya", "70:"  )
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsKenyaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
