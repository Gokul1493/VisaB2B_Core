...
* print Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsJordanDirectSubmitpostive",referencenumber)
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
	   * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BJORJOAXXXX", "57A:"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
	   * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BJORJOAXXXX", ":57A:ABC"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 * def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
	   * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	* def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
	  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408JOD138,28", ":32A:200408138.28"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408JOD138,28", ":32A:200408ABC138.28"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: To verify the Remittance Code above 4-digit
  ...
  * def finalMt103 = content.replaceAll("72:/PPC/0811", "72:" + remittanceCode ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Payment Purpose Code must be 4-numeric."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
...
Scenario: To verify the Remittance Code less 4-digit
  ...
  * match response.result.fileAudits[0].reference == referencenumber
		...
		## Remittance Code numeric 4-digit
Scenario: To verify the without prefix Remittance Code numeric 4-digit
  * def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
  	  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
  * def remittanceCode = "/0811" 
  * print remittanceCode
  * def finalMt103 = content.replaceAll("72:/PPC/0811", "72:" + remittanceCode ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
...
Scenario: To verify the without Remittance Code 4-digit
  * def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
  	  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("72:/PPC/0811", ""  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
	  * def referencenumber = "AUTOMT103SFTPJORDAN" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/JO94CBJO0010000000000131000302", "59:"  ).replaceAll("20:MT10JODRAN43954354543880", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for italt country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/JORDAN.txt')
  * def referencenumber = "MT103SFTPJORDAN" + Accno
  * print referencenumber
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsJordanDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
