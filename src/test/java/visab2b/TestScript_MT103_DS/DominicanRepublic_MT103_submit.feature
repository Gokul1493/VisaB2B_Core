Feature: DOMINICANREPUBLIC_MT103_submit
...
* print Accno
 ...
 Scenario: Transaction initated for DOMINICANREPUBLIC currency
  * def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "DOMINICANREPUBLIC.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsDominicanRepublicDirectSubmitpostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
	...
	#### Maker user intiate the transaction
 Scenario: Initiate the transaction with other Currency without 9 digit Beneficiary Tax ID
  * def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber ).replaceAll(":70:/POP/Purpose of payment	DOMINICANREPUBLIC", ":70:").replaceAll(":72:/INN/112233444", ":72:/INN/" ).replaceAll("59:/CR05015202001026284066", "59:/7098765433"  ).replaceAll(":32A:200408CRC18.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsDominicanRepublicDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber ).replaceAll(":70:/POP/Purpose of payment	DOMINICANREPUBLIC", ":70:").replaceAll("59:/CR05015202001026284066", "59:/7098765433"  ).replaceAll(":32A:200408CRC18.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BHARAINSFTPANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408CRC18.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber ).replaceAll(":70:/POP/Payment as agreed DOMINICANREPUBLIC", ":70:/PPC/CBP")
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll("57A:BCCRCRSJXXX", "57A:"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:BCCRCRSJXXX", "57A:ABC"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:BCCRCRSJXXX", "57A:ABCIBHB"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:BCCRCRSJXXX", "57A:BCCRCRSJXXXV"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/CR05015202001026284066", "59:"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:/INN/112233445566", "72:/INN/"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  Scenario:  Beneficiary ID more than 9 digit
  * def content = read('classpath:visab2b/MT103_files/DOMINICANREPUBLIC.txt')
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:/INN/112233444", "72:/INN/1122334455"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":72:/INN/112233444", "72:/INN/11223344"  ).replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103DOMINICANREPUBLICSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":70:/POP/Purpose of payment	DOMINICANREPUBLIC", ":70:").replaceAll("20:MT103DOMICANREPUBLIC2024010001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
