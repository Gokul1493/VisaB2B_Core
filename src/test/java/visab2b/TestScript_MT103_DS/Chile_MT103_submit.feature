...
* print Accno
 ...
 Scenario: Transaction initated for CHILE currency with 9 digit Beneficiary Tax ID
  * def content = read('classpath:visab2b/MT103_files/CHILE.txt')
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "CHILE.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsChileDirectSubmitpostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* match response.result.message == "Approved successfully"
	...
	#######Maker user intiate the transaction
 Scenario: Transaction initated for CHILE currency with 10 digit Beneficiary Tax ID
  * def content = read('classpath:visab2b/MT103_files/CHILE.txt')
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber ).replaceAll(":77B:/INN/112233445", ":77B:/INN/1122334455" )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber ).replaceAll(":70:/POP/payment of purpose CHILE", ":70:").replaceAll(":77B:/INN/112233445", ":77B:/INN/1122334455" ).replaceAll("59:/BR9700360305000010009795493P1", "59:/7098765433"  ).replaceAll(":32A:200408CLP18.28", ":32A:200408ALL138.28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	#* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsChileDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103CHILE20240104001", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103BHARAINSFTPANYSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408CLP18.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber ).replaceAll(":70:/POP/Payment as agreed CHILE", ":70:/PPC/CBP")
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll("57A:BECHCLRMXXX", "57A:"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:BECHCLRMXXX", "57A:ABC"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:BECHCLRMXXX", "57A:ABCIBHB"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":57A:BECHCLRMXXX", "57A:BECHCLRMXXXV"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/BR9700360305000010009795493P1", "59:"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("77B:/INN/112233445", "77B:/INN/"  ).replaceAll("20:AUTOMT103CHILESUBMIT", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":77B:/INN/112233445", ":77B:/INN/11223344556"  ).replaceAll("20:AUTOMT103CHILESUBMIT", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":77B:/INN/112233445", ":77B:/INN/11223344"  ).replaceAll("20:AUTOMT103CHILESUBMIT", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("/PHN/+1-8099087766", "/PHN/"  ).replaceAll("20:AUTOMT103CHILESUBMIT", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("72:/INN/112233445", "72:/INN/11223344556"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":77B:/INN/112233445", "72:/INN/11223344"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("/PHN/+1-8099087766", "/PHN/"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("/PHN/+1-8099087766", "/PHN/8099087766"  ).replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103CHILESUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":70:/POP/payment of purpose CHILE", ":70:").replaceAll("20:MT103CHILE20240104001", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
