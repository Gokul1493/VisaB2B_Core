Feature: ANGOLA_MT103_DIRECT_SUBMIT
...
* print Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsAngolaDirectSubmitpostive",referencenumber)
...
Scenario: Creditor Bic as Empty
	 ...
	 * def referencenumber = "AUTOMT103SFTPANGOLA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BCCBAOLUXXX", ""  ).replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AUTOMT103SFTPANGOLA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BCCBAOLUXXX", ":57A:ABC"  ).replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 ...
	 * def referencenumber = "AUTOMT103SFTPANGOLA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ""  ).replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	...
	* def referencenumber = "AUTOMT103SFTPANGOLA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408AOA138.28", ":32A:200408138.28"  ).replaceAll(":20:MT103ANGOLA34565656567", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll(":20:MT103ANGOLA34565656567", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll(":20:MT103ANGOLA34565656567", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408AOA138.28", ":32A:200408ABC138.28"  ).replaceAll(":20:MT103ANGOLA34565656567", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/ANGOLA.txt')
		* def referencenumber = "AUTOMT103SFTPANGOLA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/AO06004400006729503010102", "59:"  ).replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Purpose of payment(POP)- as Empty
	...
	* def referencenumber = "AUTOMT103SFTPANGOLA" + Accno
  * print referencenumber
* def finalMt103 = content.replaceAll(":72:/POP/Purpose of Paymentfor Angola", ""  ).replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber )
  * print finalMt103 
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for angola country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/ANGOLA.txt')
...
* def finalMt103 = content.replaceAll("20:MT103ANGOLA34565656567", "20:" + referencenumber ).replaceAll(":32A:200408AOA138.28", ":32A:200408USD138.28").replaceAll("72:/POP/Payment as agreed", "72:"  )
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsAngolaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
