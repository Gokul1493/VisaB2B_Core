...
* print Accno
  ...
  * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
  * def referencenumber = "AUTOMT103SFTPAUSTRIA" + Accno
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "AUSTRIA.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsAustriaDirectSubmitpostive",referencenumber)
...
# invalid Iban 
Scenario: verify the invalid iban 
	* def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
	* def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/AT611904300234573201", "59:/werytruytd"  ).replaceAll(":57A:BKAUATWWXXX", ""  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
 ...
 #Iban as empty
Scenario: verify the iban as empty
	* def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
	* def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/AT611904300234573201", ""  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:SFTPAUSTRIA3276754549", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 ...
	 * def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKAUATWWXXX", "57A:"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BKAUATWWXXX", ":57A:ABC"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	...
	* def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408USD138.28", ":32A:200408138.28"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPALBENIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408USD138.28", ":32A:200408ABC138.28"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	...
	* def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/AT611904300234573201", "59:"  ).replaceAll("20:SFTPAUSTRIA3276754549", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Austuria country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/AUSTRIA.txt')
  * def referencenumber = "MT103SFTPALBENIA" + Accno
  * print referencenumber
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsAustriaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
