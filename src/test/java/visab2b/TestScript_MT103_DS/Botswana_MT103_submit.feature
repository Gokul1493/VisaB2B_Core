...
* print Accno
  ...
  * def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "botswana.txt"
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll(":20:AutoBotswana0010", ":20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 ...
	 * def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BBOTBWGXXXX", ""  ).replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:BBOTBWGXXXX", ":57A:ABC"  ).replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 ...
	 * def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:9100910001", ""  ).replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
  ...
  * def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240424BWP10", ":32A:200408138.28"  ).replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240424BWP10", ":32A:200408ABC138.28"  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/botswana.txt')
		* def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:21545448787502", ""  ).replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Purpose of payment(POP)- as Empty
	...
	* def referencenumber = "AutoBotswana0010" + Accno
  * print referencenumber
* def finalMt103 = content.replaceAll(":70:/POP/POP", ":70:"  ).replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber )
  * print finalMt103 
    * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for angola country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/botswana.txt')
  * def referencenumber = "MT103SFTPbotswana" + Accno
  * print referencenumber
* def finalMt103 = content.replaceAll(":20:AutoBotswana0010", ":20:" + referencenumber ).replaceAll(":32A:240424BWP10", ":32A:200408USD138.28").replaceAll("72:/POP/Payment as agreed", "72:"  )
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
