Feature: SWITZERLAND_MT103_direct_submit
...
* print Accno
  ...
  * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "SWITZERLAND.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsSwitzerlandDirectSubmitpostive",referencenumber)
  ...
  * approvetrasnaction.params.Api.deviceId = testData.Visa_CK.keyId
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT10CHF2022086755733", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:KBAGCH22", "57A:ABC"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408CHF138,28", ":32A:"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408CHF138,28", ":32A:200408ABC138,28"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/CH2289144633283464381", "59:"  ).replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  ## Maker user intiate the transaction
 Scenario: Initiating the transaction with other currency than SWITZERLAND
  * def content = read('classpath:visab2b/MT103_files/SWITZERLAND.txt')
  * def referencenumber = "AUTOMT103SWITZERLANDSUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT10CHF2022086755733", "20:" + referencenumber ).replaceAll("59:/CH2289144633283464381", "59:ACCNO7098765433"  ).replaceAll(":32A:200408CHF138,28", ":32A:200408USD138,28")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsSwitzerlandDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
