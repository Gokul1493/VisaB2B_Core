Feature: AUSTRALIA_MT103_SUBMIT
...
* print Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
		* jutil.SetData("GetAuditsAustraliaDirectSubmitpostive",referencenumber)
...
## clearing member less than 6 digit
  ...
  * print clearingId
  * def finalMt103 = content.replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber ).replaceAll("57D://AU235645", "57D:" + clearingId ).replaceAll("57A:ANNCAU22", "" )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)	
	...
	Then status 200
	* print response
	* match response.result.fileAudits[0].error == "Creditor Agent Clearing MemberID must be starts with AU and followed by 6 numeric digit"
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:MT103AUSTRILIA3456546568", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
	  * def referencenumber = "AUTOMT103SFTPAUSTRILIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:ANNCAU22", ""  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber ).replaceAll(":57D://AU235645", ""  )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
	  * def referencenumber = "AUTOMT103SFTPAUSTRILIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:ANNCAU22", ":57A:ABC"  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 * def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
	  * def referencenumber = "AUTOMT103SFTPAUSTRILIA" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	* def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
	 * def referencenumber = "AUTOMT103SFTPAUSTRILIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Instructed currency as Empty
  * def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
  * def referencenumber = "AUTOMT103SFTPAUSTRALIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408AUD138.28", ":32A:200408138.28"  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPAUSTRALIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPAUSTRALIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPAUSTRALIA" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408AUD138.28", ":32A:200408ABC138.28"  ).replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
	  * def referencenumber = "AUTOMT103SFTPAUSTRALIA" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":59:/1234567891234567891234", ""  ).replaceAll(":20:MT103AUSTRILIA3456546568", ":20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Argentina country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/AUSTRALIA.txt')
  * def referencenumber = "MT103SFTPAUSTRALIA" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:MT103AUSTRILIA3456546568", "20:" + referencenumber ).replaceAll(":32A:200408AUD138.28", ":32A:200408USD138.28")
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
		* jutil.SetData("GetAuditsAustraliaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
