Feature: NETHERLANDS_MT103_SUMBIT
...
* print Accno
  ...
  * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "NETHERLANDS.txt"
  * def value = signsreq(reqadd,user)
	And request value
	When method POST
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsNertherlandsDirectSubmitpostive",referencenumber)
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
	   * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:ABNCNL2AECP", ":57A:"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
	   * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:ABNCNL2AECP", ":57A:ABC"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
	   * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	* def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
	  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408EUR10,10", ":32A:200408138.28"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:200408EUR10,10", ":32A:200408ABC138.28"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
	  * def referencenumber = "AUTOMT103SFTPNETHERLANDS" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:/BR9700360305000010009795493P1", "59:"  ).replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Malta country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/NETHERLANDS.txt')
  * def referencenumber = "MT103SFTPNETHERLANDS" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPMT103NETHERLANDS22543655434535437", "20:" + referencenumber ).replaceAll(":32A:200408EUR10,10", ":32A:200408USD138.28").replaceAll("70:/POP/Payment as agreed", "70:"  )
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsNertherlandsDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
