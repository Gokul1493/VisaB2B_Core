Feature: SOUTHKOREA_MT103_direct_submit
...
* print Accno
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  ...
  * def value = signsreq(reqadd,user)
	...
	* jutil.SetData("GetAuditsSouthKoreaDirectSubmitpostive",referencenumber)
...
* match response.result.fileAudits[0].status == "FAILED"
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", "50K:"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("BOLIVIA", "").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Invaild
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("57A:/ANZBKRSXXXX", "57A:ABC"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:/9100910001", ":50K:43234344"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240312KRW101,22", ":32A:240312ABC101,22"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("59:/485278645312645", "59:"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("70:/POP/POP for southkorea", "70:"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("70:/POP/POP for southkorea", "70:/POP/"  ).replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  Scenario: To verify the Clearing Member ID as above 3-digit
	* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
	 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57D:/KR654", ":57D:/KRA1654").replaceAll(":57A:/ANZBKRSXXXX", ":57A:/ANZBKRSX").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	...
	* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
	 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57D:/KR654", ":57D:/KR12").replaceAll(":57A:/ANZBKRSXXXX", ":57A:/ANZBKRSX").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "Creditor Agent Clearing MemberID must be starts with KR and followed by 3 numeric digit."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
	...
	* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
	 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57D:/KR654", ":57D:/123").replaceAll(":57A:/ANZBKRSXXXX", ":57A:/ANZBKRSX").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	...
	* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
	 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57D:/KR654", ":57D:").replaceAll(":57A:/ANZBKRSXXXX", ":57A:/ANZBKRSX").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	...
	* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
	 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57A:/ANZBKRSXXXX", ":57A:/123").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	...
	* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
	 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll(":57A:/ANZBKRSXXXX", ":57A:").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: To verify the Beneficiary Contact Phone Number as empty
		* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
		 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("/PHN/+1-545648756", "").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * def value = signsreq(reqadd,user)	
	...
	When method POST
	Then status 200
	* match response.result.fileAudits[0].error == "CreditorContactPhoneNumber' cannot be null."
  * match response.result.fileAudits[0].status == "FAILED"
  * match response.result.fileAudits[0].reference == referencenumber
	...
	Scenario: To verify the Beneficiary Contact Phone Number without prefix
		* def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
		 * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("/PHN/+1-545648756", "/+1-8099087766").replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
### match audit error message in UI	
  ...
  * match response.result.fileAudits[0].reference == referencenumber
  ...
  ## Maker user intiate the transaction
 Scenario: Initiating the transaction with other currency than SOUTHKOREA
  * def content = read('classpath:visab2b/MT103_files/SOUTHKOREA.txt')
  * def referencenumber = "AUTOMT103SOUTHKOREASUBMIT" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:2603001SFTPr000271254012", "20:" + referencenumber ).replaceAll("59:/485278645312645", "59:ACCNO7098765433"  ).replaceAll(":32A:240312KRW101,22", ":32A:240312EUR101,22").replaceAll("70:/POP/POP for southkorea", "70:")
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def value = signsreq(reqadd,user)
	...
	Then status 200
	* match response.result contains {message:"Summary: (1 of 1 files accepted)"},id:"1"}
	* jutil.SetData("GetAuditsSouthKoreaDirectSubmitothercurrency",referencenumber)
	* jutil.SetData("Duplicaterefnumber",referencenumber)
	* print jutil.SetData('Duplicaterefnumber',referencenumber)
