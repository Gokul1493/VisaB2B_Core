...
* print Accno
  ...
  * def content = read('classpath:visab2b/MT103_files/Namibia.txt')
  * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
  * def finalMt103 = content.replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber )
  * print finalMt103
  ...
  * reqadd.params.Payload.swiftFiles[0].fileName = "Namibia.txt"
...
Scenario: Transaction with end to end identification already exists
	...
	* print duplref
	* def finalMt103 = content.replaceAll(":20:AUTONAMIBIA0010", ":20:" + duplref )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Creditor Bic as Empty
	 ...
	 * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:CBKNNANXXXX", ""  ).replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * match response.result.fileAudits[0].reference == referencenumber
	 ...
	 * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":57A:CBKNNANXXXX", ":57A:ABC"  ).replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorAccountNumber as Empty
	 ...
	 * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 * def finalMt103 = content.replaceAll(":50K:9100910001", ""  ).replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: DebtorName as Empty
	...
	* def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "").replaceAll("840 MASSACHUSETTS ST", "").replaceAll("LAWRENCE, KS 66044, USA", "").replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk	
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240424NAD10", ":32A:200408138.28"  ).replaceAll(":20:AUTONAMIBIA0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":50K:9100910001", ":50K:43234344"  ).replaceAll(":20:AUTONAMIBIA0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll("JIAXING INDUSTRY", "JIXEN"  ).replaceAll(":20:AUTONAMIBIA0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
  ...
  * def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	 	 * def finalMt103 = content.replaceAll(":32A:240424NAD10", ":32A:200408ABC138.28"  ).replaceAll(":20:AUTONAMIBIA0010", ":20:" + referencenumber )
   * print finalMt103
   * def user = testData.Visa_Mk
   Given url QaUrl + 'api'
   * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: CreditorIBAN/AccountNumber as Empty
	* def content = read('classpath:visab2b/MT103_files/Namibia.txt')
		* def referencenumber = "AUTONAMIBIA0010" + Accno
  * print referencenumber
	* def finalMt103 = content.replaceAll("59:5467687645351345", "59:"  ).replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber )
  * print finalMt103
  * def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
...
Scenario: Transaction initated for Namibia country with different currency  (currency:- USD)
  * def content = read('classpath:visab2b/MT103_files/Namibia.txt')
  * def referencenumber = "MT103SFTPNamibia" + Accno
  * print referencenumber
* def finalMt103 = content.replaceAll("20:AUTONAMIBIA0010", "20:" + referencenumber ).replaceAll(":32A:240424NAD10", ":32A:200408USD138.28")
  * print finalMt103
	* def user = testData.Visa_Mk
  Given url QaUrl + 'api'
  * def reqadd = read('classpath:visab2b/Payload/MT103_swift_file.json')
